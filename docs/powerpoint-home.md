...
- [Erste Schritte mit PowerPoint-add-ins](https://docs.microsoft.com/en-us/office/dev/add-ins/quickstarts/powerpoint-quickstart)
  
- [Plattformübersicht](https://docs.microsoft.com/en-us/office/dev/add-ins/overview/office-add-ins)
  
### <a name="code-samples"></a>Codebeispiele
  
- [PowerPoint-Codebeispiele in der Office Developer Center](https://dev.office.com/code-samples#?filters=powerpoint)
