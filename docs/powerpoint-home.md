...
- [VBA-Referenz für PowerPoint](https://docs.microsoft.com/office/vba/api/overview/powerpoint)
...
- [Erste Schritte mit PowerPoint-Add-Ins](https://docs.microsoft.com/office/dev/add-ins/quickstarts/powerpoint-quickstart?tabs=visual-studio)
  
- [Plattformübersicht](https://docs.microsoft.com/office/dev/add-ins/overview/office-add-ins)
  
### <a name="code-samples"></a>Codebeispiele
  
- [PowerPoint-Codebeispiele im Office Dev Center](https://developer.microsoft.com/office/gallery/?filterBy=Samples,PowerPoint)
