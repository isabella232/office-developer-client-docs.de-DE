...
Im folgenden Codebeispiel ermittelt die GetDefaultMessageClass-Prozedur anhand der **PropertyAccessor**-Klasse das Standardformular für einen Ordner. Wenn die Ordnereigenschaft **PR \_ DEF POST \_ \_ MSGCLASS** [(PidTagDefaultPostMessageClass)](https://msdn.microsoft.com/library/cc815305\(v=office.15\)) nicht gefunden wird und Outlook einen Fehler löst, wird **versucht... catch-Block** gibt die **DefaultMessageClass-Eigenschaft** für folder **zurück.**
