...
- [VBA-Referenz für Outlook](https://msdn.microsoft.com/de-DE/library/ee861520.aspx)
  
- [Outlook 2010](https://msdn.microsoft.com/de-DE/library/cc313152%28v=office.12%29.aspx)
  
### <a name="office-add-ins"></a>Office-Add-Ins
  
- [Erste Schritte mit Outlook-Add-Ins](https://docs.microsoft.com/de-DE/outlook/add-ins/quick-start)
  
- [Plattformübersicht](https://docs.microsoft.com/de-DE/office/dev/add-ins/overview/office-add-ins)
  
### <a name="code-samples"></a>Codebeispiele
  
- [Outlook-Codebeispiele im Office Developer Center](https://dev.office.com/code-samples#?filters=outlook)
