...
Diese Eigenschaft ist ein temporärer Wert, der nur für die Lebensdauer des Objekts gültig ist, das Besitzer der Tabelle ist. Sie wird als Spalte der Tabelle angezeigt, aber nicht gespeichert.
