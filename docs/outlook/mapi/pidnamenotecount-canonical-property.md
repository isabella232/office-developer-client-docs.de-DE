---
title: Kanonische PidNameNoteCount-Eigenschaft
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="pidnamenotecount-canonical-property"></a>Kanonische PidNameNoteCount-Eigenschaft

  
  
**Betrifft**: Outlook 
  
Gibt die Anzahl von Notizen in der Datei, die an das Dokument angefügt ist.
  
|||
|:-----|:-----|
|Anzeigenamen:  <br/> |Keine  <br/> |
|-Eigenschaft festgelegt:  <br/> |PS_PUBLIC_STRINGS  <br/> |
|Name der Eigenschaft:  <br/> |NoteCount  <br/> |
