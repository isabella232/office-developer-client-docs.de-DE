...
Enthält den Suchschlüssel des Nachrichtensenders.
...
Wenn kein Transportanbieter Absenderadresseneigenschaften angegeben hat, versucht der MAPI-Spooler, sie durch Aufrufen der [IMAPISession::QueryIdentity-Methode](imapisession-queryidentity.md) für einen Eintragsbezeichner zu füllen. Wenn keine Eintragsbezeichner angegeben wurden, speichert der MAPI-Spooler einen Schlüssel, der der Zeichenfolge "Unknown" in dieser Eigenschaft entspricht. 
