...
Wenn keine Adressbuchhierarchie alle Eigenschaften des Absenders-Adresse angegeben, versucht die MAPI-Warteschlange werden durch Aufrufen der [IMAPISession::QueryIdentity](imapisession-queryidentity.md) -Methode für die Eintrags-ID ausfüllen. Wenn keine Eintragsbezeichner bereitgestellt wurde, speichert die MAPI-Warteschlange einen Schlüssel, der die Zeichenfolge "Unknown" in dieser Eigenschaft entspricht. 
