...
Gibt den vorgeschlagenen Wert für die **Eigenschaft dispidApptEndWhole** ([PidLidAppointmentEndWhole](pidlidappointmentendwhole-canonical-property.md)) für einen Zählervorschlag an.
