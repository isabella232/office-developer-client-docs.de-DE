...
## <a name="return-value"></a><span data-ttu-id="55bf6-115">R�ckgabewert</span><span class="sxs-lookup"><span data-stu-id="55bf6-115">Return value</span></span>

<span data-ttu-id="55bf6-116">S_OK</span><span class="sxs-lookup"><span data-stu-id="55bf6-116">S_OK</span></span> 
  
> <span data-ttu-id="55bf6-117">Der Aufruf erfolgreich ausgef�hrt und der erwartete Wert oder Werte zur�ckgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="55bf6-117">The call succeeded and has returned the expected value or values.</span></span>
