---
title: Kanonische PidNameEditTime-Eigenschaft
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="pidnameedittime-canonical-property"></a>Kanonische PidNameEditTime-Eigenschaft

  
  
**Betrifft**: Outlook 
  
Gibt an, wann die Datei zuletzt bearbeitet wurde.
  
|||
|:-----|:-----|
|Anzeigenamen:  <br/> |Keine  <br/> |
|-Eigenschaft festgelegt:  <br/> |PS_PUBLIC_STRINGS  <br/> |
|Name der Eigenschaft:  <br/> |EditTime  <br/> |
