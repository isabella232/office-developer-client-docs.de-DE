...
---
# <a name="pidlidlogdocumentsaved-canonical-property"></a>Kanonische Pidlidlogdocumentsaved (-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Gibt an, ob das Dokument während des Journals gespeichert wurde.
  
|||
|:-----|:-----|
|Zugeordnete Eigenschaften:  <br/> |dispidLogDocSaved  <br/> |
|Eigenschaftensatz:  <br/> |PSETID_Log  <br/> |
|Long-ID (Deckel):  <br/> |0x0000870F  <br/> |
