...
---
# <a name="pidlidfax1richtextformat-canonical-property"></a>Kanonische Pidlidfax1richtextformat (-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Gibt das Rich-Text-Format der Geschäfts-Faxnummer des Kontakts an.
  
|||
|:-----|:-----|
|Zugeordnete Eigenschaften:  <br/> |dispidFax1RTF  <br/> |
|Eigenschaftensatz:  <br/> |PSETID_Address  <br/> |
|Long-ID (Deckel):  <br/> |0x000080B6  <br/> |
