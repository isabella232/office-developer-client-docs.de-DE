...
## <a name="return-value"></a><span data-ttu-id="b08d8-118">Rückgabewert</span><span class="sxs-lookup"><span data-stu-id="b08d8-118">Return value</span></span>

<span data-ttu-id="b08d8-119">S_OK</span><span class="sxs-lookup"><span data-stu-id="b08d8-119">S_OK</span></span> 
  
> <span data-ttu-id="b08d8-120">Der Aufruf erfolgreich ausgef�hrt und der erwartete Wert oder Werte zurückgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="b08d8-120">The call succeeded and has returned the expected value or values.</span></span>
