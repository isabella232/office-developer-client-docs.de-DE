...
> <span data-ttu-id="b08d8-120">Der Aufruf erfolgreich ausgeführt und der erwartete Wert oder Werte zurückgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="b08d8-120">The call succeeded and has returned the expected value or values.</span></span>
