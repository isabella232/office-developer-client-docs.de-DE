...
Diese Eigenschaft wird nur für einen Stellvertreter festgelegt, wenn ein Delegat antwortete. Der Wert ist gleich der **PR_MAILBOX_OWNER_NAME** ([pidtagmailboxownername (](pidtagmailboxownername-canonical-property.md))-Eigenschaft für den Speicher des Stellvertreters. Diese Eigenschaft hat keine Bedeutung für den Organisator. Ausführliche Informationen zu **PR_MAILBOX_OWNER_NAME**finden Sie unter in [[MS-OXCSTOR]](https://msdn.microsoft.com/library/d42ed1e0-3e77-4264-bd59-7afc583510e2%28Office.15%29.aspx)angegebene Store Object Protocol.
