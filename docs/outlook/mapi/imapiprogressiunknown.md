...
|:-----|:-----|:-----|
|MapiProgress. h und MapiProgress. cpp  <br/> |Nicht anwendbar  <br/> |Wenn die IMAPIProgress-Einstellung aktiviert ist, übergibt MFCMAPI eine **IMAPIProgress** -Implementierung an alle Funktionen, die MfcMapi aufrufen, die eine Implementierung akzeptieren.  <br/> |
