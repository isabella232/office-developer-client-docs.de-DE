...
|<span data-ttu-id="daf0d-110">Verfügbar gemacht von:</span><span class="sxs-lookup"><span data-stu-id="daf0d-110">Exposed by:</span></span>  <br/> |<span data-ttu-id="daf0d-111">Fortschritt-Objekte</span><span class="sxs-lookup"><span data-stu-id="daf0d-111">Progress objects</span></span>  <br/> |
