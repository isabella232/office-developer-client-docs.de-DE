...
|Long-ID (Deckel):  <br/> |0x00008514  <br/> |
...
Es gibt an, ob das Nachrichtenobjekt keine Endbenutzer Sicht Bare Anlagen hat. Diese Eigenschaft ist möglicherweise unset; Wenn dies der Fall ist, wird der Standardwert FALSE angenommen.
