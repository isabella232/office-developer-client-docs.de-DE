...
Gibt eine Liste der **PR_ENTRYID** ([PidTagEntryId](pidtagentryid-canonical-property.md)) -Eigenschaft von Vorgängen an, die mit dem Kalender verknüpft sind. 
