...
|<span data-ttu-id="992bd-110">Verfügbar gemacht von:</span><span class="sxs-lookup"><span data-stu-id="992bd-110">Exposed by:</span></span>  <br/> |<span data-ttu-id="992bd-111">Message-Speicher-Anbieter-Objekte</span><span class="sxs-lookup"><span data-stu-id="992bd-111">Message store provider objects</span></span>  <br/> |
