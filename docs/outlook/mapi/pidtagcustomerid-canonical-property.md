...
---
# <a name="pidtagcustomerid-canonical-property"></a>Kanonische Pidtagcustomerid (-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Enthält die Kunden-ID des Kontakts.
...
Die Inhalte dieser Eigenschaften werden vom Benutzer oder der Organisation des Benutzers definiert.
