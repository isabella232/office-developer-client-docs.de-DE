...
Im Feld Meldung ID gemäß [RFC2822] entspricht.
  
|||
|:-----|:-----|
|Zugeordneten Eigenschaften:  <br/> |PR_INTERNET_MESSAGE_ID, PR_INTERNET_MESSAGE_ID_A, PR_INTERNET_MESSAGE_ID_W  <br/> |
|Bezeichner:  <br/> |0x1035  <br/> |
