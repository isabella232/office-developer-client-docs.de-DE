...
---
# <a name="pidtagexpirytime-canonical-property"></a>Kanonische PidTagExpiryTime-Eigenschaft
...
|||
|:-----|:-----|
|Zugeordneten Eigenschaften:  <br/> |PR_EXPIRY_TIME  <br/> |
|Bezeichner:  <br/> |0x0015  <br/> |
