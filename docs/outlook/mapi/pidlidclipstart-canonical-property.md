...
Gibt das Startdatum und die Startzeit des Ereignisses in koordinierter weltZeit (UTC) für Kalenderobjekte mit einfacher Instanz an und gibt Mitternacht für das Datum der ersten Instanz in UTC für eine wiederkehrende Datenreihe an.
  
|||
|:-----|:-----|
|Zugeordnete Eigenschaften:  <br/> |dispidClipStart  <br/> |
|Eigenschaftensatz:  <br/> |PSETID_Appointment  <br/> |
|Long-ID (Deckel):  <br/> |0x00008235  <br/> |
