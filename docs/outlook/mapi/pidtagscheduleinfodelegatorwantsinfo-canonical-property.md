---
title: Kanonische PidTagScheduleInfoDelegatorWantsInfo-Eigenschaft
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="pidtagscheduleinfodelegatorwantsinfo-canonical-property"></a>Kanonische PidTagScheduleInfoDelegatorWantsInfo-Eigenschaft
