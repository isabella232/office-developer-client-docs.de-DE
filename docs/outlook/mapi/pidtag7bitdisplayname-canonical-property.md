...
Enthält eine 7-Bit-ASCII-Darstellung des Namens eines Messaging Benutzers. 
...
Diese Eigenschaften ordnen die **PR_DISPLAY_NAME** ([PidTagDisplayName](pidtagdisplayname-canonical-property.md))-Eigenschaft in einem 7-Bit-Zeichensatz zu. Einige Messagingsysteme wie Internet und bestimmte X. 400-Links sind auf den 7-Bit-ASCII-Codesatz mit 128 Zeichen beschränkt. Gateways für solche Messagingsysteme können Ihre Leistung verbessern, indem Sie die [IAddrBook::P reparerecips](iaddrbook-preparerecips.md) -Methode direkt aufrufen, um die diese Eigenschaft abzurufen, wodurch die zusätzliche Verarbeitung für die Codekonvertierung vermieden wird. 
...
> Verarbeitet die Reihenfolge und den Datenfluss, die zum Übertragen von Daten zwischen Client und Server verwendet werden.
