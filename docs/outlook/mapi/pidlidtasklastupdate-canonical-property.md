...
Gibt die koordinierte weltZeit (UTC) und das Datum der letzten Änderung an, die an der Aufgabe vorgenommen und von der **dispidTaskHistory** ([pidlidtaskhistory (](pidlidtasklastupdate-canonical-property.md))-Eigenschaft angegeben wurde.
  
|||
|:-----|:-----|
|Zugeordnete Eigenschaften:  <br/> |dispidTaskLastUpdate  <br/> |
|Eigenschaftensatz:  <br/> |PSETID_Task  <br/> |
|Long-ID (Deckel):  <br/> |0x00008115  <br/> |
