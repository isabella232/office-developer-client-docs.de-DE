...
## <a name="return-value"></a><span data-ttu-id="7ca82-111">R�ckgabewert</span><span class="sxs-lookup"><span data-stu-id="7ca82-111">Return value</span></span>

<span data-ttu-id="7ca82-112">S_OK</span><span class="sxs-lookup"><span data-stu-id="7ca82-112">S_OK</span></span> 
  
> <span data-ttu-id="7ca82-113">Der Aufruf erfolgreich ausgef�hrt und der erwartete Wert oder Werte zur�ckgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="7ca82-113">The call succeeded and has returned the expected value or values.</span></span>
