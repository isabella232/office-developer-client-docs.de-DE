...
> <span data-ttu-id="7ca82-113">Der Aufruf erfolgreich ausgef�hrt und der erwartete Wert oder Werte zurückgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="7ca82-113">The call succeeded and has returned the expected value or values.</span></span>
