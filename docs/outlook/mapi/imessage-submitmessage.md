...
> <span data-ttu-id="55953-115">Der Aufruf erfolgreich ausgeführt und der erwartete Wert oder Werte zurückgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="55953-115">The call succeeded and has returned the expected value or values.</span></span>
