...
> <span data-ttu-id="f6a59-114">Der Aufruf erfolgreich ausgef�hrt und der erwartete Wert oder Werte zur�ckgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="f6a59-114">The call succeeded and has returned the expected value or values.</span></span>
