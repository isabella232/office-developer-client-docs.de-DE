...
---
# <a name="pidlidnonsendableto-canonical-property"></a>Kanonische Pidlidnonsendableto (-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Enthält eine Liste aller nicht sendenden Teilnehmer, die ebenfalls erforderliche Teilnehmer sind.
  
|||
|:-----|:-----|
|Zugeordnete Eigenschaften:  <br/> |dispidNonSendableTo  <br/> |
|Eigenschaftensatz:  <br/> |PSETID_Common  <br/> |
|Long-ID (Deckel):  <br/> |0x00008536  <br/> |
