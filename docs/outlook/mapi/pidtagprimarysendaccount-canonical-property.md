...
Gibt den ersten Server an, der vom Client zum Senden der e-Mail verwendet werden soll. Das Format dieser Eigenschaften ist abhängig von der Implementierung. Diese Eigenschaften können vom Client verwendet werden, um zu bestimmen, auf welchem Server die e-Mail weitergeleitet werden soll, aber optional ist und der Wert keine Bedeutung für den Server hat.
