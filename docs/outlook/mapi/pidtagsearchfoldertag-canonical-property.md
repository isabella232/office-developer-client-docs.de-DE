...
Enthält den Wert, mit dem diese Definitions Nachricht mit dem übereinstimmenden Suchordner Container synchronisiert wird.
...
Diese Eigenschaft wird geändert, wenn die Definitions Meldung geändert wird. Es muss jede Iteration ändern, aber möglicherweise nicht eindeutig.
