...
Enthält den Wert, der zum Synchronisieren dieser Definitionsnachricht mit dem übereinstimmenden Suchordnercontainer verwendet wird.
...
Diese Eigenschaft wird geändert, wenn die Definitionsnachricht geändert wird. Sie muss jede Iteration ändern, ist aber möglicherweise nicht eindeutig.
