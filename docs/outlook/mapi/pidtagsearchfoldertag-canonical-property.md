...
Enthält den Wert, der zum Synchronisieren dieser Definitionsnachricht mit dem entsprechenden Suchordnercontainer verwendet wird.
  
|||
|:-----|:-----|
|Zugeordnete Eigenschaften:  <br/> |PR_WB_SF_TAG  <br/> |
...
Diese Eigenschaft wird geändert, wenn die Definitionsnachricht geändert wird. Es muss jede Iteration ändern, aber möglicherweise nicht eindeutig.
