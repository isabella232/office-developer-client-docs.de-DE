...
In diesem Thema werden häufig verwendete Gruppen von benannten Eigenschaften aufgelistet.
  
## <a name="commonly-used-property-sets"></a>Häufig verwendete Eigenschaftensätze

In der folgenden Tabelle sind die einzelnen Eigenschaftensätze mit GUID und Funktionsbereich aufgeführt.
  
|**Bereich**|**Eigenschaftensatz Name und GUID-Wert**|
|:-----|:-----|
...
|Allgemeine Nachrichtenübermittlung  <br/> |PSETID_Report {00062013-0000-0000-C000-000000000046}  <br/> |
