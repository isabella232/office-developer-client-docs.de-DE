---
title: Kanonische Pidtagycoordinate (-Eigenschaft
manager: soliver
ms.date: 03/09/2015
...
Enthält die y-Koordinate der Anfangsposition (der oberen linken Ecke) eines Dialogfeld-Steuerelements in Windows-Standarddialog Einheiten.
