...
---
# <a name="pidtagscheduleinfodelegatenames-canonical-property"></a>Kanonische Pidtagscheduleinfodelegatenames (-Eigenschaft
...
Jeder Eintrag in diesen Eigenschaften muss den Wert der **PR_DISPLAY_NAME** ([PidTagDisplayName](pidtagdisplayname-canonical-property.md))-Eigenschaft des Adressbuchs der einzelnen Delegaten enthalten.
