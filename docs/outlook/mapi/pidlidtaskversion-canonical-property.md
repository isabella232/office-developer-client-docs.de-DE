...
|Long-ID (Deckel):  <br/> |0x00008112  <br/> |
|Datentyp:  <br/> |PT_LONG  <br/> |
|Bereich:  <br/> |Aufgabe  <br/> |
   
## <a name="remarks"></a>Bemerkungen

Aktualisierungen mit niedrigeren Versionen als der Vorgang werden ignoriert. 
  
Beim Einbetten einer Aufgabe in eine Aufgaben Kommunikation legt der Client auch die aktuelle Version der eingebetteten Aufgabe auf die Aufgaben Kommunikation fest.
