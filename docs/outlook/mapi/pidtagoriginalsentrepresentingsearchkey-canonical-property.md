...
---
# <a name="pidtagoriginalsentrepresentingsearchkey-canonical-property"></a>Kanonische PidTagOriginalSentRepresentingSearchKey-Eigenschaft
...
Senden einer Nachricht im Auftrag einer anderen Client-Clientanwendung sollte diese Eigenschaft auf den Wert der Eigenschaft **PR_SENT_REPRESENTING_SEARCH_KEY** ([PidTagSentRepresentingSearchKey](pidtagsentrepresentingsearchkey-canonical-property.md)) auf der ersten Übermittlung der Nachricht festgelegt. Einmal festgelegt ist, sollte es nicht geändert werden.
