...
---
# <a name="pidtagusercertificate-canonical-property"></a>Kanonische PidTagUserCertificate-Eigenschaft
...
|||
|:-----|:-----|
|Zugeordneten Eigenschaften:  <br/> |PR_USER_CERTIFICATE  <br/> |
|Bezeichner:  <br/> |0x3A22  <br/> |
