...
2. <span data-ttu-id="64203-128">Rufen Sie das Formular [IUnknown:: AddRef](http://msdn.microsoft.com/de-de/library/ms691379%28VS.85%29.aspx) -Methode, sodass Speicher für das Formular und alle internen Datenstrukturen verfügbar bleiben, bis die Verarbeitung beendet wird.</span><span class="sxs-lookup"><span data-stu-id="64203-128">Call your form's [IUnknown::AddRef](http://msdn.microsoft.com/de-de/library/ms691379%28VS.85%29.aspx) method so that storage for the form and any internal data structures remain available until processing is finished.</span></span> 
...
5. <span data-ttu-id="64203-132">Freigeben des Formulars Nachricht und Standortobjekten Nachricht durch ihre [IUnknown](http://msdn.microsoft.com/de-de/library/ms682317%28v=VS.85%29.aspx) -Methoden aufrufen.</span><span class="sxs-lookup"><span data-stu-id="64203-132">Release your form's message and message site objects by calling their [IUnknown::Release](http://msdn.microsoft.com/de-de/library/ms682317%28v=VS.85%29.aspx) methods.</span></span> 
