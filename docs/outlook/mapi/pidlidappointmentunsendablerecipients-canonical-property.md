...
Enthält eine Liste der nicht sendenden Teilnehmer.
  
|||
|:-----|:-----|
|Zugeordnete Eigenschaften:  <br/> |dispidApptUnsendableRecips  <br/> |
|Eigenschaftensatz:  <br/> |PSETID_Appointment  <br/> |
|Long-ID (Deckel):  <br/> |0x0000823D  <br/> |
|Datentyp:  <br/> |PT_BINARY  <br/> |
|Bereich:  <br/> |Meetings  <br/> |
   
## <a name="remarks"></a>Bemerkungen

Diese Eigenschaft ist nicht erforderlich, muss jedoch festgelegt werden. Das Format ist in [[MS-OXOCAL]](https://msdn.microsoft.com/library/09861fde-c8e4-4028-9346-e7c214cfdba1%28Office.15%29.aspx)detailliert.
