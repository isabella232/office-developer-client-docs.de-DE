...
## <a name="return-value"></a><span data-ttu-id="619ca-118">Rückgabewert</span><span class="sxs-lookup"><span data-stu-id="619ca-118">Return value</span></span>

<span data-ttu-id="619ca-119">S_OK</span><span class="sxs-lookup"><span data-stu-id="619ca-119">S_OK</span></span> 
  
> <span data-ttu-id="619ca-120">Der Aufruf erfolgreich ausgeführt und der erwartete Wert oder Werte zurückgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="619ca-120">The call succeeded and has returned the expected value or values.</span></span>
