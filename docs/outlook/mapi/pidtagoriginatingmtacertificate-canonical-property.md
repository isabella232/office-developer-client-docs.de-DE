...
---
# <a name="pidtagoriginatingmtacertificate-canonical-property"></a>Kanonische Pidtagoriginatingmtacertificate (-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Enthält einen Bezeichner für den MTA (Message Transfer Agent), der die Nachricht entstand.
...
Diese Eigenschaft entspricht dem Attribut X. 400-Bericht pro Nachricht.
