...
Der Wert FALSE oder das Fehlen dieser Eigenschaft gibt an, dass noch nie eine Besprechungsanfrage gesendet wurde. Der Wert TRUE gibt an, dass eine Besprechungsanfrage gesendet wurde. Sobald dieser Wert in einer Besprechung auf TRUE festgelegt ist, darf er nicht mehr geändert werden.
