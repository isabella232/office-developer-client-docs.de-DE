...
> <span data-ttu-id="49ac1-119">Der Aufruf erfolgreich ausgeführt und der erwartete Wert oder Werte zurückgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="49ac1-119">The call succeeded and has returned the expected value or values.</span></span> 
