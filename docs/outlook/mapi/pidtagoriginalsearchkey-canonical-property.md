...
---
# <a name="pidtagoriginalsearchkey-canonical-property"></a>Kanonische Pidtagoriginalsearchkey (-Eigenschaft
...
Bei einem nicht gelesenen Bericht enthält diese Eigenschaft eine Kopie des Suchschlüssels des ursprünglichen Nachrichtenempfängers, für den der Bericht generiert wird. Wenn der ursprüngliche Empfänger Teil einer Verteilerliste ist, wird der Suchschlüssel der Verteilerliste für den Bericht beibehalten.
