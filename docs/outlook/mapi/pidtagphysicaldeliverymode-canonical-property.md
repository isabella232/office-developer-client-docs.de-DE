...
Enthält eine Bitmaske mit Flags, die den physischen Zustellungsmodus (z. B. spezielle Zustellung) für eine Nachricht definieren, die für einen bestimmten Empfänger bestimmt ist.
