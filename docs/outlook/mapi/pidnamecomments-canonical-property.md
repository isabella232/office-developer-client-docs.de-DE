...
ms.locfileid: "59604348"
---
# <a name="pidnamecomments-canonical-property"></a>Kanonische PidNameComments-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Gibt die Kommentare der Datei an, die an das Dokument angefügt ist.
  
|||
|:-----|:-----|
|Anzeigenamen:  <br/> |Keines  <br/> |
|Eigenschaftensatz:  <br/> |PS_PUBLIC_STRINGS  <br/> |
|Eigenschaftenname:  <br/> |Kommentare  <br/> |
