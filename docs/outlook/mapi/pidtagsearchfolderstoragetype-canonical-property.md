...
Enthält Flags, mit denen die BLOB-Daten (Binary Large Object) angegeben werden, die in der **PR_WB_SF_DEFINITION** ([pidtagsearchfolderdefinition (](pidtagsearchfolderdefinition-canonical-property.md))-Eigenschaft angezeigt werden.
...
Die Definitionen der Flags werden in [[MS-OXOSRCH]](https://msdn.microsoft.com/library/c72e49b8-78c7-4483-ad65-e46e9133673b%28Office.15%29.aspx)angegeben. Suchen Sie nach **PR_WB_SF_STORAGE_TYPE**.
