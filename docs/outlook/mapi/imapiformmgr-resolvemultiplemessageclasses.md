...
## <a name="return-value"></a><span data-ttu-id="9ffb0-122">Rückgabewert</span><span class="sxs-lookup"><span data-stu-id="9ffb0-122">Return value</span></span>

<span data-ttu-id="9ffb0-123">S_OK</span><span class="sxs-lookup"><span data-stu-id="9ffb0-123">S_OK</span></span> 
  
> <span data-ttu-id="9ffb0-124">Der Aufruf erfolgreich ausgeführt und der erwartete Wert oder Werte zurückgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="9ffb0-124">The call succeeded and has returned the expected value or values.</span></span>
