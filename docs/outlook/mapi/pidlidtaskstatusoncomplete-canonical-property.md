...
---
# <a name="pidlidtaskstatusoncomplete-canonical-property"></a>Kanonische Pidlidtaskstatusoncomplete (-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Gibt an, ob der Aufgabenempfänger aufgefordert wurde, ein e-Mail-Nachrichten Update zu senden, wenn Sie die zugewiesene Aufgabe abschließen.
  
|||
|:-----|:-----|
|Zugeordnete Eigenschaften:  <br/> |dispidTaskSOC  <br/> |
|Eigenschaftensatz:  <br/> |PSETID_Task  <br/> |
|Long-ID (Deckel):  <br/> |0x00008119  <br/> |
