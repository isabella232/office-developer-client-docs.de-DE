...
---
# <a name="supporting-formatted-text-in-outgoing-messages-client-responsibilities"></a>Unterstützung von formatierten Text in ausgehenden Nachrichten: Client Zuständigkeiten
