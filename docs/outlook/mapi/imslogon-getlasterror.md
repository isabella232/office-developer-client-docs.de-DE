...
> <span data-ttu-id="fbc35-120">Der Aufruf erfolgreich ausgeführt und der erwartete Wert oder Werte zurückgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="fbc35-120">The call succeeded and has returned the expected value or values.</span></span>
