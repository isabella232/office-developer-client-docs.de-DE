...
## <a name="return-value"></a><span data-ttu-id="fbc35-118">R�ckgabewert</span><span class="sxs-lookup"><span data-stu-id="fbc35-118">Return value</span></span>

<span data-ttu-id="fbc35-119">S_OK</span><span class="sxs-lookup"><span data-stu-id="fbc35-119">S_OK</span></span> 
  
> <span data-ttu-id="fbc35-120">Der Aufruf erfolgreich ausgef�hrt und der erwartete Wert oder Werte zur�ckgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="fbc35-120">The call succeeded and has returned the expected value or values.</span></span>
