...
> <span data-ttu-id="72d0a-112">Der Aufruf erfolgreich ausgeführt und der erwartete Wert oder Werte zurückgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="72d0a-112">The call succeeded and has returned the expected value or values.</span></span>
