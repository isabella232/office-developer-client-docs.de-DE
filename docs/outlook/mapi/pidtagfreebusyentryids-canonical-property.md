...
---
# <a name="pidtagfreebusyentryids-canonical-property"></a>Kanonische Pidtagfreebusyentryids (-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Enthält die **EntryIDs** für die Nachricht zum Delegieren von Informationen, die Frei/Gebucht-Nachricht des angemeldeten Benutzers und den Ordner, dessen **PR_DISPLAY_NAME** ([PidTagDisplayName](pidtagdisplayname-canonical-property.md)) gleich "freebusy Data" ist.
