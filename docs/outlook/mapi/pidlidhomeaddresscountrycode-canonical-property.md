...
Gibt den Ländercodeteil der Privatadresse des Kontakts an.
  
|||
|:-----|:-----|
|Zugeordnete Eigenschaften:  <br/> |dispidHomeAddressCountryCode  <br/> |
|Eigenschaftensatz:  <br/> |PSETID_Address  <br/> |
|Lange ID (LID):  <br/> |0x000080DA  <br/> |
...
> Gibt die Eigenschaften und Vorgänge an, die für Contacst- und persönliche Verteilerlisten zulässig sind.
