...
---
# <a name="pidtagformdesignername-canonical-property"></a>Kanonische Pidtagformdesignername (-Eigenschaft
...
Diese Eigenschaften enthalten den eindeutigen Bezeichner für das Designer-Objekt des Formulars. 
