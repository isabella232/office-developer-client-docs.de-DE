...
## <a name="mfcmapi-reference"></a><span data-ttu-id="2559c-163">MFCMAPI (engl.) (engl.)</span><span class="sxs-lookup"><span data-stu-id="2559c-163">MFCMAPI reference</span></span>
