...
Gibt an, ob für jede diesem Kontakt zugeordnete Aktion ein Journal erstellt werden soll.
  
|||
|:-----|:-----|
|Zugeordnete Eigenschaften:  <br/> |dispidAutoLog  <br/> |
|Eigenschaftensatz:  <br/> |PSETID_Address  <br/> |
|Long-ID (Deckel):  <br/> |0x00008025  <br/> |
...
> Gibt die Eigenschaften und Vorgänge an, die für Kontakte und persönliche Verteilerliste zulässig sind.
