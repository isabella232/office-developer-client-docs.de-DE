...
> <span data-ttu-id="4e8a6-114">Der Aufruf erfolgreich ausgef�hrt und der erwartete Wert oder Werte zur�ckgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="4e8a6-114">The call succeeded and has returned the expected value or values.</span></span>
