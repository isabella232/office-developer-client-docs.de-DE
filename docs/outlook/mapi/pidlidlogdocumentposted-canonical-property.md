...
---
# <a name="pidlidlogdocumentposted-canonical-property"></a>Kanonische Pidlidlogdocumentposted (-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Gibt an, ob das Dokument während der Journalerstellung per e-Mail oder an einen Serverordner gesendet wurde.
  
|||
|:-----|:-----|
|Zugeordnete Eigenschaften:  <br/> |dispidLogDocPosted  <br/> |
|Eigenschaftensatz:  <br/> |PSETID_Log  <br/> |
|Long-ID (Deckel):  <br/> |0x00008711  <br/> |
