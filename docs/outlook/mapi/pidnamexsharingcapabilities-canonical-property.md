...
|Eigenschaftenname:  <br/> |X-Sharing-Funktionen  <br/> |
|Datentyp:  <br/> |PT_UNICODE  <br/> |
|Bereich:  <br/> |Freigabe  <br/> |
   
## <a name="remarks"></a>HinwBemerkungeneise

Diese Eigenschaft enthält einen Wert, der die Freigabefunktionen des Nachrichtenobjekts angibt.
