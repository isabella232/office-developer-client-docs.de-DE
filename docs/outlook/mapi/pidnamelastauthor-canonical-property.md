...
---
# <a name="pidnamelastauthor-canonical-property"></a>Kanonische Pidnamelastauthor (-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Gibt den neuesten Autor der angefügten Datei an.
  
|||
|:-----|:-----|
|Angezeigte Namen:  <br/> |Keine  <br/> |
|Eigenschaftensatz:  <br/> |PS_PUBLIC_STRINGS  <br/> |
|Eigenschaftsname:  <br/> |LastAuthor  <br/> |
