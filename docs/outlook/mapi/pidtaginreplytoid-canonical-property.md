...
Enthält den **PR_INTERNET_MESSAGE_ID** ([pidtaginternetmessageid (](pidtaginternetmessageid-canonical-property.md))-Eigenschaftswert der ursprünglichen Nachricht.
...
Diese Eigenschaften müssen für alle Antworten der Nachricht festgelegt werden.
