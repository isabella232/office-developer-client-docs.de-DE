...
---
# <a name="pidtagreceivedbyentryid-canonical-property"></a>Kanonische PidTagReceivedByEntryId-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Enthält die Eintrags-ID des Messaging Benutzers, der die Nachricht tatsächlich empfängt.
...
Diese Eigenschaft ist eine der Adresseigenschaften für den Messagingbenutzer, der die Nachricht empfängt. Sie muss vom eingehenden Transportanbieter festgelegt werden.
  
Diese Eigenschaft entspricht dem MH_T_-Attribut X. 400-Übermittlungs Umschlag pro Nachricht.
