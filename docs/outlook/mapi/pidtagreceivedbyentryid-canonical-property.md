...
Enthält die Eintrags-ID des Messagingbenutzers, der die Nachricht tatsächlich empfängt.
...
Diese Eigenschaft ist eine der Adresseigenschaften für den Messagingbenutzer, der die Nachricht empfängt. Sie muss vom anbieter für eingehende Transporte festgelegt werden.
  
Diese Eigenschaft entspricht einem X.400-Zustellungsumschlag pro MH_T_-Attribut.
