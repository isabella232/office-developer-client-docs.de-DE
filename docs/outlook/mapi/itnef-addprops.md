...
> Nur Eigenschaften aus der Nachricht oder einer Anlage, die durch den _UlElemID_ -Parameter angegebenen codiert. Wenn dieses Flag festgelegt ist, muss der Wert in _LpvData_ ein [IStream](http://msdn.microsoft.com/library/stg.istream%28Office.15%29.aspx) Zeiger sein. 
