...
> <span data-ttu-id="3a8e8-112">Der Aufruf erfolgreich ausgef�hrt und der erwartete Wert oder Werte zur�ckgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="3a8e8-112">The call succeeded and has returned the expected value or values.</span></span>
