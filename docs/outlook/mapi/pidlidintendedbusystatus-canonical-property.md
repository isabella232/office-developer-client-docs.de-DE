...
Gibt den Wert der **eigenschaft dispidBusyStatus** ([PidLidBusyStatus](pidlidbusystatus-canonical-property.md)) für die Besprechung im Kalender des Organisators an, wenn die Besprechungsanfrage oder das Besprechungsupdate gesendet wurde.
  
|||
|:-----|:-----|
|Zugeordnete Eigenschaften:  <br/> |dispidIntendedBusyStatus  <br/> |
|Eigenschaftensatz:  <br/> |PSETID_Appointment  <br/> |
|Lange ID (LID):  <br/> |0x00008224  <br/> |
|Datentyp:  <br/> |PT_LONG  <br/> |
|Bereich:  <br/> |Besprechungen  <br/> |
   
## <a name="remarks"></a>Hinweise

Die zulässigen Werte dieser Eigenschaft sind mit denen für die Eigenschaft **dispidBusyStatus identisch.**
