...
Gibt den Dateinamen des Sounds an, der vom Client wiedergegeben werden soll, wenn die Erinnerung für dieses Objekt überfällig wird.
  
|||
|:-----|:-----|
|Zugeordnete Eigenschaften:  <br/> |dispidReminderFileParam  <br/> |
|Eigenschaftensatz:  <br/> |PSETID_Common  <br/> |
|Long-ID (Deckel):  <br/> |0x0000851F  <br/> |
