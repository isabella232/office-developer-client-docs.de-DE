...
Gibt den Dateinamen des Sounds an, den ein Client wiedergibt, wenn die Erinnerung für dieses Objekt überfällig wird.
  
|||
|:-----|:-----|
|Zugeordnete Eigenschaften:  <br/> |dispidReminderFileParam  <br/> |
|Eigenschaftensatz:  <br/> |PSETID_Common  <br/> |
|Lange ID (LID):  <br/> |0x0000851F  <br/> |
|Datentyp:  <br/> |PT_UNICODE  <br/> |
|Bereich:  <br/> |Erinnerung  <br/> |
   
## <a name="remarks"></a>Hinweise

Wenn diese Eigenschaft nicht vorhanden ist, verwendet der Client möglicherweise einen Standardwert.
