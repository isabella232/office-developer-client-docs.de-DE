...
> <span data-ttu-id="e7ed9-127">Der Aufruf erfolgreich ausgef�hrt und der erwartete Wert oder Werte zur�ckgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="e7ed9-127">The call succeeded and has returned the expected value or values.</span></span>
