...
Stellt Optimierungshinweise zu den Empfängern einer Aufgabe bereit.
...
Wenn diese Eigenschaft festgelegt ist, muss sie auf eine bitweise **OR-Operation** von Null oder mehr der folgenden Werte festgelegt werden. 
  
|**Name**|**Wert**|**Beschreibung**|
|:-----|:-----|:-----|
|Gesendet  <br/> |0x00000001  <br/> |Die Aufgabe hat mehrere primäre Empfänger.  <br/> |
|Auszahlung  <br/> |0x00000002  <br/> |Obwohl der Sent-Hinweis nicht vorhanden war, hat der Client festgestellt, dass die Aufgabe mehrere primäre Empfänger hat.  <br/> |
