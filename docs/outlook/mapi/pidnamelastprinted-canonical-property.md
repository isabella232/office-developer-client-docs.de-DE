---
title: Kanonische PidNameLastPrinted-Eigenschaft
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="pidnamelastprinted-canonical-property"></a>Kanonische PidNameLastPrinted-Eigenschaft

  
  
**Betrifft**: Outlook 
  
Gibt an, wann die Datei zuletzt gedruckt wurde.
  
|||
|:-----|:-----|
|Anzeigenamen:  <br/> |Keine  <br/> |
|-Eigenschaft festgelegt:  <br/> |PS_PUBLIC_STRINGS  <br/> |
|Name der Eigenschaft:  <br/> |LastPrinted  <br/> |
