...
<span data-ttu-id="6c8d4-117">Suchergebnisse Ordner haben die folgenden Einschränkungen:</span><span class="sxs-lookup"><span data-stu-id="6c8d4-117">Search-results folders have the following limits:</span></span>
