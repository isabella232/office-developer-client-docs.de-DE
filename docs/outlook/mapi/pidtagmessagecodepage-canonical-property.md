...
Enthält die Codeseite, die für die Nachricht verwendet wird.
...
Die Codeseite des Ordnerobjekts wird verwendet, wenn diese Eigenschaft auf Null (0) festgelegt ist.
