...
---
# <a name="pidtagtransportproviders-canonical-property"></a>Kanonische PidTagTransportProviders-Eigenschaft

  
  
**Betrifft**: Outlook 
  
Enthält eine Liste mit den IDs der Transportanbieter im aktuellen Profil.
  
|||
|:-----|:-----|
|Zugeordneten Eigenschaften:  <br/> |PR_TRANSPORT_PROVIDERS  <br/> |
|Bezeichner:  <br/> |0x3D02  <br/> |
