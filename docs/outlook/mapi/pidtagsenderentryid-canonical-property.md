...
Enthält die Eintrags-ID des Nachrichtenabsenders.
...
Wenn kein Transportanbieter Eigenschaften für Absenderadressen angegeben hat, versucht der MAPI-Spooler, diese einzufüllen, indem er die [IMAPISession:: QueryIdentity](imapisession-queryidentity.md) -Methode für eine Eintrags-ID aufruft. Wenn keine Eintrags-IDs angegeben wurden, hat der MAPI-Spooler einen Bezeichner, der der Zeichenfolge "unknown" in dieser Eigenschaft entspricht. 
