...
|<span data-ttu-id="a86f9-109">Verfügbar gemacht von:</span><span class="sxs-lookup"><span data-stu-id="a86f9-109">Exposed by:</span></span>  <br/> |<span data-ttu-id="a86f9-110">Table-Objekte</span><span class="sxs-lookup"><span data-stu-id="a86f9-110">Table objects</span></span>  <br/> |
