...
Enthält einen Wert, der die Sprache angibt, in der der Messagingbenutzer Nachrichten schreibt.
...
Die Zeichenfolge enthält einen einzelnen zweistelligen Länder-/Regionencode. 
