...
Gibt den Verweis [ENTRYID](entryid.md) für den Kontakt an. 
...
Wenn vorhanden, sollte diese Eigenschaft dem Wert der **EntryId** des Kontakts entsprechen. 
