---
title: Kanonische Pidtagradiotelephonenumber (-Eigenschaft
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="pidtagradiotelephonenumber-canonical-property"></a>Kanonische Pidtagradiotelephonenumber (-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Enthält die Telefonnummer des Empfängers.
  
|||
|:-----|:-----|
|Zugeordnete Eigenschaften:  <br/> |PR_RADIO_TELEPHONE_NUMBER, PR_RADIO_TELEPHONE_NUMBER_A, PR_RADIO_TELEPHONE_NUMBER_W  <br/> |
|Kennung:  <br/> |0x3A1D  <br/> |
