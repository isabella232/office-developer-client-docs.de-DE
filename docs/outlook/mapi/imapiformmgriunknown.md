...
|<span data-ttu-id="403d3-108">Verfügbar gemacht von:</span><span class="sxs-lookup"><span data-stu-id="403d3-108">Exposed by:</span></span>  <br/> |<span data-ttu-id="403d3-109">Formular-Manager-Objekte</span><span class="sxs-lookup"><span data-stu-id="403d3-109">Form manager objects</span></span>  <br/> |
