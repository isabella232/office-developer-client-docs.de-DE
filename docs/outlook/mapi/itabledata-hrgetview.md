...
Dienstanbieter Aufrufen **HrGetView** , wenn sie eine Clientzugriff auf eine Tabelle gewähren müssen. **HrGetView** die Ansicht erstellt und gibt den **IMAPITable** Zeiger zurück. Dienstanbieter übergeben wiederum den Mauszeiger an den Client. Wenn der Client mithilfe der Tabelle abgeschlossen ist und dessen [IUnknown](https://msdn.microsoft.com/library/4b494c6f-f0ee-4c35-ae45-ed956f40dc7a%28Office.15%29.aspx) -Methode aufruft, ruft **HrGetView** die Callback-Funktion, die auf den durch den Parameter _LpfCallerRelease_ verwiesen. 
