...
## <a name="return-value"></a><span data-ttu-id="3fab5-109">R�ckgabewert</span><span class="sxs-lookup"><span data-stu-id="3fab5-109">Return value</span></span>

<span data-ttu-id="3fab5-110">S_OK</span><span class="sxs-lookup"><span data-stu-id="3fab5-110">S_OK</span></span> 
  
> <span data-ttu-id="3fab5-111">Der Aufruf erfolgreich ausgef�hrt und der erwartete Wert oder Werte zur�ckgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="3fab5-111">The call succeeded and has returned the expected value or values.</span></span>
