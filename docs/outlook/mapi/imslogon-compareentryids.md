...
## <a name="return-value"></a><span data-ttu-id="8f5c6-121">Rückgabewert</span><span class="sxs-lookup"><span data-stu-id="8f5c6-121">Return value</span></span>

<span data-ttu-id="8f5c6-122">S_OK</span><span class="sxs-lookup"><span data-stu-id="8f5c6-122">S_OK</span></span> 
  
> <span data-ttu-id="8f5c6-123">Der Aufruf erfolgreich ausgef�hrt und der erwartete Wert oder Werte zurückgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="8f5c6-123">The call succeeded and has returned the expected value or values.</span></span>
