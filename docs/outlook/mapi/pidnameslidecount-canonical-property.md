---
title: Kanonische PidNameSlideCount-Eigenschaft
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="pidnameslidecount-canonical-property"></a>Kanonische PidNameSlideCount-Eigenschaft

  
  
**Betrifft**: Outlook 
  
Gibt die Anzahl der Folien in der Datei, die an das Dokument angefügt ist.
  
|||
|:-----|:-----|
|Anzeigenamen:  <br/> |Keine  <br/> |
|-Eigenschaft festgelegt:  <br/> |PS_PUBLIC_STRINGS  <br/> |
|Name der Eigenschaft:  <br/> |SlideCount  <br/> |
