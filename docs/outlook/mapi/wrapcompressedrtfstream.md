...
> <span data-ttu-id="dbc23-126">Der Aufruf erfolgreich ausgeführt und der erwartete Wert oder Werte zurückgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="dbc23-126">The call succeeded and has returned the expected value or values.</span></span>
