...
|<span data-ttu-id="559d9-108">Verfügbar gemacht von:</span><span class="sxs-lookup"><span data-stu-id="559d9-108">Exposed by:</span></span>  <br/> |<span data-ttu-id="559d9-109">Objekt "Message" store</span><span class="sxs-lookup"><span data-stu-id="559d9-109">Message store object</span></span>  <br/> |
