...
---
# <a name="pidtagisdnnumber-canonical-property"></a>Kanonische PidTagIsdnNumber-Eigenschaft

  
  
**Betrifft**: Outlook 
  
ISDN-fähige Telefonnummer des Empfängers enthält. 
  
|||
|:-----|:-----|
|Zugeordneten Eigenschaften:  <br/> |PR_ISDN_NUMBER, PR_ISDN_NUMBER_A, PR_ISDN_NUMBER_W  <br/> |
|Bezeichner:  <br/> |0x3A2D  <br/> |
