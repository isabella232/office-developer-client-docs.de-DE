...
---
# <a name="pidtagmailboxownername-canonical-property"></a>Kanonische PidTagMailboxOwnerName-Eigenschaft
...
|||
|:-----|:-----|
|Zugeordneten Eigenschaften:  <br/> |PR_MAILBOX_OWNER_NAME, PR_MAILBOX_OWNER_NAME_A, PR_MAILBOX_OWNER_NAME_W  <br/> |
