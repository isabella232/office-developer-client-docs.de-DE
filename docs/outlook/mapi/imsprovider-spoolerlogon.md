...
> <span data-ttu-id="eec2b-153">Der Aufruf erfolgreich ausgef�hrt und der erwartete Wert oder Werte zur�ckgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="eec2b-153">The call succeeded and has returned the expected value or values.</span></span>
