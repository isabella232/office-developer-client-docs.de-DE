...
<span data-ttu-id="fb5f9-105">Anstatt vollst�ndige Fehler oder Erfolg melden die folgenden Methoden **IMAPIProp** partiellen Erfolg:</span><span class="sxs-lookup"><span data-stu-id="fb5f9-105">Instead of complete failure or success, the following **IMAPIProp** methods report partial success:</span></span> 
