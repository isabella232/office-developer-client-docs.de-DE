...
|<span data-ttu-id="eac6d-109">Verfügbar gemacht von:</span><span class="sxs-lookup"><span data-stu-id="eac6d-109">Exposed by:</span></span>  <br/> |<span data-ttu-id="eac6d-110">Address Book Container-Objekte</span><span class="sxs-lookup"><span data-stu-id="eac6d-110">Address book container objects</span></span>  <br/> |
