...
Wenn die Besprechungsanfrage eine wiederkehrende Datenreihe oder eine Ausnahme darstellt, ist dies der Wert des CalendarType-Felds aus der **dispidApptRecur** -Eigenschaft. Andernfalls wird diese Eigenschaft nicht festgelegt, und es wird davon ausgegangen, dass Sie 0 ist. 
