...
---
# <a name="supporting-forms-and-views-in-read-only-message-stores"></a><span data-ttu-id="d7816-103">Unterst�tzung von Formularen und Ansichten in nur-Lese Nachrichtenspeicher</span><span class="sxs-lookup"><span data-stu-id="d7816-103">Supporting Forms and Views in Read-Only Message Stores</span></span>
