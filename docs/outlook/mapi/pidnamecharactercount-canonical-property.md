...
---
# <a name="pidnamecharactercount-canonical-property"></a>Kanonische Pidnamecharactercount (-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Gibt die Zeichenanzahl der Datei an, die an das Dokument angefügt ist.
  
|||
|:-----|:-----|
|Angezeigte Namen:  <br/> |Keine  <br/> |
|Eigenschaftensatz:  <br/> |PS_PUBLIC_STRINGS  <br/> |
|Eigenschaftsname:  <br/> |CharCount  <br/> |
