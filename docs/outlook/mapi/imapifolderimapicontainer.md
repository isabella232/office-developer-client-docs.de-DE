...
|<span data-ttu-id="6d9b3-108">Verfügbar gemacht von:</span><span class="sxs-lookup"><span data-stu-id="6d9b3-108">Exposed by:</span></span>  <br/> |<span data-ttu-id="6d9b3-109">Folder-Objekten</span><span class="sxs-lookup"><span data-stu-id="6d9b3-109">Folder objects</span></span>  <br/> |
