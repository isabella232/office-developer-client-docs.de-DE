...
> Beschreibt das Herunterladen und Verwenden von MFCMAPI als Beispielanwendung f�r diese Referenz.
    
[MAPI-Beispiele](mapi-service-provider-samples.md)
  
> Zeigt Beispiele f�r MAPI-Dienstanbieter.
    
[Erstellen von Outlook-Elementen mithilfe von MAPI (engl.)](creating-outlook-items-by-using-mapi.md)
  
> Zeigt Codebeispiele zum Erstellen von Outlook-Elementen mihtilfe von MAPI.
