...
## <a name="return-value"></a><span data-ttu-id="29f9c-115">R�ckgabewert</span><span class="sxs-lookup"><span data-stu-id="29f9c-115">Return value</span></span>

<span data-ttu-id="29f9c-116">S_OK</span><span class="sxs-lookup"><span data-stu-id="29f9c-116">S_OK</span></span> 
  
> <span data-ttu-id="29f9c-117">Der Aufruf erfolgreich ausgef�hrt und der erwartete Wert oder Werte zur�ckgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="29f9c-117">The call succeeded and has returned the expected value or values.</span></span> 
