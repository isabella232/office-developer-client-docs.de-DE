...
---
# <a name="pidtagsenderaddresstype-canonical-property"></a>Kanonische Pidtagsenderaddresstype (-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Enthält den e-Mail-Adresstyp des Nachrichtenabsenders.
...
Diese Eigenschaften sind Beispiele für die Adresseigenschaften für den Absender der Nachricht. Er muss vom ausgehenden Transportanbieter festgelegt werden, der niemals zuvor vorhandene Werte weitergeben sollte.
