...
---
# <a name="pidnamelastsavedatetime-canonical-property"></a>Kanonische Pidnamelastsavedatetime (-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Gibt den Zeitpunkt an, zu dem die Datei zuletzt gespeichert wurde.
  
|||
|:-----|:-----|
|Angezeigte Namen:  <br/> |Keine  <br/> |
|Eigenschaftensatz:  <br/> |PS_PUBLIC_STRINGS  <br/> |
|Eigenschaftsname:  <br/> |LastSaveDtm  <br/> |
