...
Enthält den Geburtstag des Kontakts.
  
|||
|:-----|:-----|
|Zugeordnete Eigenschaften:  <br/> |PR_BIRTHDAY  <br/> |
|Kennung:  <br/> |0x3A42  <br/> |
|Datentyp:  <br/> |PT_SYSTIME  <br/> |
|Bereich:  <br/> |Kontakt  <br/> |
   
## <a name="remarks"></a>Bemerkungen

Diese Eigenschaft ist eine der Eigenschaften, die die Identifizierung und den Zugriff auf Informationen zu einem Kontakt bereitstellt. Diese Eigenschaften werden vom Benutzer und der Organisation des Benutzers definiert. 
