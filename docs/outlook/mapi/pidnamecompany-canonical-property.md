...
---
# <a name="pidnamecompany-canonical-property"></a>Kanonische Pidnamecompany (-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Gibt das Unternehmen an, für das die Datei erstellt wurde.
  
|||
|:-----|:-----|
|Angezeigte Namen:  <br/> |Keine  <br/> |
|Eigenschaftensatz:  <br/> |PS_PUBLIC_STRINGS  <br/> |
|Eigenschaftsname:  <br/> |Unternehmen  <br/> |
