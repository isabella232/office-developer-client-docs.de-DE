...
ms.locfileid: "59583618"
---
# <a name="pidnametitle-canonical-property"></a>Kanonische PidNameTitle-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Gibt den Titel der Datei an, die an das Dokument angefügt ist.
  
|||
|:-----|:-----|
|Anzeigenamen:  <br/> |Keines  <br/> |
|Eigenschaftensatz:  <br/> |PS_PUBLIC_STRINGS  <br/> |
|Eigenschaftenname:  <br/> |Titel  <br/> |
