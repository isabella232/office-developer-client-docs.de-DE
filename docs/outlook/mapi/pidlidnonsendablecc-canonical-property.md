...
---
# <a name="pidlidnonsendablecc-canonical-property"></a>Kanonische Pidlidnonsendablecc (-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Enthält eine Liste aller nicht sendenden Teilnehmer, die ebenfalls optionale Teilnehmer sind.
  
|||
|:-----|:-----|
|Zugeordnete Eigenschaften:  <br/> |dispidNonSendableCC  <br/> |
|Eigenschaftensatz:  <br/> |PSETID_Common  <br/> |
|Long-ID (Deckel):  <br/> |0x00008537  <br/> |
