...
Enthält eine Liste der Anzeigenamen für Benutzer im Adressbuch Kontaktadresse messaging.
  
|||
|:-----|:-----|
|Zugeordneten Eigenschaften:  <br/> |PR_CONTAB_DISPLAY_NAMES, PR_CONTAB_DISPLAY_NAMES_A, PR_CONTAB_DISPLAY_NAMES_W  <br/> |
|Bezeichner:  <br/> |0x6624  <br/> |
|Datentyp:  <br/> |PT_MV_UNICODE PT_MV_STRING8  <br/> |
|Bereich:  <br/> |Kontakt-Adressbuch  <br/> |
   
## <a name="remarks"></a>Bemerkungen

Diese Eigenschaften werden durch den Benutzer und die Organisation des Benutzers definiert.
