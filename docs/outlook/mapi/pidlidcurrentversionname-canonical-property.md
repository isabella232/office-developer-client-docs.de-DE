...
---
# <a name="pidlidcurrentversionname-canonical-property"></a>Kanonische PidLidCurrentVersionName-Eigenschaft

  
  
**Betrifft**: Outlook 
  
Enthält eine Zeichenfolge, der die Versionsnummer der Haupt- und Hilfsintervalle der Outlook-Anwendung für ein Element angibt.
  
|||
|:-----|:-----|
|Zugeordneten Eigenschaften:  <br/> |dispidCurrentVersionName  <br/> |
|-Eigenschaft festgelegt:  <br/> |PSETID_Common  <br/> |
|Long-ID (Abdeckung):  <br/> |0x00008554  <br/> |
