...
|Kennung:  <br/> |0x0062 zugreifen  <br/> |
|Datentyp:  <br/> |PT_LONG  <br/> |
|Bereich:  <br/> |Termin  <br/> |
   
## <a name="remarks"></a>Bemerkungen

Diese Eigenschaft wird in Besprechungsanfragen verwendet. Es stellt keine Eintrags-ID, sondern eine lange ganze Zahl dar, die den Termin innerhalb des Terminplans des Absenders eindeutig identifiziert.
