...
> <span data-ttu-id="d54c9-138">Der Aufruf erfolgreich ausgeführt und der erwartete Wert oder Werte zurückgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="d54c9-138">The call succeeded and has returned the expected value or values.</span></span> 
