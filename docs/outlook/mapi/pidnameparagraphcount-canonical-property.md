...
---
# <a name="pidnameparagraphcount-canonical-property"></a>Kanonische PidNameParagraphCount-Eigenschaft

  
  
**Betrifft**: Outlook 
  
Gibt die Anzahl der Absätze in der Datei, die an das Dokument angefügt ist.
  
|||
|:-----|:-----|
|Anzeigenamen:  <br/> |Keine  <br/> |
|-Eigenschaft festgelegt:  <br/> |PS_PUBLIC_STRINGS  <br/> |
|Name der Eigenschaft:  <br/> |ParCount  <br/> |
