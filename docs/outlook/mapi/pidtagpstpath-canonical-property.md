...
Enthält den Speicherort des Objekts in den Speicher für Persönliche Ordner erstellen oder konfigurieren.
  
|||
|:-----|:-----|
|Zugeordneten Eigenschaften:  <br/> |PR_PST_PATH, PR_PST_PATH_A, PR_PST_PATH_W  <br/> |
