...
|Long-ID (Deckel):  <br/> |0x00000002  <br/> |
|Datentyp:  <br/> |PT_UNICODE  <br/> |
|Bereich:  <br/> |Meetings  <br/> |
   
## <a name="remarks"></a>Bemerkungen

Der Wert dieser Eigenschaft sollte mit dem Wert der **dispidLocation** ([pidlidlocation (](pidlidlocation-canonical-property.md))-Eigenschaft der zugeordneten Besprechung übereinstimmen.
