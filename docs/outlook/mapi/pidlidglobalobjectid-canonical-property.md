...
|Lange ID (LID):  <br/> |0x00000003  <br/> |
|Datentyp:  <br/> |PT_BINARY  <br/> |
|Bereich:  <br/> |Besprechungen  <br/> |
   
## <a name="remarks"></a>Hinweise

Nachdem sie für ein Kalenderobjekt festgelegt wurde, darf sich der Wert dieser Eigenschaft nicht ändern. Eine ausführliche Beschreibung des Formats finden Sie unter [[MS-OXOCAL]](https://msdn.microsoft.com/library/9b636532-9150-4836-9635-9c9b756c9ccf%28Office.15%29.aspx).
