...
---
# <a name="pidtagscheduleinfodelegatorwantscopy-canonical-property"></a>Kanonische Pidtagscheduleinfodelegatorwantscopy (-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Enthält TRUE, wenn der delegator Kopien der Besprechungs bezogenen Objekte erhalten möchte, die an den Stellvertreter gesendet werden.
...
Diese Eigenschaft muss im Delegate Information-Objekt festgelegt werden.
