...
> <span data-ttu-id="4a552-147">Der Aufruf erfolgreich ausgeführt und der erwartete Wert oder Werte zurückgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="4a552-147">The call succeeded and has returned the expected value or values.</span></span>
