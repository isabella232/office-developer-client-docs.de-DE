...
ms.locfileid: "59550869"
---
# <a name="pidnamepagecount-canonical-property"></a>Kanonische PidNamePageCount-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Gibt die Seitenanzahl der an das Dokument angefügten Datei an.
  
|||
|:-----|:-----|
|Anzeigenamen:  <br/> |Keines  <br/> |
|Eigenschaftensatz:  <br/> |PS_PUBLIC_STRINGS  <br/> |
|Eigenschaftenname:  <br/> |PageCount  <br/> |
