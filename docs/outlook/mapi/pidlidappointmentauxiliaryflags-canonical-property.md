...
|Long-ID (Deckel):  <br/> |0x00008207  <br/> |
...
> Dieses Flag für eine Besprechungsanfrage gibt an, dass der Client oder Server eine Besprechungsantwort an den Organisator zurücksendet, wenn eine Antwort ausgewählt wird.
