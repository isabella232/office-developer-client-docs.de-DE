...
Enthält einen [RFC3282] Inhaltstyp-Kopfzeilen Feldwert für Anlagen, die von Macintosh-basierten e-Mail-Clients verwendet werden.
  
|||
|:-----|:-----|
|Angezeigte Namen:  <br/> |Keine  <br/> |
|Eigenschaftensatz:  <br/> |PSETID_Attachment  <br/> |
|Eigenschaftsname:  <br/> |AttachmentMacContentType  <br/> |
