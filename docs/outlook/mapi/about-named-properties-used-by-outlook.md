...
<span data-ttu-id="63fcf-120">In dieser Referenz werden eine Reihe von benannten Eigenschaften die unten aufgef�hrten beschrieben.</span><span class="sxs-lookup"><span data-stu-id="63fcf-120">This reference describes a number of named properties that are listed below.</span></span>
