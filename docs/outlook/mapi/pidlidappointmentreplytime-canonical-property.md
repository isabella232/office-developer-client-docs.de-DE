...
---
# <a name="pidlidappointmentreplytime-canonical-property"></a>Kanonische pidlidappointmentreplytime (-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Gibt das Datum und die Uhrzeit an, zu der der Teilnehmer auf eine empfangene Besprechungsanfrage oder eine Besprechungsaktualisierung geantwortet hat.
  
|||
|:-----|:-----|
|Zugeordnete Eigenschaften:  <br/> |dispidApptReplyTime  <br/> |
|Eigenschaftengruppe:  <br/> |PSETID_Appointment  <br/> |
|Lange ID (LID):  <br/> |0x00008220  <br/> |
|Datentyp:  <br/> |PT_SYSTIME  <br/> |
|Bereich:  <br/> |Meetings  <br/> |
   
## <a name="remarks"></a>Hinweise

Der Wert muss in UTC (Coordinated Universal Time, koordinierte Weltzeit) angegeben werden.
