...
Enthält eine Anzahl der ignorablen Zeichen, die vor den wichtigen Zeichen der Nachricht angezeigt werden.
...
Die Anzahl der Präfixzeichen enthält kein Leerzeichen.
  
Diese Eigenschaft ist eine Rich Text Format (RTF)-Hilfseigenschaft. RTF-Hilfseigenschaften werden von der [RTFSync-Funktion](rtfsync.md) verwendet und sind nicht für die direkte Verwendung durch Clientanwendungen vorgesehen. 
