...
Berechnet die Anzahl von Bytes in eine vorhandene [SMAPIFormPropArray](smapiformproparray.md) -Struktur, die eine angegebene Anzahl von [SMAPIFormProp](smapiformprop.md) Strukturen enthält. 
