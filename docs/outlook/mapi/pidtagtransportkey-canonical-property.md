...
Enthält einen Wert, der vom MAPI-Spooler verwendet wird, um den Fortschritt einer ausgehenden Nachricht über die ausgehenden Transportanbieter nachzuverfolgen.
