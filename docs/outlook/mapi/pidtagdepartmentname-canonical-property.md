...
Enthält einen Namen für die Abteilung, in der der Empfänger funktioniert. 
  
|||
|:-----|:-----|
|Zugeordneten Eigenschaften:  <br/> |PR_DEPARTMENT_NAME, PR_DEPARTMENT_NAME_A, PR_DEPARTMENT_NAME_W  <br/> |
|Bezeichner:  <br/> |0x3A18  <br/> |
