...
> <span data-ttu-id="a9432-110">Der Aufruf erfolgreich ausgeführt und der erwartete Wert oder Werte zurückgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="a9432-110">The call succeeded and has returned the expected value or values.</span></span>
