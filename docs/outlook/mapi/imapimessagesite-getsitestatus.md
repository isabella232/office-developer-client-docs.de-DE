...
## <a name="return-value"></a><span data-ttu-id="ce24a-124">R�ckgabewert</span><span class="sxs-lookup"><span data-stu-id="ce24a-124">Return value</span></span>

<span data-ttu-id="ce24a-125">S_OK</span><span class="sxs-lookup"><span data-stu-id="ce24a-125">S_OK</span></span> 
  
> <span data-ttu-id="ce24a-126">Der Aufruf erfolgreich ausgef�hrt und der erwartete Wert oder Werte zur�ckgegeben hat.</span><span class="sxs-lookup"><span data-stu-id="ce24a-126">The call succeeded and has returned the expected value or values.</span></span>
