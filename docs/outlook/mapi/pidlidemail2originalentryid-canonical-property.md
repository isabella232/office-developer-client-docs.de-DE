...
Gibt die **EntryId des** Objekts an, das der zweiten E-Mail-Adresse entspricht. 
  
|||
|:-----|:-----|
|Zugeordnete Eigenschaften:  <br/> |dispidEmail2OriginalEntryID  <br/> |
|Eigenschaftensatz:  <br/> |PSETID_Address  <br/> |
|Lange ID (LID):  <br/> |0x00008095  <br/> |
|Datentyp:  <br/> |PT_BINARY  <br/> |
|Bereich:  <br/> |Kontakt  <br/> |
   
## <a name="remarks"></a>Hinweise

Der Wert dieser Eigenschaft muss entweder eine one-off **EntryId** für diese elektronische Adresse oder ein gültiges Adressbuchobjekt **EntryId sein.**
