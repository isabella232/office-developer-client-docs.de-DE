...
---
# <a name="pidtagassistanttelephonenumber-canonical-property"></a>Kanonische Pidtagassistanttelephonenumber (-Eigenschaft

  
  
**Gilt für**: Outlook 2013 | Outlook 2016 
  
Enthält die Telefonnummer des Verwaltungsassistenten des Empfängers. 
...
Die Telefonnummer ist für den in der **PR_ASSISTANT** ([PidTagAssistant](pidtagassistant-canonical-property.md))-Eigenschaft angegebenen Assistenten. 
