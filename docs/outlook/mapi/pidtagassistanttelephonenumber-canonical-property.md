...
Die Telefonnummer ist für den Assistenten bestimmt, der in der **eigenschaft PR_ASSISTANT** ([PidTagAssistant](pidtagassistant-canonical-property.md)) angegeben ist. 
