...
---
# <a name="constants-data-degradation-layer-api"></a>Konstanten (Beeinträchtigung Datenebene API)

Dieses Thema enthält Konstantendefinitionen für die Data-Beeinträchtigung Layer-API.
