...
In diesem Abschnitt werden die Schnittstellen in der Konto-Management-API beschrieben.
  
|**Schnittstelle**|**Beschreibung**|
|:-----|:-----|
|[IOlkAccount](iolkaccount.md) <br/> |Unterstützt das Abrufen und Festlegen von Eigenschaften und andere Informationen über ein Konto.  <br/> |
