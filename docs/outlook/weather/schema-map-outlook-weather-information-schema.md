...
---
# <a name="schema-map-outlook-weather-information-schema"></a><span data-ttu-id="6ecc7-103">Schemazuordnung (Outlook-Wetter Informationsschema)</span><span class="sxs-lookup"><span data-stu-id="6ecc7-103">Schema map (Outlook Weather Information Schema)</span></span>

<span data-ttu-id="6ecc7-104">In diesem Thema wird die Schema Definition für das Outlook-Wetter Informations-XML-Schema dargestellt.</span><span class="sxs-lookup"><span data-stu-id="6ecc7-104">This topic shows the schema definition for the Outlook Weather Information XML Schema.</span></span>
