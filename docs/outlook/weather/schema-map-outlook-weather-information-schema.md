...
---
# <a name="schema-map-outlook-weather-information-schema"></a>Schemazuordnung (Outlook Wetter Informationen-Schema)

In diesem Thema wird die Schemadefinition für das Outlook Wetter Informationen XML-Schema.
