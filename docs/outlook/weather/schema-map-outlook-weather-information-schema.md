...
---
# <a name="schema-map-outlook-weather-information-schema"></a><span data-ttu-id="5f327-103">Schemazuordnung (Outlook Wetterinformationsschema)</span><span class="sxs-lookup"><span data-stu-id="5f327-103">Schema map (Outlook Weather Information Schema)</span></span>

<span data-ttu-id="5f327-104">In diesem Thema wird die Schemadefinition für das Outlook Wetterinformations-XML-Schemas gezeigt.</span><span class="sxs-lookup"><span data-stu-id="5f327-104">This topic shows the schema definition for the Outlook Weather Information XML Schema.</span></span>
