...
---
# <a name="schema-map-outlook-weather-location-schema"></a>Schemazuordnung (Outlook Wetter Speicherort-Schema)

In diesem Thema wird die Schemadefinition für das Outlook Wetter Speicherort XML-Schema.
