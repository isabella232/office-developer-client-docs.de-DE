...
---
# <a name="schema-map-outlook-weather-location-schema"></a>Schemazuordnung (Outlook-Wetter Standortschema)

In diesem Thema wird die Schema Definition für das XML-Schema des Outlook-Wetter Standorts dargestellt.
