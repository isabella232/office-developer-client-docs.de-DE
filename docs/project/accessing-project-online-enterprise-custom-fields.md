...
- [Lokale und benutzerdefinierte Enterprise-Felder](https://msdn.microsoft.com/library/office/ms447495(v=office.14).aspx)
- [Hinzufügen oder Bearbeiten von benutzerdefinierten Enterprise-Felder in Project Server 2013](https://docs.microsoft.com/project/add-or-edit-enterprise-custom-fields-in-project-server)
