...
3. Bearbeiten Sie im Projektmappen-Explorer den Wert der Eigenschaft **Website-URL** für das Projekt **ProjectsJSOM** entsprechend die URL der Project Web App-Instanz (z. B. `http://ServerName/PWA`).
