...
Hier finden Sie Vorgehensweisen, Beispielcode, SDK- und API-Dokumentationen, VBA-Referenzen, Schulungen und technische Artikel zum Entwickeln von Lösungen und zum Anpassen von Project.
...
- [VBA-Referenz für Project](https://msdn.microsoft.com/de-DE/library/dn175495.aspx)
  
- [Project 2010](https://msdn.microsoft.com/de-DE/library/ee861523.aspx)
  
### <a name="office-add-ins"></a>Office-Add-Ins
  
- [Erste Schritte mit Project-Add-Ins](https://docs.microsoft.com/de-DE/office/dev/add-ins/quickstarts/project-quickstart )
  
- [Plattformübersicht](https://msdn.microsoft.com/de-DE/library/office/jj220082.aspx)
  
### <a name="other-resources"></a>Sonstige Ressourcen
  
- [Office VBA-Objektbibliothekreferenz](http://msdn.microsoft.com/library/727c4e1c-e13c-7bac-e833-b1322607dfd3%28Office.15%29.aspx)
...
- [VSTO-Add-Ins für Office](https://docs.microsoft.com/de-DE/office/dev/add-ins/overview/office-add-ins)
