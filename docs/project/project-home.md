...
- [Project VBA-Referenz](https://msdn.microsoft.com/en-us/library/dn175495.aspx)
  
- [Project 2010](https://msdn.microsoft.com/EN-US/library/ee861523.aspx)
  
### <a name="office-add-ins"></a>Office-Add-Ins
  
- [Erste Schritte mit Project-Add-Ins](https://docs.microsoft.com/en-us/office/dev/add-ins/quickstarts/project-quickstart )
...
- [VSTO-Add-Ins für Office](https://docs.microsoft.com/en-us/office/dev/add-ins/overview/office-add-ins)
