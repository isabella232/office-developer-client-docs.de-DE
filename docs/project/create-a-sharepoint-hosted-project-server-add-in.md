...
<span data-ttu-id="f36fe-123">Die Entwicklung von Project Server-apps mit Visual Studio erfordert Folgendes:</span><span class="sxs-lookup"><span data-stu-id="f36fe-123">Development of Project Server apps with Visual Studio requires the following:</span></span>
...
<span data-ttu-id="f36fe-136"><a name="pj15_StatusingApp_UsingVisualStudio"> </a></span><span class="sxs-lookup"><span data-stu-id="f36fe-136"><a name="pj15_StatusingApp_UsingVisualStudio"> </a></span></span>
...
3. <span data-ttu-id="f36fe-158">Geben Sie im Feld **Name den Namen** Quick Status ein, navigieren Sie zu dem Speicherort, an dem Sie die APP speichern möchten, und wählen Sie dann **OK**aus.</span><span class="sxs-lookup"><span data-stu-id="f36fe-158">In the **Name** field, type QuickStatus, browse to the location where you want to save the app, and then choose **OK**.</span></span>
   ...
   <span data-ttu-id="f36fe-160">![Erstellen einer Project Server-App in Visual Studio](media/pj15_CreateStatusingApp_NewProject.gif "Erstellen einer Project Server-App in Visual Studio")</span><span class="sxs-lookup"><span data-stu-id="f36fe-160">![Creating a Project Server app in Visual Studio](media/pj15_CreateStatusingApp_NewProject.gif "Creating a Project Server app in Visual Studio")</span></span>
...
4. <span data-ttu-id="f36fe-161">Geben Sie im Dialogfeld **neue APP für SharePoint** die folgenden drei Felder ein:</span><span class="sxs-lookup"><span data-stu-id="f36fe-161">In the **New app for SharePoint** dialog box, fill in the following three fields:</span></span> 
   ...
   - <span data-ttu-id="f36fe-169">Wählen Sie in der Dropdownliste **wie soll Ihre APP für SharePoint** gehostet werden die Option **SharePoint-** Hosted aus.</span><span class="sxs-lookup"><span data-stu-id="f36fe-169">In the **How do you want to host your app for SharePoint** drop-down list, choose **SharePoint-hosted**.</span></span>
...
6. <span data-ttu-id="f36fe-173">Öffnen Sie die Manifest-Designer-Ansicht (Doppelklicken Sie beispielsweise auf die Datei AppManifest. Xml).</span><span class="sxs-lookup"><span data-stu-id="f36fe-173">Open the Manifest Designer view (for example, double-click the AppManifest.xml file).</span></span> <span data-ttu-id="f36fe-174">Auf der Registerkarte **Allgemein** sollte im Textfeld **Titel** der App-Name angezeigt werden, den Sie in Schritt 4 eingegeben haben.</span><span class="sxs-lookup"><span data-stu-id="f36fe-174">On the **General** tab, the **Title** text box should show the app name that you typed in step 4.</span></span> <span data-ttu-id="f36fe-175">Wählen Sie die Registerkarte **Berechtigungen** aus, um die folgenden Berechtigungsanforderungen für die APP hinzuzufügen (siehe Abbildung 2):</span><span class="sxs-lookup"><span data-stu-id="f36fe-175">Choose the **Permissions** tab to add the following permission requests for the app (see Figure 2):</span></span> 
   ...
   <span data-ttu-id="f36fe-180">![Festlegen des Berechtigungsumfangs für eine Statuserfassungs-App](media/pj15_CreateStatusingApp_PermissionScope.gif "Festlegen des Berechtigungsumfangs für eine Statuserfassungs-App")</span><span class="sxs-lookup"><span data-stu-id="f36fe-180">![Setting the permission scope for a statusing app](media/pj15_CreateStatusingApp_PermissionScope.gif "Setting the permission scope for a statusing app")</span></span>
...
- <span data-ttu-id="f36fe-187">**Enterprise-Ressourcen**: Ressourcen-Manager-Berechtigungen zum Lesen oder Schreiben von Informationen zu anderen Project Web App Benutzern.</span><span class="sxs-lookup"><span data-stu-id="f36fe-187">**Enterprise Resources**: Resource manager permissions, to read or write information about other Project Web App users.</span></span>
...
- <span data-ttu-id="f36fe-205">Ein **Form** -Element enthält alle anderen Benutzeroberflächenelemente.</span><span class="sxs-lookup"><span data-stu-id="f36fe-205">A **form** element contains all of the other UI elements.</span></span> 
...
<span data-ttu-id="f36fe-235"><a name="pj15_StatusingApp_JavaScript"> </a></span><span class="sxs-lookup"><span data-stu-id="f36fe-235"><a name="pj15_StatusingApp_JavaScript"> </a></span></span>
...
<span data-ttu-id="f36fe-294">Menübandregisterkarten, Gruppen und Steuerelemente für Project Web App werden in der Datei pwaribbon. XML angegeben, die im `[Program Files]\Common Files\Microsoft Shared\Web Server Extensions\15\TEMPLATE\FEATURES\PWARibbon\listtemplates` Verzeichnis auf dem Computer installiert ist, auf dem Project Server ausführt.</span><span class="sxs-lookup"><span data-stu-id="f36fe-294">Ribbon tabs, groups, and controls for Project Web App are specified in the pwaribbon.xml file, which is installed in the  `[Program Files]\Common Files\Microsoft Shared\Web Server Extensions\15\TEMPLATE\FEATURES\PWARibbon\listtemplates` directory on the computer running Project Server.</span></span> <span data-ttu-id="f36fe-295">Zum Entwerfen von benutzerdefinierten Aktionen für das Project Web App Menüband enthält der Project 2013 SDK-Download eine Kopie von pwaribbon. Xml.</span><span class="sxs-lookup"><span data-stu-id="f36fe-295">To help design custom actions for the Project Web App ribbon, the Project 2013 SDK download includes a copy of pwaribbon.xml.</span></span> 
...
2. <span data-ttu-id="f36fe-312">Klicken Sie im Bereich **Projektmappen-Explorer** in Visual Studio mit der rechten Maustaste auf das **Quick Status** -Projekt, und fügen Sie dann ein neues Element hinzu.</span><span class="sxs-lookup"><span data-stu-id="f36fe-312">In the **Solution Explorer** pane in Visual Studio, right-click the **QuickStatus** project, and then add a new item.</span></span> <span data-ttu-id="f36fe-313">Wählen Sie im Dialogfeld **Neues Element hinzufügen** die Option **benutzerdefinierte menübandaktion** aus (siehe Abbildung 4).</span><span class="sxs-lookup"><span data-stu-id="f36fe-313">In the **Add New Item** dialog box, choose **Ribbon Custom Action** (see Figure 4).</span></span> <span data-ttu-id="f36fe-314">Nennen Sie beispielsweise die benutzerdefinierte Aktion RibbonQuickStatusAction, und wählen Sie dann **Hinzufügen**aus.</span><span class="sxs-lookup"><span data-stu-id="f36fe-314">For example, name the custom action RibbonQuickStatusAction, and then choose **Add**.</span></span>
   ...
   <span data-ttu-id="f36fe-315">**Abbildung 4. Hinzufügen einer benutzerdefinierten menübandaktion**</span><span class="sxs-lookup"><span data-stu-id="f36fe-315">**Figure 4. Adding a ribbon custom action**</span></span>
...
3. <span data-ttu-id="f36fe-317">Lassen Sie auf der ersten Seite des Assistenten zum **Erstellen einer benutzerdefinierten Aktion für Menüband** die Option **Host-Webdienste** ausgewählt, wählen Sie in der Dropdownliste für den Bereich benutzerdefinierter Aktionen die Option **keine** aus, und klicken Sie dann auf **weiter** (siehe Abbildung 5).</span><span class="sxs-lookup"><span data-stu-id="f36fe-317">On the first page of the **Create Custom Action for Ribbon** wizard, leave the **Host Web** option selected, choose **None** in the drop-down list for the custom action scope, and then choose **Next** (see Figure 5).</span></span> <span data-ttu-id="f36fe-318">Die Elemente in den Dropdownlisten sind für SharePoint relevant, nicht für Project Server.</span><span class="sxs-lookup"><span data-stu-id="f36fe-318">The items in the drop-down lists are relevant to SharePoint, not to Project Server.</span></span> <span data-ttu-id="f36fe-319">Wir ersetzen den Großteil des generierten XML-Code für die benutzerdefinierte Aktion so, dass Sie auf Project Server angewendet wird.</span><span class="sxs-lookup"><span data-stu-id="f36fe-319">We will replace most of the generated XML for the custom action so that it applies to Project Server.</span></span> 
   ...
   <span data-ttu-id="f36fe-321">![Festlegen von Eigenschaften für die benutzerdefinierte Menübandaktion](media/pj15_CreateStatusingApp_RibbonCustomAction2.gif "Festlegen von Eigenschaften für die benutzerdefinierte Menübandaktion")</span><span class="sxs-lookup"><span data-stu-id="f36fe-321">![Specifying properties for the ribbon custom action](media/pj15_CreateStatusingApp_RibbonCustomAction2.gif "Specifying properties for the ribbon custom action")</span></span>
  
4. <span data-ttu-id="f36fe-322">Belassen Sie auf der nächsten Seite des Assistenten zum **Erstellen einer benutzerdefinierten Aktion für Menüband** alle Standardwerte für die Einstellungen, und wählen Sie dann **Fertig stellen** aus (siehe Abbildung 6).</span><span class="sxs-lookup"><span data-stu-id="f36fe-322">On the next page of the **Create Custom Action for Ribbon** wizard, leave all the default values for the settings, and then choose **Finish** (see Figure 6).</span></span> <span data-ttu-id="f36fe-323">Visual Studio erstellt den **RibbonQuickStatusAction** -Ordner, der eine Datei "Elements. xml" enthält.</span><span class="sxs-lookup"><span data-stu-id="f36fe-323">Visual Studio creates the **RibbonQuickStatusAction** folder, which contains an Elements.xml file.</span></span> 
    
   <span data-ttu-id="f36fe-324">**Abbildung 6. Angeben der Einstellungen für ein Schaltflächen-Steuerelement**</span><span class="sxs-lookup"><span data-stu-id="f36fe-324">**Figure 6. Specifying the settings for a button control**</span></span>

   <span data-ttu-id="f36fe-325">![Festlegen der Einstellungen für ein Schaltflächensteuerelement](media/pj15_CreateStatusingApp_RibbonCustomAction3.gif "Festlegen der Einstellungen für ein Schaltflächensteuerelement")</span><span class="sxs-lookup"><span data-stu-id="f36fe-325">![Specifying the settings for a button control](media/pj15_CreateStatusingApp_RibbonCustomAction3.gif "Specifying the settings for a button control")</span></span>
  
5. <span data-ttu-id="f36fe-326">Ändern Sie den standardmäßig generierten Code in der Datei "Elements. xml" für die benutzerdefinierte menübandaktion.</span><span class="sxs-lookup"><span data-stu-id="f36fe-326">Modify the default generated code in the Elements.xml file for the ribbon custom action.</span></span> <span data-ttu-id="f36fe-327">Im folgenden finden Sie den standardmäßigen XML-Code:</span><span class="sxs-lookup"><span data-stu-id="f36fe-327">Following is the default XML code:</span></span>
   ...
   3. <span data-ttu-id="f36fe-331">Ändern Sie die Attributwerte des untergeordneten **Schaltflächen** Elements wie folgt:</span><span class="sxs-lookup"><span data-stu-id="f36fe-331">Change the attribute values of the child **Button** element as follows:</span></span> 
       ...
       - <span data-ttu-id="f36fe-337">Die Bildattribute geben das 16 x 16-Pixel-Symbol und das 32 x 32-Pixel-Symbol für das Schaltflächen-Steuerelement an.</span><span class="sxs-lookup"><span data-stu-id="f36fe-337">The image attributes specify the 16 x 16-pixel icon and the 32 x 32-pixel icon for the button control.</span></span> <span data-ttu-id="f36fe-338">`Image32by32="_layouts/15/images/placeholder32x32.png"` Gibt in der Datei Default Elements. XML einen orangefarbenen Punkt an.</span><span class="sxs-lookup"><span data-stu-id="f36fe-338">In the default Elements.xml file,  `Image32by32="_layouts/15/images/placeholder32x32.png"` specifies an orange dot.</span></span> <span data-ttu-id="f36fe-339">Sie können Symbole aus den Bild Zuordnungsdateien (ps16x16. png und ps32x32. png) extrahieren, die im `[Program Files]\Common Files\Microsoft Shared\Web Server Extensions\15\TEMPLATE\LAYOUTS\1033\IMAGES` Verzeichnis auf dem Computer installiert sind, auf dem Project Server läuft.</span><span class="sxs-lookup"><span data-stu-id="f36fe-339">You can extract icons from the image map files (ps16x16.png and ps32x32.png) that are installed in the  `[Program Files]\Common Files\Microsoft Shared\Web Server Extensions\15\TEMPLATE\LAYOUTS\1033\IMAGES` directory on the computer running Project Server.</span></span> <span data-ttu-id="f36fe-340">Beispielsweise befindet sich das 32 x 32-Pixel-Symbol in der zweiten Spalte mit Symbolen von Links und der zehnten Zeile nach unten vom oberen Rand der ps32x32. png-ImageMap (der obere Rand des Symbols befindet sich nach dem Ende der neunten Zeile; 9 Zeilen x 32 Pixel/Zeile = 288 Pixel).</span><span class="sxs-lookup"><span data-stu-id="f36fe-340">For example, the 32 x 32-pixel icon is in the second column of icons from the left and the tenth row down from the top of the ps32x32.png image map (the top of the icon is after the end of the ninth row; 9 rows x 32 pixels/row = 288 pixels).</span></span> 
    
       - <span data-ttu-id="f36fe-341">Zum Anzeigen einer QuickInfo für das Schaltflächen-Steuerelement fügen Sie das **ToolTipTitle** -Attribut und das **ToolTipDescription** -Attribut hinzu.</span><span class="sxs-lookup"><span data-stu-id="f36fe-341">To show a tool tip for the button control, add the **ToolTipTitle** attribute and the **ToolTipDescription** attribute.</span></span> 
    
    4. <span data-ttu-id="f36fe-342">Ändern Sie die Attribute des **commanduihandler-** -Elements.</span><span class="sxs-lookup"><span data-stu-id="f36fe-342">Change the attributes of the **CommandUIHandler** element.</span></span> <span data-ttu-id="f36fe-343">Stellen Sie beispielsweise sicher, dass das **Command** -Attribut mit dem Wert des **Command** -Attributs für das **Button** -Element übereinstimmt.</span><span class="sxs-lookup"><span data-stu-id="f36fe-343">For example, ensure that the **Command** attribute matches the **Command** attribute value for the **Button** element.</span></span> <span data-ttu-id="f36fe-344">Für das **Command** - `~appWebUrl` Attribut ist ein Platzhalter für die URL der **Quick Status** -Webseite.</span><span class="sxs-lookup"><span data-stu-id="f36fe-344">For the **CommandAction** attribute,  `~appWebUrl` is a placeholder for the URL of the **QuickStatus** webpage.</span></span> <span data-ttu-id="f36fe-345">Wenn die **Quick Status** -App auf der menübandschaltfläche aufgerufen wird, wird das Token **{Standard Tokens}** durch URL-Optionen ersetzt, die **SPHostUrl**, die **Sprache**, **SPClientTag**, **SPProductNumber**und **SPAppWebUrl**einschließen.</span><span class="sxs-lookup"><span data-stu-id="f36fe-345">When the ribbon button invokes the **QuickStatus** app, the **{StandardTokens}** token is replaced by URL options that include **SPHostUrl**, **SPLanguage**, **SPClientTag**, **SPProductNumber**, and **SPAppWebUrl**.</span></span>
...
6. <span data-ttu-id="f36fe-346">Öffnen Sie im **Projektmappen-Explorer**den **Feature1. Feature** -Designer, und legen Sie das **RibbonQuickStatusAction** -Element aus den **Elementen im Lösungs** Bereich auf die **Elemente im Featurebereich** .</span><span class="sxs-lookup"><span data-stu-id="f36fe-346">In **Solution Explorer**, open the **Feature1.feature** designer, and move the **RibbonQuickStatusAction** item from the **Items in the Solution** pane to the **Items in the Feature** pane.</span></span> <span data-ttu-id="f36fe-347">Wenn Sie dann den **Paket-** Designer öffnen, befindet sich das **RibbonQuickStatusAction** -Element in den **Elementen im Paket** Bereich.</span><span class="sxs-lookup"><span data-stu-id="f36fe-347">If you then open the **Package.package** designer, the **RibbonQuickStatusAction** item will be in the **Items in the Package** pane.</span></span> 
    
<span data-ttu-id="f36fe-348">Wenn Sie die APP entwickeln und eine menübandschaltfläche hinzufügen, testen Sie die APP normalerweise und legen Haltepunkte im JavaScript-Code für das Debugging fest.</span><span class="sxs-lookup"><span data-stu-id="f36fe-348">As you develop the app and add a ribbon button, you normally test the app and set breakpoints in the JavaScript code for debugging.</span></span> <span data-ttu-id="f36fe-349">Wenn Sie **F5** drücken, um das Debuggen zu starten, kompiliert Visual Studio die APP, stellt Sie auf der Website bereit, die in der Eigenschaft **Website-URL** des **Quick Status** -Projekts angegeben ist, und zeigt eine Seite an, die fragt, ob Sie der APP Vertrauen.</span><span class="sxs-lookup"><span data-stu-id="f36fe-349">When you press **F5** to start debugging, Visual Studio compiles the app, deploys it to the site that is specified in the **Site URL** property of the **QuickStatus** project, and displays a page that asks whether you trust the app.</span></span> <span data-ttu-id="f36fe-350">Wenn Sie den Vorgang fortsetzen und dann die **Quick Status** -App beenden, wird die Seite "Aufgaben" in Project Web App zurückgegeben.</span><span class="sxs-lookup"><span data-stu-id="f36fe-350">When you proceed and then exit the **QuickStatus** app, it returns to the Tasks page in Project Web App.</span></span> 

> [!NOTE]
> <span data-ttu-id="f36fe-351">Abbildung 7 zeigt, dass die Schaltfläche " **schnell Status** " auf der Registerkarte " **Aufgaben** " des Menübands deaktiviert ist.</span><span class="sxs-lookup"><span data-stu-id="f36fe-351">Figure 7 shows that the **Quick Status** button on the **TASKS** tab of the ribbon is disabled.</span></span> <span data-ttu-id="f36fe-352">Nach vielen Debug-Bereitstellungen mit Visual Studio können benutzerdefinierte menübandsteuerelemente blockiert werden, wenn Sie die veröffentlichte App weiterhin auf demselben Testserver Debuggen oder bereitstellen.</span><span class="sxs-lookup"><span data-stu-id="f36fe-352">After many debug deployments with Visual Studio, custom ribbon controls can be blocked when you continue to debug or deploy the published app on the same test server.</span></span> <span data-ttu-id="f36fe-353">Zum Aktivieren der Schaltfläche Löschen Sie das **RibbonQuickStatusAction** -Element in Visual Studio und erstellen dann eine neue menübandaktion mit einem anderen Namen und einer anderen ID.</span><span class="sxs-lookup"><span data-stu-id="f36fe-353">To enable the button, delete the **RibbonQuickStatusAction** item in Visual Studio, and then create a new ribbon action that has a different name and ID.</span></span> <span data-ttu-id="f36fe-354">Wenn das Problem dadurch nicht behoben wird, versuchen Sie, die APP aus der Project Web App Testinstanz zu entfernen und die APP dann mit einer anderen APP-ID neu zu erstellen.</span><span class="sxs-lookup"><span data-stu-id="f36fe-354">If that doesn't solve the problem, try removing the app from the Project Web App test instance, and then recreate the app with a different app ID.</span></span> 
  
<span data-ttu-id="f36fe-355">**Abbildung 7. Anzeigen der QuickInfo der deaktivierten Schaltfläche "schnell Status"**</span><span class="sxs-lookup"><span data-stu-id="f36fe-355">**Figure 7. Viewing the tooltip of the disabled Quick Status button**</span></span>

<span data-ttu-id="f36fe-356">![Anzeigen der QuickInfo der deaktivierten Schaltfläche](media/pj15_CreateStatusingApp_ButtonToolTipDisabled.gif "Anzeigen der QuickInfo der deaktivierten Schaltfläche")</span><span class="sxs-lookup"><span data-stu-id="f36fe-356">![Viewing the tooltip of the disabled button](media/pj15_CreateStatusingApp_ButtonToolTipDisabled.gif "Viewing the tooltip of the disabled button")</span></span>
  
<span data-ttu-id="f36fe-357">In Verfahren 5 wird gezeigt, wie Sie die **Quick Status** -App bereitstellen und installieren.</span><span class="sxs-lookup"><span data-stu-id="f36fe-357">Procedure 5 shows how to deploy and install the **QuickStatus** app.</span></span> <span data-ttu-id="f36fe-358">In Prozedur 6 werden einige zusätzliche Schritte zum Testen der APP gezeigt, nachdem Sie Sie installiert haben.</span><span class="sxs-lookup"><span data-stu-id="f36fe-358">Procedure 6 shows some additional steps in testing the app after you have installed it.</span></span> 

<span data-ttu-id="f36fe-359"><a name="pj15_StatusingApp_Deploying"> </a></span><span class="sxs-lookup"><span data-stu-id="f36fe-359"><a name="pj15_StatusingApp_Deploying"> </a></span></span>

## <a name="deploying-the-quickstatus-app"></a><span data-ttu-id="f36fe-360">Bereitstellen der Quick Status-App</span><span class="sxs-lookup"><span data-stu-id="f36fe-360">Deploying the QuickStatus app</span></span>

<span data-ttu-id="f36fe-361">Es gibt verschiedene Möglichkeiten, eine app in einer SharePoint-Webanwendung wie Project Web App bereitzustellen.</span><span class="sxs-lookup"><span data-stu-id="f36fe-361">There are several ways to deploy an app to a SharePoint web application such as Project Web App.</span></span> <span data-ttu-id="f36fe-362">Welche Bereitstellung Sie verwenden, hängt davon ab, ob die app in einem privaten SharePoint-Katalog oder im öffentlichen Office Store veröffentlicht werden soll und ob SharePoint lokal installiert ist oder ein Online-Mandant ist.</span><span class="sxs-lookup"><span data-stu-id="f36fe-362">Which deployment you use will depend on whether you want to publish the app to a private SharePoint catalog or to the public Office Store, and whether SharePoint is installed on-premises or is an online tenancy.</span></span> <span data-ttu-id="f36fe-363">In Verfahren 5 wird gezeigt, wie die **Quick Status** -app in einer lokalen Installation in einem privaten App-Katalog bereitgestellt wird.</span><span class="sxs-lookup"><span data-stu-id="f36fe-363">Procedure 5 shows how to deploy the **QuickStatus** app to an on-premises installation in a private app catalog.</span></span> <span data-ttu-id="f36fe-364">Weitere Informationen finden Sie unter [Installieren und Verwalten von Apps für SharePoint 2013](https://technet.microsoft.com/library/fp161232.aspx) und [Veröffentlichen von Apps für SharePoint](https://msdn.microsoft.com/library/jj164070.aspx)</span><span class="sxs-lookup"><span data-stu-id="f36fe-364">For more information, see [Install and manage apps for SharePoint 2013](https://technet.microsoft.com/library/fp161232.aspx) and [Publish apps for SharePoint](https://msdn.microsoft.com/library/jj164070.aspx)</span></span>
  
> [!NOTE]
> <span data-ttu-id="f36fe-365">Zum Hinzufügen einer APP zu einem SharePoint-Katalog sind SharePoint-Administratorberechtigungen erforderlich.</span><span class="sxs-lookup"><span data-stu-id="f36fe-365">Adding an app to a SharePoint catalog requires SharePoint administrator permissions.</span></span> 
  
### <a name="procedure-5-to-deploy-the-quickstatus-app"></a><span data-ttu-id="f36fe-366">Prozedur 5.</span><span class="sxs-lookup"><span data-stu-id="f36fe-366">Procedure 5.</span></span> <span data-ttu-id="f36fe-367">So stellen Sie die Quick Status-App bereit</span><span class="sxs-lookup"><span data-stu-id="f36fe-367">To deploy the QuickStatus app</span></span>

1. <span data-ttu-id="f36fe-368">Speichern Sie in Visual Studio alle Dateien, und klicken Sie dann im **Projektmappen-Explorer** mit der rechten Maustaste auf das **Quick Status** -Projekt, und wählen Sie **veröffentlichen**aus.</span><span class="sxs-lookup"><span data-stu-id="f36fe-368">In Visual Studio, save all of the files, and then right-click the **QuickStatus** project in the **Solution Explorer** and choose **Publish**.</span></span>
    
2. <span data-ttu-id="f36fe-369">Da die **Quick Status** -app in SharePoint gehostet wird, gibt es nur sehr wenige Optionen für die Veröffentlichung (siehe Abbildung 8).</span><span class="sxs-lookup"><span data-stu-id="f36fe-369">Because the **QuickStatus** app is SharePoint-hosted, there are very few options for publishing (see Figure 8).</span></span> <span data-ttu-id="f36fe-370">Wählen Sie im Dialogfeld **Apps für Office und SharePoint veröffentlichen** die Option **Fertig stellen**aus.</span><span class="sxs-lookup"><span data-stu-id="f36fe-370">In the **Publish apps for Office and SharePoint** dialog box, choose **Finish**.</span></span>
    
   <span data-ttu-id="f36fe-371">**Abbildung 8. Veröffentlichen der Quick Status-App**</span><span class="sxs-lookup"><span data-stu-id="f36fe-371">**Figure 8. Publishing the QuickStatus app**</span></span>

   <span data-ttu-id="f36fe-372">![Verwenden des Assistenten zum Veröffentlichen](media/pj15_CreateStatusingApp_PublishWizard.gif "Verwenden des Assistenten zum Veröffentlichen")</span><span class="sxs-lookup"><span data-stu-id="f36fe-372">![Using the Publish Wizard](media/pj15_CreateStatusingApp_PublishWizard.gif "Using the Publish Wizard")</span></span>
  
3. <span data-ttu-id="f36fe-373">Kopieren Sie die Datei Quick Status. app aus `~\QuickStatus\bin\Debug\app.publish\1.0.0.0` dem Verzeichnis in ein bequemes Verzeichnis auf dem lokalen Computer (oder auf den SharePoint-Computer für eine lokale Installation).</span><span class="sxs-lookup"><span data-stu-id="f36fe-373">Copy the QuickStatus.app file from the  `~\QuickStatus\bin\Debug\app.publish\1.0.0.0` directory to a convenient directory on the local computer (or to the SharePoint computer for an on-premises installation).</span></span> 
    
4. <span data-ttu-id="f36fe-374">Klicken Sie in der SharePoint-zentral Administration auf der Schnellstartleiste auf **apps** , und wählen Sie dann **App-Katalog verwalten**aus.</span><span class="sxs-lookup"><span data-stu-id="f36fe-374">In SharePoint Central Administration, choose **Apps** in the Quick Launch, and then choose **Manage App Catalog**.</span></span>
    
5. <span data-ttu-id="f36fe-375">Wenn kein App-Katalog vorhanden ist, erstellen Sie eine Websitesammlung für den App-Katalog, indem Sie im Abschnitt Verwalten des App-Katalogs [in SharePoint 2013](https://technet.microsoft.com/library/fp161234.aspx)auf die *App-katalogwebsite für eine Webanwendung konfigurieren* folgen.</span><span class="sxs-lookup"><span data-stu-id="f36fe-375">If an app catalog does not exist, create a site collection for the app catalog, by following the  *Configure the App Catalog site for a web application*  section in [Manage the App Catalog in SharePoint 2013](https://technet.microsoft.com/library/fp161234.aspx).</span></span>
    
   <span data-ttu-id="f36fe-376">Wenn ein App-Katalog vorhanden ist, navigieren Sie auf der Seite App-Katalog verwalten zur Website-URL.</span><span class="sxs-lookup"><span data-stu-id="f36fe-376">If an app catalog exists, navigate to the site URL on the Manage App Catalog page.</span></span> <span data-ttu-id="f36fe-377">In den folgenden Schritten ist `https://ServerName/sites/TestApps`beispielsweise die APP-katalogwebsite.</span><span class="sxs-lookup"><span data-stu-id="f36fe-377">For example, in the following steps, the app catalog site is  `https://ServerName/sites/TestApps`.</span></span>
    
6. <span data-ttu-id="f36fe-378">Klicken Sie auf der Seite App-Katalog auf der Schnellstartleiste auf **Apps für SharePoint** .</span><span class="sxs-lookup"><span data-stu-id="f36fe-378">On the app catalog page, choose **Apps for SharePoint** in the Quick Launch.</span></span> <span data-ttu-id="f36fe-379">Wählen Sie auf der Seite Apps für SharePoint im Menüband auf der Registerkarte **Dateien** die Option **Dokument hochladen**aus.</span><span class="sxs-lookup"><span data-stu-id="f36fe-379">On the Apps for SharePoint page, on the **FILES** tab of the ribbon, choose **Upload Document**.</span></span>
    
7. <span data-ttu-id="f36fe-380">Suchen Sie im Dialogfeld **Dokument hinzufügen** nach der Quick Status. app-Datei, fügen Sie Kommentare zur Version hinzu, und wählen Sie dann **OK**aus.</span><span class="sxs-lookup"><span data-stu-id="f36fe-380">In the **Add a document** dialog box, browse for the QuickStatus.app file, add comments for the version, and then choose **OK**.</span></span>
    
8. <span data-ttu-id="f36fe-381">Wenn Sie eine APP hinzufügen, können Sie auch lokale Informationen für die APP-Beschreibung, das Symbol und andere Informationen hinzufügen.</span><span class="sxs-lookup"><span data-stu-id="f36fe-381">When you add an app, you can also add local information for the app description, icon, and other information.</span></span> <span data-ttu-id="f36fe-382">Fügen Sie im Dialogfeld **Apps für SharePoint-Quick Status. app** die Informationen hinzu, die Sie für die app in der SharePoint-Websitesammlung anzeigen möchten.</span><span class="sxs-lookup"><span data-stu-id="f36fe-382">In the **Apps for SharePoint - QuickStatus.app** dialog box, add the information that you want to show for the app in the SharePoint site collection.</span></span> <span data-ttu-id="f36fe-383">Fügen Sie beispielsweise die folgenden Informationen hinzu:</span><span class="sxs-lookup"><span data-stu-id="f36fe-383">For example, add the following information:</span></span> 
    
   1. <span data-ttu-id="f36fe-384">**Kurzes Beschreibungs** Feld: Geben Sie Quick Status Test App ein.</span><span class="sxs-lookup"><span data-stu-id="f36fe-384">**Short Description** field: Type Quick Status test app.</span></span>
    
   2. <span data-ttu-id="f36fe-385">**Beschreibungs** Feld: Geben Sie Test-App ein, um den abgeschlossenen Prozentsatz für Vorgänge in mehreren Projekten zu aktualisieren.</span><span class="sxs-lookup"><span data-stu-id="f36fe-385">**Description** field: Type Test app to update percent complete for tasks in multiple projects.</span></span>
    
   3. <span data-ttu-id="f36fe-386">**Symbol-URL** -Felder: Fügen Sie ein 96 x 96-Pixel Bild für das App-Symbol zu den Websiteobjekten für den App-Katalog hinzu.</span><span class="sxs-lookup"><span data-stu-id="f36fe-386">**Icon URL** fields: Add a 96 x 96-pixel image for the app icon to the site assets for the app catalog.</span></span> <span data-ttu-id="f36fe-387">Navigieren Sie beispielsweise zu `https://ServerName/sites/TestApps`, wählen Sie im Dropdownmenü **Einstellungen** die Option **Websiteinhalte** aus, wählen Sie **Website Objekte**aus, und fügen Sie dann das Bild quickStatusApp. png hinzu.</span><span class="sxs-lookup"><span data-stu-id="f36fe-387">For example, navigate to  `https://ServerName/sites/TestApps`, choose **Site contents** in the **Settings** drop-down menu, choose **Site Assets**, and then add the quickStatusApp.png image.</span></span> <span data-ttu-id="f36fe-388">Klicken Sie mit der rechten Maustaste auf das **quickStatusApp** -Element, wählen Sie **Eigenschaften**aus, und kopieren Sie dann den Wert **Address (URL)** im Dialogfeld **Eigenschaften** .</span><span class="sxs-lookup"><span data-stu-id="f36fe-388">Right-click the **quickStatusApp** item, choose **Properties**, and then copy the **Address (URL)** value in the **Properties** dialog box.</span></span> <span data-ttu-id="f36fe-389">Kopieren `https://ServerName/sites/TestApps/SiteAssets/QuickStatusApp.png`Sie beispielsweise den Wert in das Feld **Symbol-URL** -Webadresse, und fügen Sie ihn ein.</span><span class="sxs-lookup"><span data-stu-id="f36fe-389">For example, copy  `https://ServerName/sites/TestApps/SiteAssets/QuickStatusApp.png`, and then paste the value in the **Icon URL** web address field.</span></span> <span data-ttu-id="f36fe-390">Geben Sie eine Beschreibung für das Symbol ein, beispielsweise (siehe Abbildung 9), geben Sie Quick Status App-Symbol ein.</span><span class="sxs-lookup"><span data-stu-id="f36fe-390">Type a description for the icon, for example (as in Figure 9), type QuickStatus app icon.</span></span> <span data-ttu-id="f36fe-391">Testen Sie, ob die URL gültig ist.</span><span class="sxs-lookup"><span data-stu-id="f36fe-391">Test that the URL is valid.</span></span>
    
      <span data-ttu-id="f36fe-392">**Abbildung 9. Hinzufügen einer Symbol-URL für die Quick Status-App**</span><span class="sxs-lookup"><span data-stu-id="f36fe-392">**Figure 9. Adding an icon URL for the QuickStatus app**</span></span>

      <span data-ttu-id="f36fe-393">![Festlegen von Eigenschaften für die App in SharePoint](media/pj15_CreateStatusingApp_AddAppToSharePointSettings.gif "Festlegen von Eigenschaften für die App in SharePoint")</span><span class="sxs-lookup"><span data-stu-id="f36fe-393">![Setting properties in SharePoint for the app](media/pj15_CreateStatusingApp_AddAppToSharePointSettings.gif "Setting properties in SharePoint for the app")</span></span>
  
   4. <span data-ttu-id="f36fe-394">**Category** -Feld: Wählen Sie eine vorhandene Kategorie aus, oder geben Sie einen eigenen Wert an.</span><span class="sxs-lookup"><span data-stu-id="f36fe-394">**Category** field: Choose an existing category, or specify your own value.</span></span> <span data-ttu-id="f36fe-395">Geben Sie beispielsweise Statusing ein.</span><span class="sxs-lookup"><span data-stu-id="f36fe-395">For example, type Statusing.</span></span>
    
      > [!NOTE]
      > <span data-ttu-id="f36fe-396">Eine Kategorie mit dem Namen **Statusing** dient nur zu Testzwecken.</span><span class="sxs-lookup"><span data-stu-id="f36fe-396">A category named **Statusing** is just for testing purposes.</span></span> <span data-ttu-id="f36fe-397">Eine typische Kategorie für Project Server-Apps ist **Projekt Management**.</span><span class="sxs-lookup"><span data-stu-id="f36fe-397">A typical category for Project Server apps is **Project Management**.</span></span> 
  
   5. <span data-ttu-id="f36fe-398">Feld **Herausgebername** : Geben Sie den Namen des Herausgebers ein.</span><span class="sxs-lookup"><span data-stu-id="f36fe-398">**Publisher name** field: Type the name of the publisher.</span></span> <span data-ttu-id="f36fe-399">Geben Sie in diesem Beispiel Project SDK ein.</span><span class="sxs-lookup"><span data-stu-id="f36fe-399">In this example, type Project SDK.</span></span>
    
   6. <span data-ttu-id="f36fe-400">Feld **Enabled** : Aktivieren Sie das Kontrollkästchen **aktiviert** , um die APP für Project Web App Websiteadministratoren für die Installation sichtbar zu machen.</span><span class="sxs-lookup"><span data-stu-id="f36fe-400">**Enabled** field: To make the app visible to Project Web App site administrators for installation, select the **Enabled** check box.</span></span> 
    
   7. <span data-ttu-id="f36fe-401">Zusätzliche Felder sind optional.</span><span class="sxs-lookup"><span data-stu-id="f36fe-401">Additional fields are optional.</span></span> <span data-ttu-id="f36fe-402">Sie können beispielsweise eine Support-URL und mehrere Hilfe Bilder für die Seite mit den App-Details hinzufügen.</span><span class="sxs-lookup"><span data-stu-id="f36fe-402">For example, you can add a support URL and multiple help images for the app details page.</span></span> <span data-ttu-id="f36fe-403">In Abbildung 9 enthalten die Felder **Bild-URL 1** die URL für einen Screenshot der APP und eine Beschreibung des Screenshot.</span><span class="sxs-lookup"><span data-stu-id="f36fe-403">In Figure 9, the **Image URL 1** fields include the URL for a screenshot of the app and a description of the screenshot.</span></span> 
    
   8. <span data-ttu-id="f36fe-404">Wählen Sie im Dialogfeld **Apps für SharePoint-Quick Status. app** die Option **Speichern**aus.</span><span class="sxs-lookup"><span data-stu-id="f36fe-404">In the **Apps for SharePoint - QuickStatus.app** dialog box, choose **Save**.</span></span> <span data-ttu-id="f36fe-405">In Abbildung 9 ist das Element **Quick Status Update** in der Bibliothek Apps für SharePoint zur Bearbeitung ausgecheckt, daher würden Sie auf der Registerkarte **Bearbeiten** des Dialogfeld-Menübands **Einchecken** auswählen, um den Vorgang abzuschließen (siehe Abbildung 10).</span><span class="sxs-lookup"><span data-stu-id="f36fe-405">In Figure 9, the **Quick Status Update** item in the Apps for SharePoint library is checked out for editing, so on the **EDIT** tab of the dialog box ribbon, you would choose **Check In** to complete the process (see Figure 10).</span></span> 
    
      <span data-ttu-id="f36fe-406">**Abbildung 10. Die Quick Status-APP wird der Apps für SharePoint-Bibliothek hinzugefügt.**</span><span class="sxs-lookup"><span data-stu-id="f36fe-406">**Figure 10. The QuickStatus app is added to the Apps for SharePoint library.**</span></span>

      <span data-ttu-id="f36fe-407">![Die QuickStatus-App wird SharePoint hinzugefügt](media/pj15_CreateStatusingApp_AddAppToSharePoint.gif "Die QuickStatus-App wird SharePoint hinzugefügt")</span><span class="sxs-lookup"><span data-stu-id="f36fe-407">![The QuickStatus app is added to SharePoint](media/pj15_CreateStatusingApp_AddAppToSharePoint.gif "The QuickStatus app is added to SharePoint")</span></span>
  
9. <span data-ttu-id="f36fe-408">Wählen Sie in Project Web App im Dropdownmenü **Einstellungen** die Option **app hinzufügen**aus.</span><span class="sxs-lookup"><span data-stu-id="f36fe-408">In Project Web App, in the **Settings** drop-down menu, choose **Add an app**.</span></span> <span data-ttu-id="f36fe-409">Wählen Sie auf der Seite Ihre apps auf der Schnellstartleiste in **Ihrer Organisation aus**, und wählen Sie dann **App-Details** für die **schnell Status Update** -App aus.</span><span class="sxs-lookup"><span data-stu-id="f36fe-409">On the Your Apps page, in the Quick Launch, choose **From Your Organization**, and then choose **App Details** for the **Quick Status Update** app.</span></span> <span data-ttu-id="f36fe-410">Abbildung 11 zeigt die Detailseite mit dem App-Symbol, Screenshot und anderen Informationen, die Sie im vorherigen Schritt hinzugefügt haben.</span><span class="sxs-lookup"><span data-stu-id="f36fe-410">Figure 11 shows the details page with the app icon, screenshot, and other information that you added in the previous step.</span></span> 
    
   <span data-ttu-id="f36fe-411">**Abbildung 11. Verwenden der Seite Details zum schnell Status Update in Project Web App**</span><span class="sxs-lookup"><span data-stu-id="f36fe-411">**Figure 11. Using the Quick Status Update details page in Project Web App**</span></span>

   <span data-ttu-id="f36fe-412">![Hinzufügen der QuickStatus-App zu Project Web App](media/pj15_CreateStatusingApp_AddAppToPWA.gif "Hinzufügen der QuickStatus-App zu Project Web App")</span><span class="sxs-lookup"><span data-stu-id="f36fe-412">![Adding the QuickStatus app to Project Web App](media/pj15_CreateStatusingApp_AddAppToPWA.gif "Adding the QuickStatus app to Project Web App")</span></span>
  
10. <span data-ttu-id="f36fe-413">Wählen Sie auf der Seite Quick Status Update Details die Option **Hinzufügen**aus.</span><span class="sxs-lookup"><span data-stu-id="f36fe-413">On the Quick Status Update details page, choose **ADD IT**.</span></span> <span data-ttu-id="f36fe-414">Project Web App zeigt ein Dialogfeld an, in dem die Vorgänge aufgelistet sind, die die Quick Status-app ausführen kann (siehe Abbildung 12).</span><span class="sxs-lookup"><span data-stu-id="f36fe-414">Project Web App displays a dialog box that lists the operations that the QuickStatus app can perform (see Figure 12).</span></span> <span data-ttu-id="f36fe-415">Die Liste der Vorgänge wird von den **AppPermissionRequest** -Elementen in der Datei AppManifest. XML abgeleitet.</span><span class="sxs-lookup"><span data-stu-id="f36fe-415">The list of operations is derived from the **AppPermissionRequest** elements in the AppManifest.xml file.</span></span> 
    
    <span data-ttu-id="f36fe-416">**Abbildung 12. Überprüfen, ob Sie der schnell Status-App Vertrauen**</span><span class="sxs-lookup"><span data-stu-id="f36fe-416">**Figure 12. Verifying that you trust the Quick Status app**</span></span>

    <span data-ttu-id="f36fe-417">![Überprüfen des Vertrauens gegenüber der QuickStatus-App](media/pj15_CreateStatusingApp_AddAppToPWA2Trust.gif "Überprüfen des Vertrauens gegenüber der QuickStatus-App")</span><span class="sxs-lookup"><span data-stu-id="f36fe-417">![Verifying trust for the QuickStatus app](media/pj15_CreateStatusingApp_AddAppToPWA2Trust.gif "Verifying trust for the QuickStatus app")</span></span>
  
11. <span data-ttu-id="f36fe-418">Wählen Sie im Dialogfeld **schnell Status Aktualisierung ausführen** **vertrauenswürdig aus**.</span><span class="sxs-lookup"><span data-stu-id="f36fe-418">In the **Do you trust Quick Status Update** dialog box, choose **Trust It**.</span></span> <span data-ttu-id="f36fe-419">Die APP wird der Seite Project Web App Websiteinhalt hinzugefügt (siehe Abbildung 13).</span><span class="sxs-lookup"><span data-stu-id="f36fe-419">The app is added to the Project Web App Site Contents page (see Figure 13).</span></span>
    
    <span data-ttu-id="f36fe-420">**Abbildung 13. Anzeigen der schnell Status-App auf der Seite "Websiteinhalte"**</span><span class="sxs-lookup"><span data-stu-id="f36fe-420">**Figure 13. Viewing the Quick Status app on the Site Contents page**</span></span>

    <span data-ttu-id="f36fe-421">![Anzeigen der QuickStatus-App in den Websiteinhalten](media/pj15_CreateStatusingApp_AddAppToPWA3.gif "Anzeigen der QuickStatus-App in den Websiteinhalten")</span><span class="sxs-lookup"><span data-stu-id="f36fe-421">![Viewing the QuickStatus app in Site Contents](media/pj15_CreateStatusingApp_AddAppToPWA3.gif "Viewing the QuickStatus app in Site Contents")</span></span>
  
<span data-ttu-id="f36fe-422">Auf der Seite Websiteinhalte können Sie das Symbol **Quick Status Update** auswählen, um die APP auszuführen.</span><span class="sxs-lookup"><span data-stu-id="f36fe-422">On the Site Contents page, you can select the **Quick Status Update** icon to run the app.</span></span>

> [!NOTE]
> <span data-ttu-id="f36fe-423">Für zusätzliche Befehle, die Informationen über die APP bereitstellen, wählen Sie auf der Seite Websiteinhalte den Bereich aus, der den **schnell Status Update** Namen und die Auslassungspunkte (...) enthält. Sie können die Seite Info für die APP lesen, die Seite App-Details anzeigen, die Informationen zu app-Fehlern enthält, die Seite App-Berechtigungen überprüfen oder die APP aus Project Web App entfernen.</span><span class="sxs-lookup"><span data-stu-id="f36fe-423">For additional commands that provide information about the app, on the Site Contents page, choose the region that contains the **Quick Status Update** name and the ellipsis (...). You can review the About page for the app, view the App Details page that contains information about app errors, review the app permissions page, or remove the app from Project Web App.</span></span> 
  
<span data-ttu-id="f36fe-424">Auf der Seite Aufgaben in Project Web App (siehe Abbildung 14) sollte die Schaltfläche **Quick Status** auf dem Menüband aktiviert sein.</span><span class="sxs-lookup"><span data-stu-id="f36fe-424">On the Tasks page in Project Web App (see Figure 14), the **QuickStatus** button should be enabled on the ribbon.</span></span> <span data-ttu-id="f36fe-425">Wenn die Schaltfläche " **schnell Status** " deaktiviert ist, versuchen Sie die im Hinweis für Abbildung 7 beschriebenen Aktionen.</span><span class="sxs-lookup"><span data-stu-id="f36fe-425">If the **Quick Status** button is disabled, try the actions described in the note for Figure 7.</span></span> 

<span data-ttu-id="f36fe-426">**Abbildung 14. Starten der Quick Status-App auf der Registerkarte "Aufgaben"**</span><span class="sxs-lookup"><span data-stu-id="f36fe-426">**Figure 14. Starting the QuickStatus app from the TASKS tab**</span></span>

<span data-ttu-id="f36fe-427">![Starten der QuickStatus-App von der Registerkarte "TASKS"](media/pj15_CreateStatusingApp_TasksRibbon.gif "Starten der QuickStatus-App von der Registerkarte "TASKS"")</span><span class="sxs-lookup"><span data-stu-id="f36fe-427">![Starting the QuickStatus app from the TASKS tab](media/pj15_CreateStatusingApp_TasksRibbon.gif "Starting the QuickStatus app from the TASKS tab")</span></span>
  
<span data-ttu-id="f36fe-428">In Prozedur 6 sind einige Tests aufgeführt, die mit der Quick Status-App vorgenommen werden müssen.</span><span class="sxs-lookup"><span data-stu-id="f36fe-428">Procedure 6 shows some tests to make with the QuickStatus app.</span></span>

<span data-ttu-id="f36fe-429"><a name="pj15_StatusingApp_Testing"> </a></span><span class="sxs-lookup"><span data-stu-id="f36fe-429"><a name="pj15_StatusingApp_Testing"> </a></span></span>

## <a name="testing-the-quickstatus-app"></a><span data-ttu-id="f36fe-430">Testen der Quick Status-App</span><span class="sxs-lookup"><span data-stu-id="f36fe-430">Testing the QuickStatus app</span></span>

<span data-ttu-id="f36fe-431">Jeder Vorgang, den ein Benutzer in der **Quick Status** -App möglicherweise ausprobieren sollte, sollte vor der Bereitstellung der APP auf einem Produktions Server oder einem Produktions Mandanten von Project online auf einer Testinstallation von Project Server getestet werden.</span><span class="sxs-lookup"><span data-stu-id="f36fe-431">Every operation that a user might try in the **QuickStatus** app should be tested on a test installation of Project Server before deploying the app to a production server or to a production tenant of Project Online.</span></span> <span data-ttu-id="f36fe-432">Mit einer Testinstallation können Sie Zuordnungen für Benutzer ändern und löschen, ohne dass sich dies auf aktuelle Projekte auswirkt.</span><span class="sxs-lookup"><span data-stu-id="f36fe-432">A test installation enables you to change and delete assignments for users without affecting actual projects.</span></span> <span data-ttu-id="f36fe-433">Bei Tests sollten auch mehrere Benutzer mit unterschiedlichen Berechtigungssätzen wie Administrator, Projektmanager und Teammitglied beteiligt sein.</span><span class="sxs-lookup"><span data-stu-id="f36fe-433">Testing should also involve several users who have different sets of permissions, such as administrator, project manager, and team member.</span></span> <span data-ttu-id="f36fe-434">Durch gründliche Tests können Änderungen aufgezeigt werden, die in der APP vorgenommen werden sollten, was beim Testen während der Entwicklung nicht erkennbar war.</span><span class="sxs-lookup"><span data-stu-id="f36fe-434">Thorough testing can uncover changes that should be made in the app, which were not apparent in testing during development.</span></span> <span data-ttu-id="f36fe-435">In Prozedur 6 werden mehrere Tests für die **Quick Status** -App aufgelistet, es werden jedoch keine erschöpfenden Testreihen eingeschlossen.</span><span class="sxs-lookup"><span data-stu-id="f36fe-435">Procedure 6 lists several tests for the **QuickStatus** app, but does not include an exhaustive series of tests.</span></span> 
  
### <a name="procedure-6-to-test-the-quickstatus-app"></a><span data-ttu-id="f36fe-436">Prozedur 6.</span><span class="sxs-lookup"><span data-stu-id="f36fe-436">Procedure 6.</span></span> <span data-ttu-id="f36fe-437">So testen Sie die Quick Status-App</span><span class="sxs-lookup"><span data-stu-id="f36fe-437">To test the QuickStatus app</span></span>

1. <span data-ttu-id="f36fe-438">Führen Sie die **Quick Status** -App aus, in der der Benutzer keine Zuweisungen hat.</span><span class="sxs-lookup"><span data-stu-id="f36fe-438">Run the **QuickStatus** app where the user has no assignments.</span></span> <span data-ttu-id="f36fe-439">Die APP sollte eine blaue Meldung am unteren Rand der Seite anzeigen, beispielsweise hat der **Benutzer Name keine Zuweisungen**.</span><span class="sxs-lookup"><span data-stu-id="f36fe-439">The app should show a blue message at the bottom of the page, for example, **User Name has no assignments**.</span></span>
    
   <span data-ttu-id="f36fe-440">Wählen Sie **Aktualisieren**aus, und die Nachricht ändert sich in eine grüne **Zuweisung wurde aktualisiert**.</span><span class="sxs-lookup"><span data-stu-id="f36fe-440">Choose **Update**, and the message changes to a green **Assignments have been updated**.</span></span>
    
   > [!NOTE]
   > <span data-ttu-id="f36fe-441">Das App-Verhalten sollte so geändert werden, dass die Schaltfläche **Aktualisieren** deaktiviert ist, wenn keine Zuweisungen vorhanden sind.</span><span class="sxs-lookup"><span data-stu-id="f36fe-441">The app behavior should be changed so that the **Update** button is disabled when there are no assignments.</span></span> 
  
2. <span data-ttu-id="f36fe-442">Führen Sie die APP aus, bei der der Benutzer mehrere Zuordnungen in mehreren verschiedenen Projekten hat und einige Zuordnungen nicht abgeschlossen sind.</span><span class="sxs-lookup"><span data-stu-id="f36fe-442">Run the app where the user has multiple assignments in several different projects and some assignments are not complete.</span></span> <span data-ttu-id="f36fe-443">Beachten Sie die Darstellung der APP, und führen Sie Aktionen wie folgt aus (siehe Abbildung 15):</span><span class="sxs-lookup"><span data-stu-id="f36fe-443">Notice the appearance of the app and perform actions as follows (see Figure 15):</span></span>
    
   1. <span data-ttu-id="f36fe-444">Die **onGetAssignmentsSuccess** -Funktion erstellt eine Zeile in der Tabelle für jede Zuweisung für den aktuellen Benutzer.</span><span class="sxs-lookup"><span data-stu-id="f36fe-444">The **onGetAssignmentsSuccess** function creates a row in the table for each assignment for the current user.</span></span> <span data-ttu-id="f36fe-445">Der Projektname wird nur einmal in einer fetten Schriftart für die erste Zuweisung in jedem Projekt angezeigt.</span><span class="sxs-lookup"><span data-stu-id="f36fe-445">The project name shows only once, in a bold font, for the first assignment in each project.</span></span> 
    
   2. <span data-ttu-id="f36fe-446">Deaktivieren Sie das Kontrollkästchen in der Spaltenüberschrift **Vorgangsname** .</span><span class="sxs-lookup"><span data-stu-id="f36fe-446">Clear the check box in the **Task name** column header.</span></span> <span data-ttu-id="f36fe-447">Der Ereignishandler Tabellenkopf Klick löscht alle anderen Kontrollkästchen in den Vorgangszeilen.</span><span class="sxs-lookup"><span data-stu-id="f36fe-447">The table header click event handler clears all of the other check boxes in the task rows.</span></span> 
    
   3. <span data-ttu-id="f36fe-448">Wählen Sie alle Aufgaben aus.</span><span class="sxs-lookup"><span data-stu-id="f36fe-448">Select all of the tasks.</span></span> <span data-ttu-id="f36fe-449">Der Click-Ereignishandler für jede Zeile bestimmt, ob alle Zeilen ausgewählt sind, und wenn dies der Fall ist, wird die Spaltenüberschrift **Vorgangsname** ausgewählt.</span><span class="sxs-lookup"><span data-stu-id="f36fe-449">The click event handler for each row determines whether all rows are selected, and if so, selects the **Task name** column header.</span></span> 
    
   4. <span data-ttu-id="f36fe-450">Deaktivieren Sie erneut alle Kontrollkästchen, und wählen Sie dann eine Zuordnung mit einer verbleibenden Arbeit aus.</span><span class="sxs-lookup"><span data-stu-id="f36fe-450">Clear all of the check boxes again, and then select one assignment that has some remaining work.</span></span> <span data-ttu-id="f36fe-451">Beispielsweise zeigt Abbildung 15 die oberste Aufgabe T1 verfügt über 20% verbleibenden Arbeit abgeschlossen.</span><span class="sxs-lookup"><span data-stu-id="f36fe-451">For example, Figure 15 shows the top task T1 has 20% remaining work to complete.</span></span>
    
   5. <span data-ttu-id="f36fe-452">Geben Sie im Textfeld **Prozent fertig stellen** den Text 80 ein, und wählen Sie dann **Aktualisieren**aus.</span><span class="sxs-lookup"><span data-stu-id="f36fe-452">In the **Set percent complete** text box, type 80, and then choose **Update**.</span></span> <span data-ttu-id="f36fe-453">Am unteren Rand der Seite sollte eine grüne Meldung angezeigt werden, **Zuordnungen wurden aktualisiert**.</span><span class="sxs-lookup"><span data-stu-id="f36fe-453">The bottom of the page should show a green message, **Assignments have been updated**.</span></span>
    
      <span data-ttu-id="f36fe-454">**Abbildung 15. Aktualisieren einer Zuordnung in der Quick Status-App**</span><span class="sxs-lookup"><span data-stu-id="f36fe-454">**Figure 15. Updating an assignment in the QuickStatus app**</span></span>

      <span data-ttu-id="f36fe-455">![Aktualisieren einer Zuweisung in der QuickStatus-App](media/pj15_CreateStatusingApp_Testing1Update.gif "Aktualisieren einer Zuweisung in der QuickStatus-App")</span><span class="sxs-lookup"><span data-stu-id="f36fe-455">![Updating an assignment in the QuickStatus app](media/pj15_CreateStatusingApp_Testing1Update.gif "Updating an assignment in the QuickStatus app")</span></span>
  
3. <span data-ttu-id="f36fe-456">Wählen Sie **Aktualisieren** (siehe Abbildung 16).</span><span class="sxs-lookup"><span data-stu-id="f36fe-456">Choose **Refresh** (see Figure 16).</span></span> <span data-ttu-id="f36fe-457">Alle Aufgaben werden erneut ausgewählt, und die oberste Aufgabe zeigt 80% abgeschlossen.</span><span class="sxs-lookup"><span data-stu-id="f36fe-457">All of the tasks are selected again, and the top task shows 80% complete.</span></span> 
    
      <span data-ttu-id="f36fe-458">**Abbildung 16. Aktualisieren der Seite "schnell Status Aktualisierung"**</span><span class="sxs-lookup"><span data-stu-id="f36fe-458">**Figure 16. Refreshing the Quick Status Update page**</span></span>

      <span data-ttu-id="f36fe-459">![Aktualisieren der QuickStatus-Seite](media/pj15_CreateStatusingApp_Testing2Refresh.gif "Aktualisieren der QuickStatus-Seite")</span><span class="sxs-lookup"><span data-stu-id="f36fe-459">![Refreshing the QuickStatus page](media/pj15_CreateStatusingApp_Testing2Refresh.gif "Refreshing the QuickStatus page")</span></span>
  
4. <span data-ttu-id="f36fe-460">Deaktivieren Sie alle Kontrollkästchen, und wählen Sie dann eine andere Aufgabe aus.</span><span class="sxs-lookup"><span data-stu-id="f36fe-460">Clear all of the check boxes, and then select another task.</span></span> <span data-ttu-id="f36fe-461">Wählen Sie beispielsweise **neuer Vorgang aus PWA aus**.</span><span class="sxs-lookup"><span data-stu-id="f36fe-461">For example, select **New task from PWA**.</span></span> <span data-ttu-id="f36fe-462">Lassen Sie das Textfeld **Prozentsatz abgeschlossen** leer, löschen Sie den gesamten Text in der Spalte **% abgeschlossen** für den ausgewählten Vorgang, und wählen Sie dann **Aktualisieren**aus.</span><span class="sxs-lookup"><span data-stu-id="f36fe-462">Leave the **Set percent complete** text box empty, delete all text in the **% complete** column for the selected task, and then choose **Update**.</span></span> <span data-ttu-id="f36fe-463">Da beide Textfelder leer sind, wird in der App eine rote Fehlermeldung angezeigt (siehe Abbildung 17).</span><span class="sxs-lookup"><span data-stu-id="f36fe-463">Because both text boxes are empty, the app shows a red error message (see Figure 17).</span></span>
    
      <span data-ttu-id="f36fe-464">**Abbildung 17. Testen der Fehlermeldung**</span><span class="sxs-lookup"><span data-stu-id="f36fe-464">**Figure 17. Testing the error message**</span></span>

      <span data-ttu-id="f36fe-465">![Testen der Fehlermeldung](media/pj15_CreateStatusingApp_Testing3Error.gif "Testen der Fehlermeldung")</span><span class="sxs-lookup"><span data-stu-id="f36fe-465">![Testing the error message](media/pj15_CreateStatusingApp_Testing3Error.gif "Testing the error message")</span></span>
  
5. <span data-ttu-id="f36fe-466">Aktualisieren Sie die vorherige Aufgabe auf 80% abgeschlossen, und wählen Sie dann **Beenden**aus.</span><span class="sxs-lookup"><span data-stu-id="f36fe-466">Update the previous task to 80% complete, and then choose **Exit**.</span></span> <span data-ttu-id="f36fe-467">Die **exitToPwa** -Funktion ändert den Speicherort des Browserfensters auf die Seite Aufgaben in der SharePoint-Hostanwendung (die URL ändert https://ServerName/pwa/Tasks.aspx)sich in.</span><span class="sxs-lookup"><span data-stu-id="f36fe-467">The **exitToPwa** function changes the browser window location to the Tasks page in the SharePoint host application (that is, the URL changes to https://ServerName/pwa/Tasks.aspx).</span></span> <span data-ttu-id="f36fe-468">Abbildung 18 zeigt, dass die **T1** -Aufgabe und die **neue Aufgabe aus PWA** -Aufgabe jeweils 80% abgeschlossen anzeigen.</span><span class="sxs-lookup"><span data-stu-id="f36fe-468">Figure 18 shows that the **T1** task and the **New task from PWA** task each show 80% complete.</span></span> 
    
      <span data-ttu-id="f36fe-469">**Abbildung 18. Überprüfen, ob die Vorgänge in Project Web App aktualisiert wurden**</span><span class="sxs-lookup"><span data-stu-id="f36fe-469">**Figure 18. Verifying the tasks are updated in Project Web App**</span></span>

      <span data-ttu-id="f36fe-470">![Überprüfen der aktualisierten Aufgaben in Project Web App](media/pj15_CreateStatusingApp_TasksUpdatedInPWA.gif "Überprüfen der aktualisierten Aufgaben in Project Web App")</span><span class="sxs-lookup"><span data-stu-id="f36fe-470">![Verifying the updated tasks in Project Web App](media/pj15_CreateStatusingApp_TasksUpdatedInPWA.gif "Verifying the updated tasks in Project Web App")</span></span>
  
6. <span data-ttu-id="f36fe-471">Bevor der aktualisierte Status in Project Professional 2013 angezeigt wird, müssen die Änderungen zur Genehmigung übermittelt und dann vom Projektmanager genehmigt werden.</span><span class="sxs-lookup"><span data-stu-id="f36fe-471">Before the updated status shows in Project Professional 2013, the changes must be submitted for approval, and then approved by the project manager.</span></span>
    
<span data-ttu-id="f36fe-472">Das Testen zeigt mehrere andere Änderungen, die in der **Quick Status** -App für eine verbesserte Benutzerfreundlichkeit vorgenommen werden sollten.</span><span class="sxs-lookup"><span data-stu-id="f36fe-472">Testing reveals several other changes that should be made in the **QuickStatus** app for improved usability.</span></span> <span data-ttu-id="f36fe-473">Zum Beispiel:</span><span class="sxs-lookup"><span data-stu-id="f36fe-473">For example:</span></span>

- <span data-ttu-id="f36fe-474">Es sollten zusätzliche Fehlerprüfungen und die Validierung von Text Feldwerten erfolgen.</span><span class="sxs-lookup"><span data-stu-id="f36fe-474">There should be additional error checks and validation of text box values.</span></span> <span data-ttu-id="f36fe-475">Derzeit kann ein Benutzer einen nicht numerischen Wert oder einen negativen Wert für den abgeschlossenen Prozentsatz eingeben, was zu einer unfreundlichen Fehlermeldung führt.</span><span class="sxs-lookup"><span data-stu-id="f36fe-475">Currently, a user can enter a non-numeric value or a negative value for percent complete, which results in an unfriendly error message.</span></span> <span data-ttu-id="f36fe-476">Bei einem negativen Wert ist die Fehlermeldung beispielsweise **Fehler beim Aktualisieren der Zuordnungen: PJClientCallableException: StatusingSetDataValueInvalid**.</span><span class="sxs-lookup"><span data-stu-id="f36fe-476">For example, with a negative value, the error message is **Error updating assignments: PJClientCallableException: StatusingSetDataValueInvalid**.</span></span>
    
- <span data-ttu-id="f36fe-477">Die Fehlermeldung für leere Textfelder kann neben der Zeilennummer auch das Projekt und die Aufgabe auflisten.</span><span class="sxs-lookup"><span data-stu-id="f36fe-477">The error message for blank text boxes could list the project and task, in addition to the row number.</span></span>
    
- <span data-ttu-id="f36fe-478">Die Erfolgsmeldung könnte eine Liste der aktualisierten Aufgaben enthalten. oder wenn die **updateAssignments** -Funktion erfolgreich ist, kann Sie eine automatische Seitenaktualisierung durchführen und aktualisierte Vorgänge oder Prozentsätze in einer anderen Farbe und einer fetten Schriftart anzeigen.</span><span class="sxs-lookup"><span data-stu-id="f36fe-478">The success message could include a list of the tasks updated; or if the **updateAssignments** function is successful, it could perform an automatic page refresh and show updated tasks or percentages in a different color and bold font.</span></span> 
    
- <span data-ttu-id="f36fe-479">Um eine sehr große Tabelle zu vermeiden, sollte die Zuordnungstabelle auf Aufgaben limitiert sein, die weniger als 100% abgeschlossen sind.</span><span class="sxs-lookup"><span data-stu-id="f36fe-479">To avoid a very large table, the table of assignments should be limited to tasks that are less than 100% complete.</span></span> <span data-ttu-id="f36fe-480">Oder fügen Sie eine Option hinzu, um alle Aufgaben anzuzeigen.</span><span class="sxs-lookup"><span data-stu-id="f36fe-480">Or, add an option to show all tasks.</span></span> <span data-ttu-id="f36fe-481">Dieses Problem kann auch mithilfe eines auf jQuery basierenden Rasters anstelle einer Tabelle behoben werden, in der Sie die Filterung und das Raster-Paging ganz einfach implementieren können.</span><span class="sxs-lookup"><span data-stu-id="f36fe-481">This problem could also be solved by using a jQuery-based grid instead of a table, where you can easily implement filtering and grid paging.</span></span>
    
- <span data-ttu-id="f36fe-482">Da die **Quick Status** -App den Status nicht übermittelt, wäre das Symbol " **schnell Status** " auf der Registerkarte " **Aufgaben** " des Menübands mehr logisch das erste Symbol in der Gruppe " **Aufgaben** " und nicht das letzte Symbol in der **Submit** -Gruppe.</span><span class="sxs-lookup"><span data-stu-id="f36fe-482">Because the **QuickStatus** app does not submit status, the **Quick Status** icon on the **TASKS** tab of the ribbon would more logically be the first icon in the **Tasks** group, rather than the last icon in the **Submit** group.</span></span> 
    
- <span data-ttu-id="f36fe-483">Da die **onGetAssignmentsSuccess** -Funktion den **btnSubmitUpdate** -Schaltflächentext initialisiert, aber die anderen Schaltflächen Textwerte in HTML initialisiert werden, bleibt die Seite in einem teilweise initialisierten Zustand, während die **getassigns** -Funktion ausgeführt wird.</span><span class="sxs-lookup"><span data-stu-id="f36fe-483">Because the **onGetAssignmentsSuccess** function initializes the **btnSubmitUpdate** button text, but the other button text values are initialized in HTML, the page is left in a partially initialized state while the **getAssignments** function runs.</span></span> <span data-ttu-id="f36fe-484">Schaltflächen auf der Seite werden konsistenter angezeigt, wenn die Textwerte alle in HTML initialisiert wurden.</span><span class="sxs-lookup"><span data-stu-id="f36fe-484">Buttons on the page would appear more consistent if the text values were all initialized in HTML.</span></span> 
    
<span data-ttu-id="f36fe-485">Am wichtigsten ist, dass der von der **Quick Status** -App verwendete Ansatz, bei dem er für Zuordnungen den abgeschlossenen Prozentsatz ändert, in einer Produktions-App überarbeitet werden sollte.</span><span class="sxs-lookup"><span data-stu-id="f36fe-485">Most importantly, the approach that the **QuickStatus** app uses, where it changes percent complete for assignments, should be revised in a production app.</span></span> <span data-ttu-id="f36fe-486">Weitere Informationen finden Sie im Abschnitt " [Nächste Schritte](#pj15_StatusingApp_NextSteps) ".</span><span class="sxs-lookup"><span data-stu-id="f36fe-486">For more information, see the [Next steps](#pj15_StatusingApp_NextSteps) section.</span></span> 

<span data-ttu-id="f36fe-487"><a name="pj15_StatusingApp_Example"> </a></span><span class="sxs-lookup"><span data-stu-id="f36fe-487"><a name="pj15_StatusingApp_Example"> </a></span></span>

## <a name="example-code-for-the-quickstatus-app"></a><span data-ttu-id="f36fe-488">Beispielcode für die Quick Status-App</span><span class="sxs-lookup"><span data-stu-id="f36fe-488">Example code for the QuickStatus app</span></span>

### <a name="defaultaspx-file"></a><span data-ttu-id="f36fe-489">Datei "default. aspx"</span><span class="sxs-lookup"><span data-stu-id="f36fe-489">Default.aspx file</span></span>

<span data-ttu-id="f36fe-490">Der folgende Code befindet sich in `Pages\Default.aspx` der Datei des **Quick Status** -Projekts:</span><span class="sxs-lookup"><span data-stu-id="f36fe-490">The following code is in the  `Pages\Default.aspx` file of the **QuickStatus** project:</span></span> 
...
### <a name="appjs-file"></a><span data-ttu-id="f36fe-491">Datei "App. js"</span><span class="sxs-lookup"><span data-stu-id="f36fe-491">App.js file</span></span>

<span data-ttu-id="f36fe-492">Der folgende Code befindet sich in `Scripts\App.js` der Datei des **Quick Status** -Projekts:</span><span class="sxs-lookup"><span data-stu-id="f36fe-492">The following code is in the  `Scripts\App.js` file of the **QuickStatus** project:</span></span> 
...
### <a name="appcss-file"></a><span data-ttu-id="f36fe-493">App.css-Datei</span><span class="sxs-lookup"><span data-stu-id="f36fe-493">App.css file</span></span>

<span data-ttu-id="f36fe-494">Der folgende CSS-Code befindet sich `Content\App.css` in der Datei des **Quick Status** -Projekts:</span><span class="sxs-lookup"><span data-stu-id="f36fe-494">The following CSS code is in the  `Content\App.css` file of the **QuickStatus** project:</span></span> 
...
### <a name="elementsxml-file-for-the-ribbon"></a><span data-ttu-id="f36fe-495">Datei "Elements. xml" für das Menüband</span><span class="sxs-lookup"><span data-stu-id="f36fe-495">Elements.xml file for the ribbon</span></span>

<span data-ttu-id="f36fe-496">Die folgende XML-Definition für die Schaltfläche hinzugefügt auf der Registerkarte **Aufgaben** im Menüband befindet `RibbonQuickStatusAction\Elements.xml` sich in der Datei des **Quick Status** -Projekts:</span><span class="sxs-lookup"><span data-stu-id="f36fe-496">The following XML definition, for the added button on the **TASKS** tab on the ribbon, is in the  `RibbonQuickStatusAction\Elements.xml` file of the **QuickStatus** project:</span></span> 
...
### <a name="appmanifestxml-file"></a><span data-ttu-id="f36fe-497">Die Datei "AppManifest.xml"</span><span class="sxs-lookup"><span data-stu-id="f36fe-497">AppManifest.xml file</span></span>

<span data-ttu-id="f36fe-498">Im folgenden finden Sie den XML-Code für das App-Manifest des **Quick Status** -Projekts, das die beiden Berechtigungs Anforderungsbereiche enthält, die für die Aktualisierung des Zuordnungsstatus des App-Benutzers in mehreren Projekten erforderlich sind:</span><span class="sxs-lookup"><span data-stu-id="f36fe-498">Following is the XML for the app manifest of the **QuickStatus** project, which includes the two permission request scopes that are necessary for updating the app user's assignment status in multiple projects:</span></span> 
...
### <a name="appiconpng-file"></a><span data-ttu-id="f36fe-499">AppIcon. png-Datei</span><span class="sxs-lookup"><span data-stu-id="f36fe-499">AppIcon.png file</span></span>

<span data-ttu-id="f36fe-500">Die vollständige Visual Studio Lösung für die **Quick Status** -app enthält eine benutzerdefinierte AppIcon. png-Datei.</span><span class="sxs-lookup"><span data-stu-id="f36fe-500">The complete Visual Studio solution for the **QuickStatus** app includes a custom AppIcon.png file.</span></span> <span data-ttu-id="f36fe-501">Die Lösung wird im Project 2013 SDK-Download enthalten sein.</span><span class="sxs-lookup"><span data-stu-id="f36fe-501">The solution will be included in the Project 2013 SDK download.</span></span> 

<span data-ttu-id="f36fe-502"><a name="pj15_StatusingApp_NextSteps"> </a></span><span class="sxs-lookup"><span data-stu-id="f36fe-502"><a name="pj15_StatusingApp_NextSteps"> </a></span></span>

## <a name="next-steps"></a><span data-ttu-id="f36fe-503">Nächste Schritte</span><span class="sxs-lookup"><span data-stu-id="f36fe-503">Next steps</span></span>

<span data-ttu-id="f36fe-504">Die **Quick Status** -APP ist ein relativ einfaches Beispiel für das Schreiben von apps, die auf Project Server 2013 und Project Online installiert werden können.</span><span class="sxs-lookup"><span data-stu-id="f36fe-504">The **QuickStatus** app is a relatively simple example of how to write apps that can be installed on Project Server 2013 and Project Online.</span></span> <span data-ttu-id="f36fe-505">Im Abschnitt [Testen des Quick Status-App](#pj15_StatusingApp_Testing) werden mehrere Verbesserungen aufgeführt, die für eine bessere Benutzerfreundlichkeit vorgenommen werden können.</span><span class="sxs-lookup"><span data-stu-id="f36fe-505">The [Testing the QuickStatus app](#pj15_StatusingApp_Testing) section lists several improvements that can be made for better usability.</span></span> <span data-ttu-id="f36fe-506">Die **Quick Status** -App verwendet JavaScript-Funktionen, um den Zuordnungsstatus für Project Web App zu aktualisieren.</span><span class="sxs-lookup"><span data-stu-id="f36fe-506">The **QuickStatus** app uses JavaScript functions to update assignment status for Project Web App.</span></span> <span data-ttu-id="f36fe-507">Das Ändern der Zuordnung "abgeschlossener Prozentsatz" ist jedoch keine empfohlene Projekt Verwaltungsmethode.</span><span class="sxs-lookup"><span data-stu-id="f36fe-507">But, changing the assignment percent complete is not a recommended project management practice.</span></span> <span data-ttu-id="f36fe-508">Ein weiterer Ansatz besteht darin, das tatsächliche Startdatum und die verbleibende Dauer der zugewiesenen Vorgänge zu aktualisieren.</span><span class="sxs-lookup"><span data-stu-id="f36fe-508">Another approach would be to update the actual start date and remaining duration of assigned tasks.</span></span> <span data-ttu-id="f36fe-509">Eine Erläuterung der Probleme finden Sie unter [Update besser](https://www.mpug.com/articles/update-better) im MPUG-Newsletter.</span><span class="sxs-lookup"><span data-stu-id="f36fe-509">For a discussion of the issues, see [Update Better](https://www.mpug.com/articles/update-better) in the MPUG newsletter.</span></span> 

<span data-ttu-id="f36fe-510"><a name="pj15_StatusingApp_AdditionalResources"> </a></span><span class="sxs-lookup"><span data-stu-id="f36fe-510"><a name="pj15_StatusingApp_AdditionalResources"> </a></span></span>

## <a name="see-also"></a><span data-ttu-id="f36fe-511">Siehe auch</span><span class="sxs-lookup"><span data-stu-id="f36fe-511">See also</span></span>

- [<span data-ttu-id="f36fe-512">Project Server-Programmieraufgaben</span><span class="sxs-lookup"><span data-stu-id="f36fe-512">Project Server programming tasks</span></span>](project-programming-tasks.md)
- [<span data-ttu-id="f36fe-513">SharePoint-Add-Ins</span><span class="sxs-lookup"><span data-stu-id="f36fe-513">SharePoint Add-ins</span></span>](https://msdn.microsoft.com/library/jj163230.aspx)
- [<span data-ttu-id="f36fe-514">Verwalten von Vorgangsaktualisierungen in Project Web App</span><span class="sxs-lookup"><span data-stu-id="f36fe-514">Managing task updates in Project Web App</span></span>](https://technet.microsoft.com/library/hh767481%28v=office.14%29.aspx)
- [<span data-ttu-id="f36fe-515">Erstellen benutzerdefinierter Aktionen zur Bereitstellung mit SharePoint-Add-Ins</span><span class="sxs-lookup"><span data-stu-id="f36fe-515">Create custom actions to deploy with SharePoint Add-ins</span></span>](https://msdn.microsoft.com/library/jj163954.aspx)
