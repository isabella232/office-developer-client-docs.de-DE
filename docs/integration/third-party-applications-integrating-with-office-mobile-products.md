...
Ich bestätige ferner, dass (a) das nicht ordnungsgemäße Identifizieren von Dokumenten als Verbraucher oder Unternehmen zu einer Beendigung der Fähigkeit meines Unternehmens zur Integration in Microsoft Office-Produkte führen kann. und (b) Microsoft kann diese Bedingungen von Zeit zu Zeit aktualisieren, und es obliegt mir oder einem anderen Vertreter, in meiner Eigenschaft zu prüfen, ob neue Bedingungen gelten, bevor nachfolgende Dateiinformationen weitergegeben werden. Wenn Microsoft die Nutzungsbedingungen ändert, gibt das aktuelle Datum oben auf dieser Inhaltsseite die folgenden Änderungen an, beispielsweise "updated as of month/year".
