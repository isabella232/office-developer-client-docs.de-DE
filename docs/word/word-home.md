...
Hier finden Sie Vorgehensweisen, Beispielcode, SDK- und API-Dokumentation, VBA-Referenzen, Schulungen und technische Artikel zum Entwickeln von Lösungen und Anpassen von Word ein.
...
- [Erste Schritte mit Word-add-ins](https://docs.microsoft.com/en-us/office/dev/add-ins/quickstarts/word-quickstart)
  
- [Plattformübersicht](https://docs.microsoft.com/en-us/office/dev/add-ins/overview/office-add-ins)
  
### <a name="code-samples"></a>Codebeispiele
  
- [Word-Codebeispiele in der Office Developer Center](https://developer.microsoft.com/en-us/word/gallery/?filterBy=Word,Samples)
