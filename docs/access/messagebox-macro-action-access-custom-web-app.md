...
---
# <a name="messagebox-macro-action-access-custom-web-app"></a>Abfrageergebnis-Makroaktion (Access benutzerdefinierte Web app)
...
Die **Abfrageergebnis** -Aktion hat das folgende Argument. 
