...
---
# <a name="day-function-access-custom-web-app"></a>Day-Funktion (Access benutzerdefinierte Web app)

Gibt eine ganze Zahl, die den Tag (Tag des Monats), der dem angegebenen Datum im gregorianischen Kalender darstellt.
...
**Tag** gibt den gleichen Wert wie **Datepart** (Tag, Date) zurück. 
