...
---
# <a name="year-function-access-custom-web-app"></a>Year-Funktion (Access benutzerdefinierte Web app)

Gibt einen numerischen Wert, der das Jahr des angegebenen Datums im gregorianischen Kalender darstellt.
...
Von den Funktionen **Jahr**, **Monat**und **Tag** zurückgegebenen Werte werden Gregorianische Werte das Anzeigeformat für den angegebenen Wert. Wenn das Anzeigeformat für das angegebene Datum verwendet, der Hijri-Kalender, die zurückgegebenen Werte für das **Jahr**, **Monat**und **Tag** -Funktionen wird werden beispielsweise Werte zugeordnet, mit dem entsprechenden gregorianischen Datum. 
