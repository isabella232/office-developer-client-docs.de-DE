...
---
# <a name="month-function-access-custom-web-app"></a>Month-Funktion (Access benutzerdefinierte Web app)

Gibt eine ganze Zahl, die den Monat des angegebenen Datums darstellt.
...
**Month** -Funktion enthält das folgende Argument. 
...
Wenn *Datum* nur einen Teil einer Uhrzeit enthält, ist der Rückgabewert 1, der Basis Monat. 
