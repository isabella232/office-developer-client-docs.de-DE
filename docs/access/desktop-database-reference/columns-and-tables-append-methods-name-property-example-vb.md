---
title: Append-Methode (Columns und Tables), Name-Eigenschaft (beispiel) (VB)
...
ms.locfileid: "59565814"
---
# <a name="columns-and-tables-append-methods-name-property-example-vb"></a>Append-Methode (Columns und Tables), Name-Eigenschaft (beispiel) (VB)
