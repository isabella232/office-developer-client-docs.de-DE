...
ms.locfileid: "25887411"
---
# <a name="openschema-method-example-vj"></a><span data-ttu-id="19e64-102">OpenSchema-Methode (Beispiel) (VJ++)</span><span class="sxs-lookup"><span data-stu-id="19e64-102">OpenSchema method example (VJ++)</span></span>


<span data-ttu-id="19e64-103">**Betrifft**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="19e64-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="19e64-104">In diesem Beispiel wird die [OpenSchema](openschema-method-ado.md)-Methode verwendet, um den Namen und den Typ jeder Tabelle in der ***Pubs***-Datenbank anzuzeigen.</span><span class="sxs-lookup"><span data-stu-id="19e64-104">This example uses the [OpenSchema](openschema-method-ado.md) method to display the name and type of each table in the ***Pubs*** database.</span></span>
