...
Der Name des IIS-Webservers, auf dem VBScript ausgeführt wird, kann von VBScript erkannt werden, indem auf die für Active Server Pages (ASP) verfügbare VBScript-Methode **Request.ServerVariables** zugegriffen wird:
