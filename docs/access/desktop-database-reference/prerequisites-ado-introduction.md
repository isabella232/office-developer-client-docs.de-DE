...
ms.openlocfilehash: 802b7f8c8a5e3d3e072e6d0670200c48d103b3bf
ms.sourcegitcommit: c557bbcccf37a6011f89aae1ddd399dfe549d087
ms.translationtype: MT
ms.contentlocale: de-DE
ms.lasthandoff: 10/31/2018
ms.locfileid: "25867846"
---
...
Das *ADO-Programmierhandbuch* wird als nützlich für Entwickler mit einer Vielzahl von Hintergründe erweisen. Die Benutzer dieses Handbuchs sollten mindestens mittlere Vorkenntnisse beim Entwickeln von Anwendungen mit Microsoft Visual Basic haben, weil die meisten Beispiele in diesem Handbuch in dieser Sprache geschrieben sind. Andere Beispiele sind in Microsoft Visual C++, Java, Visual Basic Scripting Edition (VBScript) und Microsoft JScript geschrieben.
...
ADO ist Teil der Microsoft Data Access-Strategie (UDA). (Weitere Informationen zu UDA finden Sie unter "[Rolle von ADO in Microsoft Data Access](the-role-of-ado-in-microsoft-data-access.md)" weiter unten in diesem Kapitel.) Als solche interagiert ADO mit der OLE DB-Technologie. OLE DB basiert auf Microsoft Component Object Model (COM). Deshalb können sich COM-Kenntnisse als hilfreich erweisen, um einige erweiterte ADO-Konzepte zu verstehen.
