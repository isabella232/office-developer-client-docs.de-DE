...
Erstellt eine Löschabfrage, die Datensätze aus einer oder mehreren Tabellen in der [FROM](https://msdn.microsoft.com/library/ff836674\(v=office.15\))-Klausel löscht, die die Kriterien der [WHERE](https://msdn.microsoft.com/library/ff195245\(v=office.15\))-Klausel erfüllen.
