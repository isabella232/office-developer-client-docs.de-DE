...
In diesem Beispiel wird eine TABLE \_ TYPE-Abfrageeinschränkung im **Argument Kriterien** _ der OpenSchema-Methode ***angegeben. Daher* werden nur Schemainformationen für die in der __Pubs-Datenbank angegebenen_ Ansichten** zurückgegeben. In dem Beispiel wird anschließend der Name und Typ jeder einzelnen Tabelle angezeigt.
