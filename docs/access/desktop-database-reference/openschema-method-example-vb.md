...
In diesem Beispiel wird eine\_Abfrageeinschränkung für Tabellentypen im Argument OpenSchema method ***Criteria*** angegeben. **** Folglich werden nur Schemainformationen für die in der ***Pubs***-Datenbank angegebenen Ansichten zurückgegeben. In dem Beispiel wird anschließend der Name und Typ jeder einzelnen Tabelle angezeigt.
