...
---
# <a name="using-the-command-object-reference-ado"></a>Using the Command Object Reference (ADO)
...
**Betrifft**: Access 2013 | Office 2013
  ...
  - [Command-Objekt - Übersicht](command-object-overview.md)
  ...
  - [Aufrufen einer gespeicherten Prozedur mithilfe eines Befehls](calling-a-stored-procedure-with-a-command.md)
