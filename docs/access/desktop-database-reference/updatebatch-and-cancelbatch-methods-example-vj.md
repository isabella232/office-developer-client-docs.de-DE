...
ms.locfileid: "32313559"
---
# <a name="updatebatch-and-cancelbatch-methods-example-vj"></a><span data-ttu-id="3ef8f-102">UpdateBatch- und CancelBatch-Methode (Beispiel) (VJ++)</span><span class="sxs-lookup"><span data-stu-id="3ef8f-102">UpdateBatch and CancelBatch methods example (VJ++)</span></span>


<span data-ttu-id="3ef8f-103">**Gilt für**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="3ef8f-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="3ef8f-104">Dieses Beispiel veranschaulicht die [UpdateBatch](updatebatch-method-ado.md)-Methode in Verbindung mit der [CancelBatch](cancelbatch-method-ado.md)-Methode.</span><span class="sxs-lookup"><span data-stu-id="3ef8f-104">This example demonstrates the [UpdateBatch](updatebatch-method-ado.md) method in conjunction with the [CancelBatch](cancelbatch-method-ado.md) method.</span></span>
