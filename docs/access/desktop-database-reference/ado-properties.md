...
<td><p>Gibt an, auf welcher Seite sich der aktuelle Datensatz befindet.</p></td>
</tr>
<tr class="even">
<td><p><a href="absoluteposition-property-ado.md">AbsolutePosition</a></p></td>
<td><p>Gibt die Position des aktuellen Datensatzes eines <strong>Recordset</strong>-Objekts an.</p></td>
</tr>
<tr class="odd">
<td><p><a href="activecommand-property-ado.md">ActiveCommand</a></p></td>
<td><p>Gibt das <strong>Command</strong>-Objekt an, mit dem das zugeordnete <strong>Recordset</strong>-Objekt erstellt wurde.</p></td>
</tr>
<tr class="even">
<td><p><a href="activeconnection-property-ado.md">ActiveConnection</a></p></td>
<td><p>Gibt an, zu welchem <strong>Connection</strong>-Objekt das angegebene <strong>Command</strong>-, <strong>Recordset</strong>- oder <strong>Record</strong>-Objekt derzeit gehört.</p></td>
</tr>
<tr class="odd">
...
<td><p>Ein <strong>Chapter</strong>-OLE DB-Objekt wird aus einem <strong>ADORecordsetConstruction</strong>-Objekt abgerufen oder für dieses festgelegt.</p></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td><p><a href="precision-property-ado.md">Mit doppelter Genauigkeit</a></p></td>
...
<tr class="odd">
<td><p><a href="https://docs.microsoft.com/office/vba/access/concepts/miscellaneous/size-property-ado-stream">Größe (ADO-Datenstrom)</a></p></td>
<td><p>Die Gesamtgröße des Datenstroms wird als Byteanzahl angegeben.</p></td>
</tr>
<tr class="even">
...
<tr class="even">
<td><p><a href="source-property-ado-record.md">Quelle (ADO-Datensatz)</a></p></td>
...
<td><p>Die Quelle für die Daten in einem <strong>Recordset</strong>-Objekt wird angegeben.</p></td>
</tr>
<tr class="even">
...
<td><p>Gibt für alle entsprechenden Objekte an, ob deren Status als geöffnet oder geschlossen gilt. Für alle entsprechenden Objekte, durch die eine asynchrone Methode ausgeführt wird, wird angegeben, ob der aktuelle Status des Objekts connecting, executing oder retrieving entspricht.</p></td>
</tr>
<tr class="even">
...
<td><p>In einem hierarchischen <strong>Recordset</strong>-Objekt wird angegeben, ob der Verweis auf die zugrunde liegenden untergeordneten Datensätze (d. h. das <em>Kapitel</em>) geändert wird, wenn die Position der übergeordneten Zeile geändert wird.</p></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td><p><a href="type-property-ado-stream.md">Typ (ADO Stream)</a></p></td>
