---
title: ADO-NumericScale-und Precision-Eigenschaft (Beispiel) (VC + +)
...
ms.locfileid: "32283268"
---
# <a name="ado-numericscale-and-precision-properties-example-vc"></a><span data-ttu-id="cee70-102">ADO-NumericScale-und Precision-Eigenschaft (Beispiel) (VC + +)</span><span class="sxs-lookup"><span data-stu-id="cee70-102">ADO NumericScale and Precision properties example (VC++)</span></span>


<span data-ttu-id="cee70-103">**Gilt für**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="cee70-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="cee70-104">In diesem Beispiel werden die Eigenschaften [NumericScale](numericscale-property-ado.md) und [Precision](precision-property-ado.md) verwendet, um die Anzahl von Dezimalstellen und die Genauigkeit der Felder in der ***Discounts***-Tabelle der ***Pubs***-Datenbank anzuzeigen.</span><span class="sxs-lookup"><span data-stu-id="cee70-104">This example uses the [NumericScale](numericscale-property-ado.md) and [Precision](precision-property-ado.md) properties to display the numeric scale and precision of fields in the ***Discounts*** table of the ***Pubs*** database.</span></span>
