...
ms.locfileid: "25878416"
---
# <a name="openschema-method-example-vc"></a><span data-ttu-id="62c32-102">OpenSchema-Methode (Beispiel) (VC++)</span><span class="sxs-lookup"><span data-stu-id="62c32-102">OpenSchema method example (VC++)</span></span>


<span data-ttu-id="62c32-103">**Betrifft**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="62c32-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="62c32-104">In diesem Beispiel wird die [OpenSchema](openschema-method-ado.md)-Methode verwendet, um den Namen und den Typ jeder Tabelle in der ***Pubs***-Datenbank anzuzeigen.</span><span class="sxs-lookup"><span data-stu-id="62c32-104">This example uses the [OpenSchema](openschema-method-ado.md) method to display the name and type of each table in the ***Pubs*** database.</span></span>
