...
ms.locfileid: "32296661"
---
# <a name="cancel-method-example-vj"></a><span data-ttu-id="784e8-102">Cancel-Methode (Beispiel) (VJ++)</span><span class="sxs-lookup"><span data-stu-id="784e8-102">Cancel method example (VJ++)</span></span>


<span data-ttu-id="784e8-103">**Gilt für**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="784e8-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="784e8-104">In diesem Beispiel wird die [Cancel](cancel-method-ado.md)-Methode verwendet, um einen für ein [Connection](connection-object-ado.md)-Objekt ausgeführten Befehl abzubrechen, wenn die Verbindung ausgelastet ist.</span><span class="sxs-lookup"><span data-stu-id="784e8-104">This example uses the [Cancel](cancel-method-ado.md) method to cancel a command executing on a [Connection](connection-object-ado.md) object if the connection is busy.</span></span>
