...
ms.locfileid: "32312159"
---
# <a name="views-refresh-method-example-vb"></a><span data-ttu-id="189f6-102">Refresh-Methode (Views) (VB-Beispiel)</span><span class="sxs-lookup"><span data-stu-id="189f6-102">Views Refresh method example (VB)</span></span>


<span data-ttu-id="189f6-103">**Gilt für**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="189f6-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="189f6-p101">Im folgenden Code wird die Aktualisierung der [Views](views-collection-adox.md)-Auflistung eines [Catalog](catalog-object-adox.md)-Objekts gezeigt. Dies ist erforderlich, um auf [View](view-object-adox.md)-Objekte im **Catalog** -Objekt zugreifen zu können.</span><span class="sxs-lookup"><span data-stu-id="189f6-p101">The following code shows how to refresh the [Views](views-collection-adox.md) collection of a [Catalog](catalog-object-adox.md). This is required before [View](view-object-adox.md) objects from the **Catalog** can be accessed.</span></span>
