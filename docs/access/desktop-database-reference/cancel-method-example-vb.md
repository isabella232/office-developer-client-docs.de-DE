...
ms.locfileid: "25860119"
---
# <a name="cancel-method-example-vb"></a><span data-ttu-id="6937d-102">Cancel-Methode (Beispiel) (VB)</span><span class="sxs-lookup"><span data-stu-id="6937d-102">Cancel method example (VB)</span></span>


<span data-ttu-id="6937d-103">**Betrifft**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="6937d-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="6937d-104">In diesem Beispiel wird die [Cancel](cancel-method-ado.md)-Methode verwendet, um einen für ein [Connection](connection-object-ado.md)-Objekt ausgeführten Befehl abzubrechen, wenn die Verbindung ausgelastet ist.</span><span class="sxs-lookup"><span data-stu-id="6937d-104">This example uses the [Cancel](cancel-method-ado.md) method to cancel a command executing on a [Connection](connection-object-ado.md) object if the connection is busy.</span></span>
