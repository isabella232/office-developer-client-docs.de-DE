---
title: IsolationLevel- und Mode-Eigenschaft (Beispiel) (VC++)
...
ms.locfileid: "28714822"
---
# <a name="isolationlevel-and-mode-properties-example-vc"></a><span data-ttu-id="0dfe6-102">IsolationLevel- und Mode-Eigenschaft (Beispiel) (VC++)</span><span class="sxs-lookup"><span data-stu-id="0dfe6-102">IsolationLevel and Mode properties example (VC++)</span></span>


<span data-ttu-id="0dfe6-103">**Betrifft**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="0dfe6-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="0dfe6-104">In diesem Beispiel wird die [Mode](mode-property-ado.md)-Eigenschaft verwendet, um eine exklusive Verbindung zu öffnen, und mit der [Level](isolationlevel-property-ado.md)-Eigenschaft wird eine Transaktion geöffnet, die isoliert von anderen Transaktionen ausgeführt wird.</span><span class="sxs-lookup"><span data-stu-id="0dfe6-104">This example uses the [Mode](mode-property-ado.md) property to open an exclusive connection, and the [IsolationLevel](isolationlevel-property-ado.md) property to open a transaction that is conducted in isolation of other transactions.</span></span>
...
<span data-ttu-id="0dfe6-105">**IsolationLevelX.h**</span><span class="sxs-lookup"><span data-stu-id="0dfe6-105">**IsolationLevelX.h**</span></span>
