...
Because the data type of a bookmark is provider specific, ADO exposes it as a Variant. SQL Server-Lesezeichen sind beispielsweise vom Typ\_DbType R8 (Double). ADO would expose this type as a Variant with a subtype of Double.
