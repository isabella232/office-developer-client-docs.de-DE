...
---
# <a name="parameters-collection-command-property-example-vc"></a><span data-ttu-id="c95ff-102">Parameters-Auflistung, Command-Eigenschaft (Beispiel) (VC + +)</span><span class="sxs-lookup"><span data-stu-id="c95ff-102">Parameters Collection, Command property example (VC++)</span></span>


<span data-ttu-id="c95ff-103">**Gilt für**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="c95ff-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="c95ff-104">Im folgenden Codebeispiel wird die Verwendung der [Command](command-property-adox.md)-Eigenschaft mit dem [Command](command-object-ado.md)-Objekt veranschaulicht, um Parameterinformationen für die Prozedur abzurufen.</span><span class="sxs-lookup"><span data-stu-id="c95ff-104">The following code demonstrates how to use the [Command](command-property-adox.md) property with the [Command](command-object-ado.md) object to retrieve parameter information for the procedure.</span></span>
