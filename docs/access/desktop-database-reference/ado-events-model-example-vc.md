...
<span data-ttu-id="a7e8f-110">Ein Teil des Codes spiegelt einfach den Codierungsstil wider.</span><span class="sxs-lookup"><span data-stu-id="a7e8f-110">Some of the code simply reflects coding style.</span></span>
