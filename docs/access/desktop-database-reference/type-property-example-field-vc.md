...
In diesem Beispiel wird die [Type](type-property-ado.md) -Eigenschaft veranschaulicht, indem der Name der Konstante angezeigt wird, die dem Wert der **Type -Eigenschaft** aller [Field -Objekte](field-object-ado.md) in **_der_** Employees -Tabelle entspricht. The FieldType function is required for this procedure to run.
