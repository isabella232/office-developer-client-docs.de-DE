...
In diesem Beispiel wird die [Type](type-property-ado.md) -Eigenschaft veranschaulicht, indem der Name der Konstante angezeigt wird, die dem Wert der **Type** -Eigenschaft aller [Field](field-object-ado.md) -Objekte in der ***Employees*** -Tabelle entspricht. The FieldType function is required for this procedure to run.
