...
ms.locfileid: "25889805"
---
# <a name="addnew-method-example-vc"></a><span data-ttu-id="4ef69-102">AddNew-Methode (Beispiel) (VC++)</span><span class="sxs-lookup"><span data-stu-id="4ef69-102">AddNew method example (VC++)</span></span>


<span data-ttu-id="4ef69-103">**Betrifft**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="4ef69-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="4ef69-104">In diesem Beispiel wird die [AddNew](addnew-method-ado.md)-Methode zum Erstellen eines neuen Datensatzes mit dem angegebenen Namen verwendet.</span><span class="sxs-lookup"><span data-stu-id="4ef69-104">This example uses the [AddNew](addnew-method-ado.md) method to create a new record with the specified name.</span></span>
...
<span data-ttu-id="4ef69-105">**AddNewX.h**</span><span class="sxs-lookup"><span data-stu-id="4ef69-105">**AddNewX.h**</span></span>
