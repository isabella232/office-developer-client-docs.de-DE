...
ms.locfileid: "25881531"
---
# <a name="procedures-delete-method-example-vb"></a><span data-ttu-id="b7ab3-102">Delete-Methode (Procedures) (VB-Beispiel)</span><span class="sxs-lookup"><span data-stu-id="b7ab3-102">Procedures Delete method example (VB)</span></span>


<span data-ttu-id="b7ab3-103">**Betrifft**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="b7ab3-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="b7ab3-104">Im folgenden Code wird das Löschen einer Prozedur mithilfe der [Delete](procedures-collection-adox.md)-Methode der [Procedures](delete-method-adox-collections.md)-Auflistung veranschaulicht.</span><span class="sxs-lookup"><span data-stu-id="b7ab3-104">The following code demonstrates how to delete a procedure using the [Procedures](procedures-collection-adox.md) collection [Delete](delete-method-adox-collections.md) method.</span></span>
