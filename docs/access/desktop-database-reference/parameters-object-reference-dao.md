...
ms.locfileid: "28700038"
---
# <a name="parameters-object-reference-dao"></a>Parameter-Objektverweis (DAO)

**Betrifft**: Access 2013, Office 2013

- [Parameters-Auflistung (DAO)](parameters-collection-dao.md)
- [Parameter-Member (DAO)](parameters-members-dao.md)
- [Parametereigenschaften (DAO)](parameters-properties-dao.md)
- [Parameter-Methoden (DAO)](parameters-methods-dao.md)
