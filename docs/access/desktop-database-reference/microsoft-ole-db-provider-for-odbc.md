...
<tr class="even">
<td><p><span data-ttu-id="0f5e7-123"><strong>DSN</strong></span><span class="sxs-lookup"><span data-stu-id="0f5e7-123"><strong>DSN</strong></span></span></p></td>
...
<span data-ttu-id="0f5e7-168">(KAGPROP_FILEUSAGE)</span><span class="sxs-lookup"><span data-stu-id="0f5e7-168">(KAGPROP_FILEUSAGE)</span></span></p></td>
...
<td><p><span data-ttu-id="0f5e7-187">Gibt die maximale Anzahl von Spalten an, die in einer Tabelle zulässig sind.</span><span class="sxs-lookup"><span data-stu-id="0f5e7-187">Indicates the maximum number of columns allowed in a table.</span></span></p></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-242">ODBC-Cursor-Typ</span><span class="sxs-lookup"><span data-stu-id="0f5e7-242">ODBC Cursor Type</span></span><br />
...
<th><p><span data-ttu-id="0f5e7-269">Dynamic</span><span class="sxs-lookup"><span data-stu-id="0f5e7-269">Dynamic</span></span></p></th>
...
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-292"><a href="bookmark-property-ado.md">Bookmark</a></span><span class="sxs-lookup"><span data-stu-id="0f5e7-292"><a href="bookmark-property-ado.md">Bookmark</a></span></span></p></td>
...
<td><p><span data-ttu-id="0f5e7-366">nur Lesen</span><span class="sxs-lookup"><span data-stu-id="0f5e7-366">read-only</span></span></p></td>
</tr>
</tbody>
</table>
...
<td><p><span data-ttu-id="0f5e7-383">Ja</span><span class="sxs-lookup"><span data-stu-id="0f5e7-383">Yes</span></span></p></td>
</tr>
<tr class="odd">
...
<td><p><span data-ttu-id="0f5e7-407">Ja</span><span class="sxs-lookup"><span data-stu-id="0f5e7-407">Yes</span></span></p></td>
...
<td><p><span data-ttu-id="0f5e7-432">Ja</span><span class="sxs-lookup"><span data-stu-id="0f5e7-432">Yes</span></span></p></td>
...
<td><p><span data-ttu-id="0f5e7-456">Nein</span><span class="sxs-lookup"><span data-stu-id="0f5e7-456">No</span></span></p></td>
...
<span data-ttu-id="0f5e7-476">Der Microsoft OLE DB-Anbieter für ODBC fügt verschiedene Eigenschaften in die **Properties** -Auflistung der nicht geöffneten Objekte [Connection](connection-object-ado.md), [Recordset](recordset-object-ado.md) und [Command](command-object-ado.md) ein.</span><span class="sxs-lookup"><span data-stu-id="0f5e7-476">The Microsoft OLE DB Provider for ODBC inserts several dynamic properties into the **Properties** collection of the unopened [Connection](connection-object-ado.md), [Recordset](recordset-object-ado.md), and [Command](command-object-ado.md) objects.</span></span>

<span data-ttu-id="0f5e7-p118">Bei den folgenden Tabellen handelt es sich um ein Cross-Index-System der ADO- und OLE DB-Namen für alle dynamischen Eigenschaften. In OLE DB Programmer's Reference wird ein ADO-Eigenschaftenname als "Description" bezeichnet. Weitere Informationen zu diesen Eigenschaften finden Sie in OLE DB Programmer's Reference. Suchen Sie im Index nach dem OLE DB-Eigenschaftennamen, oder lesen Sie Appendix C: OLE DB Properties.</span><span class="sxs-lookup"><span data-stu-id="0f5e7-p118">The tables below are a cross-index of the ADO and OLE DB names for each dynamic property. The OLE DB Programmer's Reference refers to an ADO property name by the term, "Description." You can find more information about these properties in the OLE DB Programmer's Reference. Search for the OLE DB property name in the Index or see Appendix C: OLE DB Properties.</span></span>

## <a name="connection-dynamic-properties"></a><span data-ttu-id="0f5e7-481">Dynamische Eigenschaften von "Connection"</span><span class="sxs-lookup"><span data-stu-id="0f5e7-481">Connection Dynamic Properties</span></span>

<span data-ttu-id="0f5e7-482">Die folgenden Eigenschaften werden der **Properties** -Auflistung des **Connection** -Objekts hinzugefügt.</span><span class="sxs-lookup"><span data-stu-id="0f5e7-482">The following properties are added to the **Connection** object's **Properties** collection.</span></span>
...
<thead>
<tr class="header">
<th><p><span data-ttu-id="0f5e7-483">ADO-Eigenschaftenname</span><span class="sxs-lookup"><span data-stu-id="0f5e7-483">ADO Property Name</span></span></p></th>
<th><p><span data-ttu-id="0f5e7-484">OLE DB-Eigenschaftenname</span><span class="sxs-lookup"><span data-stu-id="0f5e7-484">OLE DB Property Name</span></span></p></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-485">Active Sessions</span><span class="sxs-lookup"><span data-stu-id="0f5e7-485">Active Sessions</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-486">DBPROP_ACTIVESESSIONS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-486">DBPROP_ACTIVESESSIONS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-487">Asynchable Abort</span><span class="sxs-lookup"><span data-stu-id="0f5e7-487">Asynchable Abort</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-488">DBPROP_ASYNCTXNABORT</span><span class="sxs-lookup"><span data-stu-id="0f5e7-488">DBPROP_ASYNCTXNABORT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-489">Asynchable Commit</span><span class="sxs-lookup"><span data-stu-id="0f5e7-489">Asynchable Commit</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-490">DBPROP_ASYNCTNXCOMMIT</span><span class="sxs-lookup"><span data-stu-id="0f5e7-490">DBPROP_ASYNCTNXCOMMIT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-491">Autocommit Isolation Levels</span><span class="sxs-lookup"><span data-stu-id="0f5e7-491">Autocommit Isolation Levels</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-492">DBPROP_SESS_AUTOCOMMITISOLEVELS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-492">DBPROP_SESS_AUTOCOMMITISOLEVELS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-493">Catalog Location</span><span class="sxs-lookup"><span data-stu-id="0f5e7-493">Catalog Location</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-494">DBPROP_CATALOGLOCATION</span><span class="sxs-lookup"><span data-stu-id="0f5e7-494">DBPROP_CATALOGLOCATION</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-495">Catalog Term</span><span class="sxs-lookup"><span data-stu-id="0f5e7-495">Catalog Term</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-496">DBPROP_CATALOGTERM</span><span class="sxs-lookup"><span data-stu-id="0f5e7-496">DBPROP_CATALOGTERM</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-497">Column Definition</span><span class="sxs-lookup"><span data-stu-id="0f5e7-497">Column Definition</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-498">DBPROP_COLUMNDEFINITION</span><span class="sxs-lookup"><span data-stu-id="0f5e7-498">DBPROP_COLUMNDEFINITION</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-499">Connect Timeout</span><span class="sxs-lookup"><span data-stu-id="0f5e7-499">Connect Timeout</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-500">DBPROP_INIT_TIMEOUT</span><span class="sxs-lookup"><span data-stu-id="0f5e7-500">DBPROP_INIT_TIMEOUT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-501">Current Catalog</span><span class="sxs-lookup"><span data-stu-id="0f5e7-501">Current Catalog</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-502">DBPROP_CURRENTCATALOG</span><span class="sxs-lookup"><span data-stu-id="0f5e7-502">DBPROP_CURRENTCATALOG</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-503">Data Source</span><span class="sxs-lookup"><span data-stu-id="0f5e7-503">Data Source</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-504">DBPROP_INIT_DATASOURCE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-504">DBPROP_INIT_DATASOURCE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-505">Data Source Name</span><span class="sxs-lookup"><span data-stu-id="0f5e7-505">Data Source Name</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-506">DBPROP_DATASOURCENAME</span><span class="sxs-lookup"><span data-stu-id="0f5e7-506">DBPROP_DATASOURCENAME</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-507">Data Source Object Threading Model</span><span class="sxs-lookup"><span data-stu-id="0f5e7-507">Data Source Object Threading Model</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-508">DBPROP_DSOTHREADMODEL</span><span class="sxs-lookup"><span data-stu-id="0f5e7-508">DBPROP_DSOTHREADMODEL</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-509">DBMS Name</span><span class="sxs-lookup"><span data-stu-id="0f5e7-509">DBMS Name</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-510">DBPROP_DBMSNAME</span><span class="sxs-lookup"><span data-stu-id="0f5e7-510">DBPROP_DBMSNAME</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-511">DBMS Version</span><span class="sxs-lookup"><span data-stu-id="0f5e7-511">DBMS Version</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-512">DBPROP_DBMSVER</span><span class="sxs-lookup"><span data-stu-id="0f5e7-512">DBPROP_DBMSVER</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-513">Extended Properties</span><span class="sxs-lookup"><span data-stu-id="0f5e7-513">Extended Properties</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-514">DBPROP_INIT_PROVIDERSTRING</span><span class="sxs-lookup"><span data-stu-id="0f5e7-514">DBPROP_INIT_PROVIDERSTRING</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-515">GROUP BY Support</span><span class="sxs-lookup"><span data-stu-id="0f5e7-515">GROUP BY Support</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-516">DBPROP_GROUPBY</span><span class="sxs-lookup"><span data-stu-id="0f5e7-516">DBPROP_GROUPBY</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-517">Heterogeneous Table Support</span><span class="sxs-lookup"><span data-stu-id="0f5e7-517">Heterogeneous Table Support</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-518">DBPROP_HETEROGENEOUSTABLES</span><span class="sxs-lookup"><span data-stu-id="0f5e7-518">DBPROP_HETEROGENEOUSTABLES</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-519">Identifier Case Sensitivity</span><span class="sxs-lookup"><span data-stu-id="0f5e7-519">Identifier Case Sensitivity</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-520">DBPROP_IDENTIFIERCASE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-520">DBPROP_IDENTIFIERCASE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-521">Initial Catalog</span><span class="sxs-lookup"><span data-stu-id="0f5e7-521">Initial Catalog</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-522">NULL</span><span class="sxs-lookup"><span data-stu-id="0f5e7-522">DBPROP_INIT_CATALOG</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-523">Isolation Levels</span><span class="sxs-lookup"><span data-stu-id="0f5e7-523">Isolation Levels</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-524">DBPROP_SUPPORTEDTXNISOLEVELS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-524">DBPROP_SUPPORTEDTXNISOLEVELS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-525">Isolation Retention</span><span class="sxs-lookup"><span data-stu-id="0f5e7-525">Isolation Retention</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-526">DBPROP_SUPPORTEDTXNISORETAIN</span><span class="sxs-lookup"><span data-stu-id="0f5e7-526">DBPROP_SUPPORTEDTXNISORETAIN</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-527">Locale Identifier</span><span class="sxs-lookup"><span data-stu-id="0f5e7-527">Locale Identifier</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-528">DBPROP_INIT_LCID</span><span class="sxs-lookup"><span data-stu-id="0f5e7-528">DBPROP_INIT_LCID</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-529">Location</span><span class="sxs-lookup"><span data-stu-id="0f5e7-529">Location</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-530">STANDARD</span><span class="sxs-lookup"><span data-stu-id="0f5e7-530">DBPROP_INIT_LOCATION</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-531">Maximum Index Size</span><span class="sxs-lookup"><span data-stu-id="0f5e7-531">Maximum Index Size</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-532">DBPROP_MAXINDEXSIZE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-532">DBPROP_MAXINDEXSIZE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-533">Maximum Row Size</span><span class="sxs-lookup"><span data-stu-id="0f5e7-533">Maximum Row Size</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-534">DBPROP_MAXROWSIZE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-534">DBPROP_MAXROWSIZE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-535">Maximum Row Size Includes BLOB</span><span class="sxs-lookup"><span data-stu-id="0f5e7-535">Maximum Row Size Includes BLOB</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-536">DBPROP_MAXROWSIZEINCLUDESBLOB</span><span class="sxs-lookup"><span data-stu-id="0f5e7-536">DBPROP_MAXROWSIZEINCLUDESBLOB</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-537">Maximum Tables in SELECT</span><span class="sxs-lookup"><span data-stu-id="0f5e7-537">Maximum Tables in SELECT</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-538">DBPROP_MAXTABLESINSELECT</span><span class="sxs-lookup"><span data-stu-id="0f5e7-538">DBPROP_MAXTABLESINSELECT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-539">Mode</span><span class="sxs-lookup"><span data-stu-id="0f5e7-539">Mode</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-540">DBPROP_INIT_MODE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-540">DBPROP_INIT_MODE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-541">Multiple Parameter Sets</span><span class="sxs-lookup"><span data-stu-id="0f5e7-541">Multiple Parameter Sets</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-542">DBPROP_MULTIPLEPARAMSETS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-542">DBPROP_MULTIPLEPARAMSETS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-543">Multiple Results</span><span class="sxs-lookup"><span data-stu-id="0f5e7-543">Multiple Results</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-544">DBPROP_MULTIPLERESULTS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-544">DBPROP_MULTIPLERESULTS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-545">Multiple Storage Objects</span><span class="sxs-lookup"><span data-stu-id="0f5e7-545">Multiple Storage Objects</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-546">DBPROP_MULTIPLESTORAGEOBJECTS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-546">DBPROP_MULTIPLESTORAGEOBJECTS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-547">Multi-Table Update</span><span class="sxs-lookup"><span data-stu-id="0f5e7-547">Multi-Table Update</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-548">DBPROP_MULTITABLEUPDATE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-548">DBPROP_MULTITABLEUPDATE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-549">NULL Collation Order</span><span class="sxs-lookup"><span data-stu-id="0f5e7-549">NULL Collation Order</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-550">DBPROP_NULLCOLLATION</span><span class="sxs-lookup"><span data-stu-id="0f5e7-550">DBPROP_NULLCOLLATION</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-551">NULL Concatenation Behavior</span><span class="sxs-lookup"><span data-stu-id="0f5e7-551">NULL Concatenation Behavior</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-552">DBPROP_CONCATNULLBEHAVIOR</span><span class="sxs-lookup"><span data-stu-id="0f5e7-552">DBPROP_CONCATNULLBEHAVIOR</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-553">OLE DB Services</span><span class="sxs-lookup"><span data-stu-id="0f5e7-553">OLE DB Services</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-554">DBPROP_INIT_OLEDBSERVICES</span><span class="sxs-lookup"><span data-stu-id="0f5e7-554">DBPROP_INIT_OLEDBSERVICES</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-555">OLE DB Version</span><span class="sxs-lookup"><span data-stu-id="0f5e7-555">OLE DB Version</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-556">DBPROP_PROVIDEROLEDBVER</span><span class="sxs-lookup"><span data-stu-id="0f5e7-556">DBPROP_PROVIDEROLEDBVER</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-557">OLE Object Support</span><span class="sxs-lookup"><span data-stu-id="0f5e7-557">OLE Object Support</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-558">DBPROP_OLEOBJECTS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-558">DBPROP_OLEOBJECTS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-559">Open Rowset Support</span><span class="sxs-lookup"><span data-stu-id="0f5e7-559">Open Rowset Support</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-560">DBPROP_OPENROWSETSUPPORT</span><span class="sxs-lookup"><span data-stu-id="0f5e7-560">DBPROP_OPENROWSETSUPPORT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-561">ORDER BY Columns in Select List</span><span class="sxs-lookup"><span data-stu-id="0f5e7-561">ORDER BY Columns in Select List</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-562">DBPROP_ORDERBYCOLUMNSINSELECT</span><span class="sxs-lookup"><span data-stu-id="0f5e7-562">DBPROP_ORDERBYCOLUMNSINSELECT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-563">Output Parameter Availability</span><span class="sxs-lookup"><span data-stu-id="0f5e7-563">Output Parameter Availability</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-564">DBPROP_OUTPUTPARAMETERAVAILABILITY</span><span class="sxs-lookup"><span data-stu-id="0f5e7-564">DBPROP_OUTPUTPARAMETERAVAILABILITY</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-565">Password</span><span class="sxs-lookup"><span data-stu-id="0f5e7-565">Password</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-566">DBPROP_AUTH_PASSWORD</span><span class="sxs-lookup"><span data-stu-id="0f5e7-566">DBPROP_AUTH_PASSWORD</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-567">Pass By Ref Accessors</span><span class="sxs-lookup"><span data-stu-id="0f5e7-567">Pass By Ref Accessors</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-568">DBPROP_BYREFACCESSORS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-568">DBPROP_BYREFACCESSORS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-569">Persist Security Info</span><span class="sxs-lookup"><span data-stu-id="0f5e7-569">Persist Security Info</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-570">DBPROP_AUTH_PERSIST_SENSITIVE_AUTHINFO</span><span class="sxs-lookup"><span data-stu-id="0f5e7-570">DBPROP_AUTH_PERSIST_SENSITIVE_AUTHINFO</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-571">Persistent ID Type</span><span class="sxs-lookup"><span data-stu-id="0f5e7-571">Persistent ID Type</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-572">DBPROP_PERSISTENTIDTYPE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-572">DBPROP_PERSISTENTIDTYPE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-573">Prepare Abort Behavior</span><span class="sxs-lookup"><span data-stu-id="0f5e7-573">Prepare Abort Behavior</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-574">DBPROP_PREPAREABORTBEHAVIOR</span><span class="sxs-lookup"><span data-stu-id="0f5e7-574">DBPROP_PREPAREABORTBEHAVIOR</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-575">Prepare Commit Behavior</span><span class="sxs-lookup"><span data-stu-id="0f5e7-575">Prepare Commit Behavior</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-576">DBPROP_PREPARECOMMITBEHAVIOR</span><span class="sxs-lookup"><span data-stu-id="0f5e7-576">DBPROP_PREPARECOMMITBEHAVIOR</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-577">Procedure Term</span><span class="sxs-lookup"><span data-stu-id="0f5e7-577">Procedure Term</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-578">DBPROP_PROCEDURETERM</span><span class="sxs-lookup"><span data-stu-id="0f5e7-578">DBPROP_PROCEDURETERM</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-579">Prompt</span><span class="sxs-lookup"><span data-stu-id="0f5e7-579">Prompt</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-580">DBPROP_INIT_PROMPT</span><span class="sxs-lookup"><span data-stu-id="0f5e7-580">DBPROP_INIT_PROMPT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-581">Provider Friendly Name</span><span class="sxs-lookup"><span data-stu-id="0f5e7-581">Provider Friendly Name</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-582">DBPROP_PROVIDERFRIENDLYNAME</span><span class="sxs-lookup"><span data-stu-id="0f5e7-582">DBPROP_PROVIDERFRIENDLYNAME</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-583">Provider Name</span><span class="sxs-lookup"><span data-stu-id="0f5e7-583">Provider Name</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-584">DBPROP_PROVIDERFILENAME</span><span class="sxs-lookup"><span data-stu-id="0f5e7-584">DBPROP_PROVIDERFILENAME</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-585">Provider Version</span><span class="sxs-lookup"><span data-stu-id="0f5e7-585">Provider Version</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-586">DBPROP_PROVIDERVER</span><span class="sxs-lookup"><span data-stu-id="0f5e7-586">DBPROP_PROVIDERVER</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-587">Read-Only Data Source</span><span class="sxs-lookup"><span data-stu-id="0f5e7-587">Read-Only Data Source</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-588">DBPROP_DATASOURCEREADONLY</span><span class="sxs-lookup"><span data-stu-id="0f5e7-588">DBPROP_DATASOURCEREADONLY</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-589">Rowset Conversions on Command</span><span class="sxs-lookup"><span data-stu-id="0f5e7-589">Rowset Conversions on Command</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-590">DBPROP_ROWSETCONVERSIONSONCOMMAND</span><span class="sxs-lookup"><span data-stu-id="0f5e7-590">DBPROP_ROWSETCONVERSIONSONCOMMAND</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-591">Schema Term</span><span class="sxs-lookup"><span data-stu-id="0f5e7-591">Schema Term</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-592">DBPROP_SCHEMATERM</span><span class="sxs-lookup"><span data-stu-id="0f5e7-592">DBPROP_SCHEMATERM</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-593">Schema Usage</span><span class="sxs-lookup"><span data-stu-id="0f5e7-593">Schema Usage</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-594">DBPROP_SCHEMAUSAGE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-594">DBPROP_SCHEMAUSAGE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-595">SQL Support</span><span class="sxs-lookup"><span data-stu-id="0f5e7-595">SQL Support</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-596">DBPROP_SQLSUPPORT</span><span class="sxs-lookup"><span data-stu-id="0f5e7-596">DBPROP_SQLSUPPORT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-597">Structured Storage</span><span class="sxs-lookup"><span data-stu-id="0f5e7-597">Structured Storage</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-598">DBPROP_STRUCTUREDSTORAGE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-598">DBPROP_STRUCTUREDSTORAGE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-599">Subquery Support</span><span class="sxs-lookup"><span data-stu-id="0f5e7-599">Subquery Support</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-600">DBPROP_SUBQUERIES</span><span class="sxs-lookup"><span data-stu-id="0f5e7-600">DBPROP_SUBQUERIES</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-601">Table Term</span><span class="sxs-lookup"><span data-stu-id="0f5e7-601">Table Term</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-602">DBPROP_TABLETERM</span><span class="sxs-lookup"><span data-stu-id="0f5e7-602">DBPROP_TABLETERM</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-603">Transaction DDL</span><span class="sxs-lookup"><span data-stu-id="0f5e7-603">Transaction DDL</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-604">DBPROP_SUPPORTEDTXNDDL</span><span class="sxs-lookup"><span data-stu-id="0f5e7-604">DBPROP_SUPPORTEDTXNDDL</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-605">User ID</span><span class="sxs-lookup"><span data-stu-id="0f5e7-605">User ID</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-606">DBPROP_AUTH_USERID</span><span class="sxs-lookup"><span data-stu-id="0f5e7-606">DBPROP_AUTH_USERID</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-607">User Name</span><span class="sxs-lookup"><span data-stu-id="0f5e7-607">User Name</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-608">DBPROP_USERNAME</span><span class="sxs-lookup"><span data-stu-id="0f5e7-608">DBPROP_USERNAME</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-609">Window Handle</span><span class="sxs-lookup"><span data-stu-id="0f5e7-609">Window Handle</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-610">DBPROP_INIT_HWND</span><span class="sxs-lookup"><span data-stu-id="0f5e7-610">DBPROP_INIT_HWND</span></span></p></td>
</tr>
</tbody>
</table>


## <a name="recordset-dynamic-properties"></a><span data-ttu-id="0f5e7-611">Dynamische Eigenschaften von "Recordset"</span><span class="sxs-lookup"><span data-stu-id="0f5e7-611">Recordset Dynamic Properties</span></span>

<span data-ttu-id="0f5e7-612">Die folgenden Eigenschaften werden der **Properties** -Auflistung des **Recordset** -Objekts hinzugefügt.</span><span class="sxs-lookup"><span data-stu-id="0f5e7-612">The following properties are added to the **Recordset** object's **Properties** collection.</span></span>
...
<thead>
<tr class="header">
<th><p><span data-ttu-id="0f5e7-613">ADO-Eigenschaftenname</span><span class="sxs-lookup"><span data-stu-id="0f5e7-613">ADO Property Name</span></span></p></th>
<th><p><span data-ttu-id="0f5e7-614">OLE DB-Eigenschaftenname</span><span class="sxs-lookup"><span data-stu-id="0f5e7-614">OLE DB Property Name</span></span></p></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-615">Access Order</span><span class="sxs-lookup"><span data-stu-id="0f5e7-615">Access Order</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-616">DBPROP_ACCESSORDER</span><span class="sxs-lookup"><span data-stu-id="0f5e7-616">DBPROP_ACCESSORDER</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-617">Blocking Storage Objects</span><span class="sxs-lookup"><span data-stu-id="0f5e7-617">Blocking Storage Objects</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-618">DBPROP_BLOCKINGSTORAGEOBJECTS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-618">DBPROP_BLOCKINGSTORAGEOBJECTS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-619">Bookmark Type</span><span class="sxs-lookup"><span data-stu-id="0f5e7-619">Bookmark Type</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-620">DBPROP_BOOKMARKTYPE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-620">DBPROP_BOOKMARKTYPE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-621">Bookmarkable</span><span class="sxs-lookup"><span data-stu-id="0f5e7-621">Bookmarkable</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-622">DBPROP_IROWSETLOCATE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-622">DBPROP_IROWSETLOCATE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-623">Change Inserted Rows</span><span class="sxs-lookup"><span data-stu-id="0f5e7-623">Change Inserted Rows</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-624">DBPROP_CHANGEINSERTEDROWS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-624">DBPROP_CHANGEINSERTEDROWS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-625">Column Privileges</span><span class="sxs-lookup"><span data-stu-id="0f5e7-625">Column Privileges</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-626">DBPROP_COLUMNRESTRICT</span><span class="sxs-lookup"><span data-stu-id="0f5e7-626">DBPROP_COLUMNRESTRICT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-627">Column Set Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-627">Column Set Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-628">DBPROP_NOTIFYCOLUMNSET</span><span class="sxs-lookup"><span data-stu-id="0f5e7-628">DBPROP_NOTIFYCOLUMNSET</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-629">Delay Storage Object Updates</span><span class="sxs-lookup"><span data-stu-id="0f5e7-629">Delay Storage Object Updates</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-630">DBPROP_DELAYSTORAGEOBJECTS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-630">DBPROP_DELAYSTORAGEOBJECTS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-631">Fetch Backwards</span><span class="sxs-lookup"><span data-stu-id="0f5e7-631">Fetch Backwards</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-632">DBPROP_CANFETCHBACKWARDS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-632">DBPROP_CANFETCHBACKWARDS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-633">Hold Rows</span><span class="sxs-lookup"><span data-stu-id="0f5e7-633">Hold Rows</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-634">DBPROP_CANHOLDROWS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-634">DBPROP_CANHOLDROWS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-635">IAccessor</span><span class="sxs-lookup"><span data-stu-id="0f5e7-635">IAccessor</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-636">DBPROP_IAccessor</span><span class="sxs-lookup"><span data-stu-id="0f5e7-636">DBPROP_IAccessor</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-637">IColumnsInfo</span><span class="sxs-lookup"><span data-stu-id="0f5e7-637">IColumnsInfo</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-638">DBPROP_IColumnsInfo</span><span class="sxs-lookup"><span data-stu-id="0f5e7-638">DBPROP_IColumnsInfo</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-639">IColumnsRowset</span><span class="sxs-lookup"><span data-stu-id="0f5e7-639">IColumnsRowset</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-640">DBPROP_IColumnsRowset</span><span class="sxs-lookup"><span data-stu-id="0f5e7-640">DBPROP_IColumnsRowset</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-641">IConnectionPointContainer</span><span class="sxs-lookup"><span data-stu-id="0f5e7-641">IConnectionPointContainer</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-642">DBPROP_IConnectionPointContainer</span><span class="sxs-lookup"><span data-stu-id="0f5e7-642">DBPROP_IConnectionPointContainer</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-643">IConvertType</span><span class="sxs-lookup"><span data-stu-id="0f5e7-643">IConvertType</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-644">DBPROP_IConvertType</span><span class="sxs-lookup"><span data-stu-id="0f5e7-644">DBPROP_IConvertType</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-645">Immobile Rows</span><span class="sxs-lookup"><span data-stu-id="0f5e7-645">Immobile Rows</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-646">DBPROP_IMMOBILEROWS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-646">DBPROP_IMMOBILEROWS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-647">IRowset</span><span class="sxs-lookup"><span data-stu-id="0f5e7-647">IRowset</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-648">DBPROP_IRowset</span><span class="sxs-lookup"><span data-stu-id="0f5e7-648">DBPROP_IRowset</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-649">IRowsetChange</span><span class="sxs-lookup"><span data-stu-id="0f5e7-649">IRowsetChange</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-650">DBPROP_IRowsetChange</span><span class="sxs-lookup"><span data-stu-id="0f5e7-650">DBPROP_IRowsetChange</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-651">IRowsetIdentity</span><span class="sxs-lookup"><span data-stu-id="0f5e7-651">IRowsetIdentity</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-652">DBPROP_IRowsetIdentity</span><span class="sxs-lookup"><span data-stu-id="0f5e7-652">DBPROP_IRowsetIdentity</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-653">IRowsetInfo</span><span class="sxs-lookup"><span data-stu-id="0f5e7-653">IRowsetInfo</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-654">DBPROP_IRowsetInfo</span><span class="sxs-lookup"><span data-stu-id="0f5e7-654">DBPROP_IRowsetInfo</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-655">IRowsetLocate</span><span class="sxs-lookup"><span data-stu-id="0f5e7-655">IRowsetLocate</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-656">DBPROP_IRowsetLocate</span><span class="sxs-lookup"><span data-stu-id="0f5e7-656">DBPROP_IRowsetLocate</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-657">IRowsetResynch</span><span class="sxs-lookup"><span data-stu-id="0f5e7-657">IRowsetResynch</span></span></p></td>
<td><p></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-658">IRowsetUpdate</span><span class="sxs-lookup"><span data-stu-id="0f5e7-658">IRowsetUpdate</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-659">DBPROP_IRowsetUpdate</span><span class="sxs-lookup"><span data-stu-id="0f5e7-659">DBPROP_IRowsetUpdate</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-660">ISequentialStream</span><span class="sxs-lookup"><span data-stu-id="0f5e7-660">ISequentialStream</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-661">DBPROP_ISequentialStream</span><span class="sxs-lookup"><span data-stu-id="0f5e7-661">DBPROP_ISequentialStream</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-662">ISupportErrorInfo</span><span class="sxs-lookup"><span data-stu-id="0f5e7-662">ISupportErrorInfo</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-663">DBPROP_ISupportErrorInfo</span><span class="sxs-lookup"><span data-stu-id="0f5e7-663">DBPROP_ISupportErrorInfo</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-664">Literal Bookmarks</span><span class="sxs-lookup"><span data-stu-id="0f5e7-664">Literal Bookmarks</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-665">DBPROP_LITERALBOOKMARKS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-665">DBPROP_LITERALBOOKMARKS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-666">Literal Row Identity</span><span class="sxs-lookup"><span data-stu-id="0f5e7-666">Literal Row Identity</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-667">DBPROP_LITERALIDENTITY</span><span class="sxs-lookup"><span data-stu-id="0f5e7-667">DBPROP_LITERALIDENTITY</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-668">Maximum Open Rows</span><span class="sxs-lookup"><span data-stu-id="0f5e7-668">Maximum Open Rows</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-669">DBPROP_MAXOPENROWS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-669">DBPROP_MAXOPENROWS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-670">Maximum Pending Rows</span><span class="sxs-lookup"><span data-stu-id="0f5e7-670">Maximum Pending Rows</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-671">DBPROP_MAXPENDINGROWS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-671">DBPROP_MAXPENDINGROWS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-672">Maximum Rows</span><span class="sxs-lookup"><span data-stu-id="0f5e7-672">Maximum Rows</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-673">DBPROP_MAXROWS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-673">DBPROP_MAXROWS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-674">Notification Granularity</span><span class="sxs-lookup"><span data-stu-id="0f5e7-674">Notification Granularity</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-675">DBPROP_NOTIFICATIONGRANULARITY</span><span class="sxs-lookup"><span data-stu-id="0f5e7-675">DBPROP_NOTIFICATIONGRANULARITY</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-676">Notification Phases</span><span class="sxs-lookup"><span data-stu-id="0f5e7-676">Notification Phases</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-677">DBPROP_NOTIFICATIONPHASES</span><span class="sxs-lookup"><span data-stu-id="0f5e7-677">DBPROP_NOTIFICATIONPHASES</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-678">Objects Transacted</span><span class="sxs-lookup"><span data-stu-id="0f5e7-678">Objects Transacted</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-679">DBPROP_TRANSACTEDOBJECT</span><span class="sxs-lookup"><span data-stu-id="0f5e7-679">DBPROP_TRANSACTEDOBJECT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-680">Own Changes Visible</span><span class="sxs-lookup"><span data-stu-id="0f5e7-680">Own Changes Visible</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-681">DBPROP_OWNUPDATEDELETE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-681">DBPROP_OWNUPDATEDELETE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-682">Own Inserts Visible</span><span class="sxs-lookup"><span data-stu-id="0f5e7-682">Own Inserts Visible</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-683">DBPROP_OWNINSERT</span><span class="sxs-lookup"><span data-stu-id="0f5e7-683">DBPROP_OWNINSERT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-684">Preserve on Abort</span><span class="sxs-lookup"><span data-stu-id="0f5e7-684">Preserve on Abort</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-685">DBPROP_ABORTPRESERVE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-685">DBPROP_ABORTPRESERVE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-686">Preserve on Commit</span><span class="sxs-lookup"><span data-stu-id="0f5e7-686">Preserve on Commit</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-687">DBPROP_COMMITPRESERVE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-687">DBPROP_COMMITPRESERVE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-688">Quick Restart</span><span class="sxs-lookup"><span data-stu-id="0f5e7-688">Quick Restart</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-689">DBPROP_QUICKRESTART</span><span class="sxs-lookup"><span data-stu-id="0f5e7-689">DBPROP_QUICKRESTART</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-690">Reentrant Events</span><span class="sxs-lookup"><span data-stu-id="0f5e7-690">Reentrant Events</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-691">DBPROP_REENTRANTEVENTS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-691">DBPROP_REENTRANTEVENTS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-692">Remove Deleted Rows</span><span class="sxs-lookup"><span data-stu-id="0f5e7-692">Remove Deleted Rows</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-693">DBPROP_REMOVEDELETED</span><span class="sxs-lookup"><span data-stu-id="0f5e7-693">DBPROP_REMOVEDELETED</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-694">Report Multiple Changes</span><span class="sxs-lookup"><span data-stu-id="0f5e7-694">Report Multiple Changes</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-695">DBPROP_REPORTMULTIPLECHANGES</span><span class="sxs-lookup"><span data-stu-id="0f5e7-695">DBPROP_REPORTMULTIPLECHANGES</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-696">Return Pending Inserts</span><span class="sxs-lookup"><span data-stu-id="0f5e7-696">Return Pending Inserts</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-697">DBPROP_RETURNPENDINGINSERTS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-697">DBPROP_RETURNPENDINGINSERTS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-698">Row Delete Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-698">Row Delete Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-699">DBPROP_NOTIFYROWDELETE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-699">DBPROP_NOTIFYROWDELETE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-700">Row First Change Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-700">Row First Change Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-701">DBPROP_NOTIFYROWFIRSTCHANGE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-701">DBPROP_NOTIFYROWFIRSTCHANGE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-702">Row Insert Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-702">Row Insert Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-703">DBPROP_NOTIFYROWINSERT</span><span class="sxs-lookup"><span data-stu-id="0f5e7-703">DBPROP_NOTIFYROWINSERT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-704">Row Privileges</span><span class="sxs-lookup"><span data-stu-id="0f5e7-704">Row Privileges</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-705">DBPROP_ROWRESTRICT</span><span class="sxs-lookup"><span data-stu-id="0f5e7-705">DBPROP_ROWRESTRICT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-706">Row Resynchronization Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-706">Row Resynchronization Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-707">DBPROP_NOTIFYROWRESYNCH</span><span class="sxs-lookup"><span data-stu-id="0f5e7-707">DBPROP_NOTIFYROWRESYNCH</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-708">Row Threading Model</span><span class="sxs-lookup"><span data-stu-id="0f5e7-708">Row Threading Model</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-709">DBPROP_ROWTHREADMODEL</span><span class="sxs-lookup"><span data-stu-id="0f5e7-709">DBPROP_ROWTHREADMODEL</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-710">Row Undo Change Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-710">Row Undo Change Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-711">DBPROP_NOTIFYROWUNDOCHANGE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-711">DBPROP_NOTIFYROWUNDOCHANGE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-712">Row Undo Delete Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-712">Row Undo Delete Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-713">DBPROP_NOTIFYROWUNDODELETE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-713">DBPROP_NOTIFYROWUNDODELETE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-714">Row Undo Insert Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-714">Row Undo Insert Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-715">DBPROP_NOTIFYROWUNDOINSERT</span><span class="sxs-lookup"><span data-stu-id="0f5e7-715">DBPROP_NOTIFYROWUNDOINSERT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-716">Row Update Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-716">Row Update Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-717">DBPROP_NOTIFYROWUPDATE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-717">DBPROP_NOTIFYROWUPDATE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-718">Rowset Fetch Position Change Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-718">Rowset Fetch Position Change Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-719">DBPROP_NOTIFYROWSETFETCHPOSISIONCHANGE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-719">DBPROP_NOTIFYROWSETFETCHPOSISIONCHANGE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-720">Rowset Release Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-720">Rowset Release Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-721">DBPROP_NOTIFYROWSETRELEASE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-721">DBPROP_NOTIFYROWSETRELEASE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-722">Scroll Backwards</span><span class="sxs-lookup"><span data-stu-id="0f5e7-722">Scroll Backwards</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-723">DBPROP_CANSCROLLBACKWARDS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-723">DBPROP_CANSCROLLBACKWARDS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-724">Skip Deleted Bookmarks</span><span class="sxs-lookup"><span data-stu-id="0f5e7-724">Skip Deleted Bookmarks</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-725">DBPROP_BOOKMARKSKIPPED</span><span class="sxs-lookup"><span data-stu-id="0f5e7-725">DBPROP_BOOKMARKSKIPPED</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-726">Strong Row Identity</span><span class="sxs-lookup"><span data-stu-id="0f5e7-726">Strong Row Identity</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-727">DBPROP_STRONGITDENTITY</span><span class="sxs-lookup"><span data-stu-id="0f5e7-727">DBPROP_STRONGITDENTITY</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-728">Unique Rows</span><span class="sxs-lookup"><span data-stu-id="0f5e7-728">Unique Rows</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-729">DBPROP_UNIQUEROWS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-729">DBPROP_UNIQUEROWS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-730">Updatability</span><span class="sxs-lookup"><span data-stu-id="0f5e7-730">Updatability</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-731">DBPROP_UPDATABILITY</span><span class="sxs-lookup"><span data-stu-id="0f5e7-731">DBPROP_UPDATABILITY</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-732">Use Bookmarks</span><span class="sxs-lookup"><span data-stu-id="0f5e7-732">Use Bookmarks</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-733">DBPROP_BOOKMARKS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-733">DBPROP_BOOKMARKS</span></span></p></td>
</tr>
</tbody>
</table>


## <a name="command-dynamic-properties"></a><span data-ttu-id="0f5e7-734">Dynamische Eigenschaften von "Command"</span><span class="sxs-lookup"><span data-stu-id="0f5e7-734">Command Dynamic Properties</span></span>

<span data-ttu-id="0f5e7-735">Die folgenden Eigenschaften werden der **Properties** -Auflistung des **Command** -Objekts hinzugefügt.</span><span class="sxs-lookup"><span data-stu-id="0f5e7-735">The following properties are added to the **Command** object's **Properties** collection.</span></span>
...
<thead>
<tr class="header">
<th><p><span data-ttu-id="0f5e7-736">ADO-Eigenschaftenname</span><span class="sxs-lookup"><span data-stu-id="0f5e7-736">ADO Property Name</span></span></p></th>
<th><p><span data-ttu-id="0f5e7-737">OLE DB-Eigenschaftenname</span><span class="sxs-lookup"><span data-stu-id="0f5e7-737">OLE DB Property Name</span></span></p></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-738">Access Order</span><span class="sxs-lookup"><span data-stu-id="0f5e7-738">Access Order</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-739">DBPROP_ACCESSORDER</span><span class="sxs-lookup"><span data-stu-id="0f5e7-739">DBPROP_ACCESSORDER</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-740">Blocking Storage Objects</span><span class="sxs-lookup"><span data-stu-id="0f5e7-740">Blocking Storage Objects</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-741">DBPROP_BLOCKINGSTORAGEOBJECTS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-741">DBPROP_BLOCKINGSTORAGEOBJECTS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-742">Bookmark Type</span><span class="sxs-lookup"><span data-stu-id="0f5e7-742">Bookmark Type</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-743">DBPROP_BOOKMARKTYPE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-743">DBPROP_BOOKMARKTYPE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-744">Bookmarkable</span><span class="sxs-lookup"><span data-stu-id="0f5e7-744">Bookmarkable</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-745">DBPROP_IROWSETLOCATE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-745">DBPROP_IROWSETLOCATE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-746">Change Inserted Rows</span><span class="sxs-lookup"><span data-stu-id="0f5e7-746">Change Inserted Rows</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-747">DBPROP_CHANGEINSERTEDROWS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-747">DBPROP_CHANGEINSERTEDROWS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-748">Column Privileges</span><span class="sxs-lookup"><span data-stu-id="0f5e7-748">Column Privileges</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-749">DBPROP_COLUMNRESTRICT</span><span class="sxs-lookup"><span data-stu-id="0f5e7-749">DBPROP_COLUMNRESTRICT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-750">Column Set Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-750">Column Set Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-751">DBPROP_NOTIFYCOLUMNSET</span><span class="sxs-lookup"><span data-stu-id="0f5e7-751">DBPROP_NOTIFYCOLUMNSET</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-752">Delay Storage Object Updates</span><span class="sxs-lookup"><span data-stu-id="0f5e7-752">Delay Storage Object Updates</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-753">DBPROP_DELAYSTORAGEOBJECTS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-753">DBPROP_DELAYSTORAGEOBJECTS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-754">Fetch Backwards</span><span class="sxs-lookup"><span data-stu-id="0f5e7-754">Fetch Backwards</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-755">DBPROP_CANFETCHBACKWARDS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-755">DBPROP_CANFETCHBACKWARDS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-756">Hold Rows</span><span class="sxs-lookup"><span data-stu-id="0f5e7-756">Hold Rows</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-757">DBPROP_CANHOLDROWS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-757">DBPROP_CANHOLDROWS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-758">IAccessor</span><span class="sxs-lookup"><span data-stu-id="0f5e7-758">IAccessor</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-759">DBPROP_IAccessor</span><span class="sxs-lookup"><span data-stu-id="0f5e7-759">DBPROP_IAccessor</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-760">IColumnsInfo</span><span class="sxs-lookup"><span data-stu-id="0f5e7-760">IColumnsInfo</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-761">DBPROP_IColumnsInfo</span><span class="sxs-lookup"><span data-stu-id="0f5e7-761">DBPROP_IColumnsInfo</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-762">IColumnsRowset</span><span class="sxs-lookup"><span data-stu-id="0f5e7-762">IColumnsRowset</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-763">DBPROP_IColumnsRowset</span><span class="sxs-lookup"><span data-stu-id="0f5e7-763">DBPROP_IColumnsRowset</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-764">IConnectionPointContainer</span><span class="sxs-lookup"><span data-stu-id="0f5e7-764">IConnectionPointContainer</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-765">DBPROP_IConnectionPointContainer</span><span class="sxs-lookup"><span data-stu-id="0f5e7-765">DBPROP_IConnectionPointContainer</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-766">IConvertType</span><span class="sxs-lookup"><span data-stu-id="0f5e7-766">IConvertType</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-767">DBPROP_IConvertType</span><span class="sxs-lookup"><span data-stu-id="0f5e7-767">DBPROP_IConvertType</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-768">Immobile Rows</span><span class="sxs-lookup"><span data-stu-id="0f5e7-768">Immobile Rows</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-769">DBPROP_IMMOBILEROWS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-769">DBPROP_IMMOBILEROWS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-770">IRowset</span><span class="sxs-lookup"><span data-stu-id="0f5e7-770">IRowset</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-771">DBPROP_IRowset</span><span class="sxs-lookup"><span data-stu-id="0f5e7-771">DBPROP_IRowset</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-772">IRowsetChange</span><span class="sxs-lookup"><span data-stu-id="0f5e7-772">IRowsetChange</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-773">DBPROP_IRowsetChange</span><span class="sxs-lookup"><span data-stu-id="0f5e7-773">DBPROP_IRowsetChange</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-774">IRowsetIdentity</span><span class="sxs-lookup"><span data-stu-id="0f5e7-774">IRowsetIdentity</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-775">DBPROP_IRowsetIdentity</span><span class="sxs-lookup"><span data-stu-id="0f5e7-775">DBPROP_IRowsetIdentity</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-776">IRowsetInfo</span><span class="sxs-lookup"><span data-stu-id="0f5e7-776">IRowsetInfo</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-777">DBPROP_IRowsetInfo</span><span class="sxs-lookup"><span data-stu-id="0f5e7-777">DBPROP_IRowsetInfo</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-778">IRowsetLocate</span><span class="sxs-lookup"><span data-stu-id="0f5e7-778">IRowsetLocate</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-779">DBPROP_IRowsetLocate</span><span class="sxs-lookup"><span data-stu-id="0f5e7-779">DBPROP_IRowsetLocate</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-780">IRowsetResynch</span><span class="sxs-lookup"><span data-stu-id="0f5e7-780">IRowsetResynch</span></span></p></td>
<td><p></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-781">IRowsetUpdate</span><span class="sxs-lookup"><span data-stu-id="0f5e7-781">IRowsetUpdate</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-782">DBPROP_IRowsetUpdate</span><span class="sxs-lookup"><span data-stu-id="0f5e7-782">DBPROP_IRowsetUpdate</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-783">ISequentialStream</span><span class="sxs-lookup"><span data-stu-id="0f5e7-783">ISequentialStream</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-784">DBPROP_ISequentialStream</span><span class="sxs-lookup"><span data-stu-id="0f5e7-784">DBPROP_ISequentialStream</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-785">ISupportErrorInfo</span><span class="sxs-lookup"><span data-stu-id="0f5e7-785">ISupportErrorInfo</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-786">DBPROP_ISupportErrorInfo</span><span class="sxs-lookup"><span data-stu-id="0f5e7-786">DBPROP_ISupportErrorInfo</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-787">Literal Bookmarks</span><span class="sxs-lookup"><span data-stu-id="0f5e7-787">Literal Bookmarks</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-788">DBPROP_LITERALBOOKMARKS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-788">DBPROP_LITERALBOOKMARKS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-789">Literal Row Identity</span><span class="sxs-lookup"><span data-stu-id="0f5e7-789">Literal Row Identity</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-790">DBPROP_LITERALIDENTITY</span><span class="sxs-lookup"><span data-stu-id="0f5e7-790">DBPROP_LITERALIDENTITY</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-791">Maximum Open Rows</span><span class="sxs-lookup"><span data-stu-id="0f5e7-791">Maximum Open Rows</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-792">DBPROP_MAXOPENROWS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-792">DBPROP_MAXOPENROWS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-793">Maximum Pending Rows</span><span class="sxs-lookup"><span data-stu-id="0f5e7-793">Maximum Pending Rows</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-794">DBPROP_MAXPENDINGROWS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-794">DBPROP_MAXPENDINGROWS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-795">Maximum Rows</span><span class="sxs-lookup"><span data-stu-id="0f5e7-795">Maximum Rows</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-796">DBPROP_MAXROWS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-796">DBPROP_MAXROWS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-797">Notification Granularity</span><span class="sxs-lookup"><span data-stu-id="0f5e7-797">Notification Granularity</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-798">DBPROP_NOTIFICATIONGRANULARITY</span><span class="sxs-lookup"><span data-stu-id="0f5e7-798">DBPROP_NOTIFICATIONGRANULARITY</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-799">Notification Phases</span><span class="sxs-lookup"><span data-stu-id="0f5e7-799">Notification Phases</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-800">DBPROP_NOTIFICATIONPHASES</span><span class="sxs-lookup"><span data-stu-id="0f5e7-800">DBPROP_NOTIFICATIONPHASES</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-801">Objects Transacted</span><span class="sxs-lookup"><span data-stu-id="0f5e7-801">Objects Transacted</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-802">DBPROP_TRANSACTEDOBJECT</span><span class="sxs-lookup"><span data-stu-id="0f5e7-802">DBPROP_TRANSACTEDOBJECT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-803">Own Changes Visible</span><span class="sxs-lookup"><span data-stu-id="0f5e7-803">Own Changes Visible</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-804">DBPROP_OWNUPDATEDELETE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-804">DBPROP_OWNUPDATEDELETE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-805">Own Inserts Visible</span><span class="sxs-lookup"><span data-stu-id="0f5e7-805">Own Inserts Visible</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-806">DBPROP_OWNINSERT</span><span class="sxs-lookup"><span data-stu-id="0f5e7-806">DBPROP_OWNINSERT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-807">Preserve on Abort</span><span class="sxs-lookup"><span data-stu-id="0f5e7-807">Preserve on Abort</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-808">DBPROP_ABORTPRESERVE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-808">DBPROP_ABORTPRESERVE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-809">Preserve on Commit</span><span class="sxs-lookup"><span data-stu-id="0f5e7-809">Preserve on Commit</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-810">DBPROP_COMMITPRESERVE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-810">DBPROP_COMMITPRESERVE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-811">Quick Restart</span><span class="sxs-lookup"><span data-stu-id="0f5e7-811">Quick Restart</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-812">DBPROP_QUICKRESTART</span><span class="sxs-lookup"><span data-stu-id="0f5e7-812">DBPROP_QUICKRESTART</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-813">Reentrant Events</span><span class="sxs-lookup"><span data-stu-id="0f5e7-813">Reentrant Events</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-814">DBPROP_REENTRANTEVENTS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-814">DBPROP_REENTRANTEVENTS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-815">Remove Deleted Rows</span><span class="sxs-lookup"><span data-stu-id="0f5e7-815">Remove Deleted Rows</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-816">DBPROP_REMOVEDELETED</span><span class="sxs-lookup"><span data-stu-id="0f5e7-816">DBPROP_REMOVEDELETED</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-817">Report Multiple Changes</span><span class="sxs-lookup"><span data-stu-id="0f5e7-817">Report Multiple Changes</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-818">DBPROP_REPORTMULTIPLECHANGES</span><span class="sxs-lookup"><span data-stu-id="0f5e7-818">DBPROP_REPORTMULTIPLECHANGES</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-819">Return Pending Inserts</span><span class="sxs-lookup"><span data-stu-id="0f5e7-819">Return Pending Inserts</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-820">DBPROP_RETURNPENDINGINSERTS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-820">DBPROP_RETURNPENDINGINSERTS</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-821">Row Delete Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-821">Row Delete Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-822">DBPROP_NOTIFYROWDELETE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-822">DBPROP_NOTIFYROWDELETE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-823">Row First Change Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-823">Row First Change Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-824">DBPROP_NOTIFYROWFIRSTCHANGE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-824">DBPROP_NOTIFYROWFIRSTCHANGE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-825">Row Insert Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-825">Row Insert Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-826">DBPROP_NOTIFYROWINSERT</span><span class="sxs-lookup"><span data-stu-id="0f5e7-826">DBPROP_NOTIFYROWINSERT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-827">Row Privileges</span><span class="sxs-lookup"><span data-stu-id="0f5e7-827">Row Privileges</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-828">DBPROP_ROWRESTRICT</span><span class="sxs-lookup"><span data-stu-id="0f5e7-828">DBPROP_ROWRESTRICT</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-829">Row Resynchronization Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-829">Row Resynchronization Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-830">DBPROP_NOTIFYROWRESYNCH</span><span class="sxs-lookup"><span data-stu-id="0f5e7-830">DBPROP_NOTIFYROWRESYNCH</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-831">Row Threading Model</span><span class="sxs-lookup"><span data-stu-id="0f5e7-831">Row Threading Model</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-832">DBPROP_ROWTHREADMODEL</span><span class="sxs-lookup"><span data-stu-id="0f5e7-832">DBPROP_ROWTHREADMODEL</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-833">Row Undo Change Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-833">Row Undo Change Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-834">DBPROP_NOTIFYROWUNDOCHANGE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-834">DBPROP_NOTIFYROWUNDOCHANGE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-835">Row Undo Delete Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-835">Row Undo Delete Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-836">DBPROP_NOTIFYROWUNDODELETE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-836">DBPROP_NOTIFYROWUNDODELETE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-837">Row Undo Insert Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-837">Row Undo Insert Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-838">DBPROP_NOTIFYROWUNDOINSERT</span><span class="sxs-lookup"><span data-stu-id="0f5e7-838">DBPROP_NOTIFYROWUNDOINSERT</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-839">Row Update Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-839">Row Update Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-840">DBPROP_NOTIFYROWUPDATE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-840">DBPROP_NOTIFYROWUPDATE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-841">Rowset Fetch Position Change Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-841">Rowset Fetch Position Change Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-842">DBPROP_NOTIFYROWSETFETCHPOSITIONCHANGE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-842">DBPROP_NOTIFYROWSETFETCHPOSITIONCHANGE</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-843">Rowset Release Notification</span><span class="sxs-lookup"><span data-stu-id="0f5e7-843">Rowset Release Notification</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-844">DBPROP_NOTIFYROWSETRELEASE</span><span class="sxs-lookup"><span data-stu-id="0f5e7-844">DBPROP_NOTIFYROWSETRELEASE</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-845">Scroll Backwards</span><span class="sxs-lookup"><span data-stu-id="0f5e7-845">Scroll Backwards</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-846">DBPROP_CANSCROLLBACKWARDS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-846">DBPROP_CANSCROLLBACKWARDS</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-847">Skip Deleted Bookmarks</span><span class="sxs-lookup"><span data-stu-id="0f5e7-847">Skip Deleted Bookmarks</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-848">DBPROP_BOOKMARKSKIP</span><span class="sxs-lookup"><span data-stu-id="0f5e7-848">DBPROP_BOOKMARKSKIP</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-849">Strong Row Identity</span><span class="sxs-lookup"><span data-stu-id="0f5e7-849">Strong Row Identity</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-850">DBPROP_STRONGIDENTITY</span><span class="sxs-lookup"><span data-stu-id="0f5e7-850">DBPROP_STRONGIDENTITY</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="0f5e7-851">Updatability</span><span class="sxs-lookup"><span data-stu-id="0f5e7-851">Updatability</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-852">DBPROP_UPDATABILITY</span><span class="sxs-lookup"><span data-stu-id="0f5e7-852">DBPROP_UPDATABILITY</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="0f5e7-853">Use Bookmarks</span><span class="sxs-lookup"><span data-stu-id="0f5e7-853">Use Bookmarks</span></span></p></td>
<td><p><span data-ttu-id="0f5e7-854">DBPROP_BOOKMARKS</span><span class="sxs-lookup"><span data-stu-id="0f5e7-854">DBPROP_BOOKMARKS</span></span></p></td>
</tr>
</tbody>
</table>


## <a name="see-also"></a><span data-ttu-id="0f5e7-855">Siehe auch</span><span class="sxs-lookup"><span data-stu-id="0f5e7-855">See also</span></span>

<span data-ttu-id="0f5e7-856">Weitere Informationen zur Implementierung und funktionale Informationen zu den Microsoft OLE DB-Anbieter für ODBC wenden Sie sich an dem [OLE DB Programmer's Guide](https://docs.microsoft.com/previous-versions/windows/desktop/ms713643(v=vs.85)) oder besuchen Sie das [Data Plattform Developer Center](https://docs.microsoft.com/sql/connect/sql-data-developer?view=sql-server-2017).</span><span class="sxs-lookup"><span data-stu-id="0f5e7-856">For details regarding specific implementation and functional information about the Microsoft OLE DB Provider for ODBC, consult the [OLE DB Programmer's Guide](https://docs.microsoft.com/previous-versions/windows/desktop/ms713643(v=vs.85)) or visit the [Data Platform Developer Center](https://docs.microsoft.com/sql/connect/sql-data-developer?view=sql-server-2017).</span></span>
