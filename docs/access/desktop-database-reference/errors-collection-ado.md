...
> [!NOTE]
> <P>[!HINWEIS] Weitere Informationen zur Art, wie ein einzelner ADO-Vorgang mehrere Fehler erzeugen kann, finden Sie in der Beschreibung des <STRONG>Error</STRONG> -Objekts.</P>
