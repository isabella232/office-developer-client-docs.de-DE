...
ms.locfileid: "25879249"
---
# <a name="command-and-commandtext-properties-example-vc"></a><span data-ttu-id="c618d-102">Command- und CommandText-Eigenschaft (VC++-Beispiel)</span><span class="sxs-lookup"><span data-stu-id="c618d-102">Command and CommandText properties example (VC++)</span></span>


<span data-ttu-id="c618d-103">**Betrifft**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="c618d-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="c618d-104">Im folgenden Codebeispiel wird die Verwendung der [Command](command-property-adox.md)-Eigenschaft veranschaulicht, um den Text einer Prozedur zu aktualisieren.</span><span class="sxs-lookup"><span data-stu-id="c618d-104">The following code demonstrates how to use the [Command](command-property-adox.md) property to update the text of a procedure.</span></span>
