...
ms.locfileid: "28704588"
---
# <a name="errors-object-reference-dao"></a>Fehler-Objektverweis (DAO)

**Betrifft**: Access 2013, Office 2013

- [Errors-Auflistung (DAO)](errors-collection-dao.md)
- [Fehler-Member (DAO)](errors-members-dao.md)
- [Fehler-Eigenschaften (DAO)](errors-properties-dao.md)
- [Fehler-Methoden (DAO)](errors-methods-dao.md)
