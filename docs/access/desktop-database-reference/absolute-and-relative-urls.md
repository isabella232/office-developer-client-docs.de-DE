...
|*resource*|Wenn enthalten, *Ressource* ist das Ziel und ist in der Regel der Name einer Datei. Es kann eine *einfache Datei*, mit einer einzigen binären Stream von Bytes oder ein *strukturiertes Dokument*mit einer speichern und binären sein.|
