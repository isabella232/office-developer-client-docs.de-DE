---
title: Open- und Close-Methoden (Beispiel) (VC++)
...
ms.locfileid: "32288413"
---
# <a name="open-and-close-methods-example-vc"></a><span data-ttu-id="26d0a-102">Open- und Close-Methoden (Beispiel) (VC++)</span><span class="sxs-lookup"><span data-stu-id="26d0a-102">Open and Close methods example (VC++)</span></span>


<span data-ttu-id="26d0a-103">**Gilt für**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="26d0a-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="26d0a-104">In diesem Beispiel werden die Methoden **Open** und [Close](close-method-ado.md) für geöffnete [Recordset](recordset-object-ado.md)- und [Connection](connection-object-ado.md)-Objekte verwendet.</span><span class="sxs-lookup"><span data-stu-id="26d0a-104">This example uses the **Open** and [Close](close-method-ado.md) methods on both [Recordset](recordset-object-ado.md) and [Connection](connection-object-ado.md) objects that have been opened.</span></span>
...
<span data-ttu-id="26d0a-105">**OpenX. h**</span><span class="sxs-lookup"><span data-stu-id="26d0a-105">**OpenX.h**</span></span>
