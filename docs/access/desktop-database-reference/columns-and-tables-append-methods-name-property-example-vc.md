---
title: Append-Methode (Columns und Tables), Name-Eigenschaft (beispiel) (VC++)
...
ms.locfileid: "59569454"
---
# <a name="columns-and-tables-append-methods-name-property-example-vc"></a>Append-Methode (Columns und Tables), Name-Eigenschaft (beispiel) (VC++)
