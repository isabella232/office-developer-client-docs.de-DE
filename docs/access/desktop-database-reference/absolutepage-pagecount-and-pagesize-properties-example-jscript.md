...
ms.locfileid: "25472859"
---
# <a name="absolutepage-pagecount-and-pagesize-properties-example-jscript"></a><span data-ttu-id="c0cb4-102">AbsolutePage-, PageCount- und PageSize-Eigenschaft (Beispiel) (JScript)</span><span class="sxs-lookup"><span data-stu-id="c0cb4-102">AbsolutePage, PageCount, and PageSize Properties Example (JScript)</span></span>

<span data-ttu-id="c0cb4-103">**Betrifft**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="c0cb4-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="c0cb4-104">Dieses Beispiel veranschaulicht die AbsolutePage-, PageCount- und PageSize-Eigenschaften.</span><span class="sxs-lookup"><span data-stu-id="c0cb4-104">This example demonstrates the AbsolutePage, PageCount, and PageSize properties.</span></span> <span data-ttu-id="c0cb4-105">Schneiden Sie aus und fügen Sie den folgenden Code in Editor oder einem anderen Texteditor, und speichern Sie es als **AbsolutePageJS.asp**.</span><span class="sxs-lookup"><span data-stu-id="c0cb4-105">Cut and paste the following code to Notepad or another text editor, and save it as **AbsolutePageJS.asp**.</span></span>
