...
ms.locfileid: "25473410"
---
# <a name="addnew-method-example-vj"></a><span data-ttu-id="48e70-102">AddNew-Methode (Beispiel) (VJ++)</span><span class="sxs-lookup"><span data-stu-id="48e70-102">AddNew Method Example (VJ++)</span></span>


<span data-ttu-id="48e70-103">**Betrifft**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="48e70-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="48e70-104">Dieses Beispiel verwendet die [AddNew](addnew-method-ado.md) -Methode, um einen neuen Datensatz mit dem angegebenen Namen zu erstellen.</span><span class="sxs-lookup"><span data-stu-id="48e70-104">This example uses the [AddNew](addnew-method-ado.md) method to create a new record with the specified name.</span></span>
