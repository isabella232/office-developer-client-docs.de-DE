...
ms.locfileid: "25886179"
---
# <a name="delete-method-example-vj"></a><span data-ttu-id="bd479-102">Delete-Methode (Beispiel) (VJ++)</span><span class="sxs-lookup"><span data-stu-id="bd479-102">Delete method example (VJ++)</span></span>


<span data-ttu-id="bd479-103">**Betrifft**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="bd479-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="bd479-104">In diesem Beispiel wird die [Delete](delete-method-ado-recordset.md)-Methode verwendet, um einen angegebenen Datensatz aus einem [Recordset](recordset-object-ado.md)-Objekt zu entfernen.</span><span class="sxs-lookup"><span data-stu-id="bd479-104">This example uses the [Delete](delete-method-ado-recordset.md) method to remove a specified record from a [Recordset](recordset-object-ado.md).</span></span>
