...
Dieses Beispiel veranschaulicht die [Update](update-method-ado.md)-Methode in Verbindung mit der [CancelUpdate](cancelupdate-method-ado.md)-Methode.
...
Dieses Beispiel veranschaulicht die **Update** -Methode in Verbindung mit der [AddNew](addnew-method-ado.md)-Methode.
