---
title: ADO-Codebeispiele in Microsoft Visual Basic (Access)
...
ms.locfileid: "25879214"
---
# <a name="ado-code-examples-in-microsoft-visual-basic-access"></a>ADO-Codebeispiele in Microsoft Visual Basic (Access)
...
**Betrifft**: Access 2013, Office 2013
  ...
  - [ActualSize- und DefinedSize-Eigenschaft (Beispiel) (VB)](actualsize-and-definedsize-properties-example-vb.md)
  ...
  - [AppendChunk- und GetChunk-Methode (Beispiel) (VB)](appendchunk-and-getchunk-methods-example-vb.md)

  - [Attributes- und Name-Eigenschaft (Beispiel) (VB)](attributes-and-name-properties-example-vb.md)

  - [BeginTrans-, CommitTrans- und RollbackTrans-Methode (Beispiel) (VB)](begintrans-committrans-and-rollbacktrans-methods-example-vb.md)
  ...
  - [CursorType-, LockType- und EditMode-Eigenschaft (Beispiel) (VB)](cursortype-locktype-and-editmode-properties-example-vb.md)
  ...
  - [Description-, HelpContext-, HelpFile-, NativeError-, Number-, Source- und SQLState-Eigenschaft (Beispiel) (VB)](description-helpcontext-helpfile-nativeerror-number-source-and-sqlstate-properties-example-vb.md)
  ...
  - [Provider- und DefaultDatabase-Eigenschaft (Beispiel) (VB)](provider-and-defaultdatabase-properties-example-vb.md)
