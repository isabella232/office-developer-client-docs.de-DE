...
- [Append und CreateParameter-Methode (Beispiel)](append-and-createparameter-methods-example-vc.md)
- [Methoden "AppendChunk" und "GetChunk" Methoden Beispiel](appendchunk-and-getchunk-methods-example-vc.md)
- [BeginTrans, CommitTrans und RollbackTrans Methoden Beispiel](begintrans-committrans-and-rollbacktrans-methods-example-vc.md)
...
- [Löschen-Methode (Beispiel)](delete-method-example-vc.md)
- [Execute-, Requery- und Clear-Methoden Beispiel](execute-requery-and-clear-methods-example-vc.md)
- [Suchen Sie nach Methode (Beispiel)](find-method-example-vc.md)
...
- [Open- und Close-Methode (Beispiel)](open-and-close-methods-example-vc.md)
...
- [Speichern und Open-Methoden (Beispiel)](save-and-open-methods-example-vc.md)
...
- [Update- und CancelUpdate-Methode-Beispiel](update-and-cancelupdate-methods-example-vc.md)
...
- [ADO-Ereignismodellbeispiel](ado-events-model-example-vc.md)
