...
- [Append- und CreateParameter-Methoden (Beispiel)](append-and-createparameter-methods-example-vc.md)
- [AppendChunk- und GetChunk-Methode (Beispiel)](appendchunk-and-getchunk-methods-example-vc.md)
- [BeginTrans-, CommitTrans- und RollbackTrans-Methode (Beispiel)](begintrans-committrans-and-rollbacktrans-methods-example-vc.md)
...
- [Beispiel für resync-Methode](resync-method-example-vc.md)
...
- [UpdateBatch- und CancelBatch-Methode (Beispiel)](updatebatch-and-cancelbatch-methods-example-vc.md)

## <a name="properties"></a>Eigenschaften

- [AbsolutePage-, PageCount- und PageSize-Eigenschaft (Beispiel)](absolutepage-pagecount-and-pagesize-properties-example-vc.md)
...
- [Description-, HelpContext-, HelpFile-, NativeError-, Number-, Source- und SQLState-Eigenschaft (Beispiel)](description-helpcontext-helpfile-nativeerror-number-source-and-sqlstate-properties-example-vc.md)
...
- [Beispiel für State-Eigenschaft](state-property-example-vc.md)
...
- [Type-Eigenschaft (Beispiel) (Fields)](type-property-example-field-vc.md)
...
- [Beispiel für Version-Eigenschaft](version-property-example-vc.md)

## <a name="events"></a>Ereignisse

- [Beispiel für das ADO-Ereignismodell](ado-events-model-example-vc.md)
