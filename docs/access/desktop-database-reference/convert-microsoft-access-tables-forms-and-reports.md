---
<<<<<<< HEAD-Titel: Konvertieren von Microsoft Access-Tabellen, Formulare und Berichte TOCTitle: Konvertieren von Microsoft Access-Tabellen, Formulare und Berichte Ms:assetid: cc170e62-a663-60e8-4446-07a7a874b747 Ms:mtpsurl: https://msdn.microsoft.com/library/Ff834413(v=office.15) Ms:contentKeyID: 48547731 ms.date: 09/18/2015 === Titel: Konvertieren von Microsoft Access Tabellen, Formulare und Berichte TOCTitle: Konvertieren von Microsoft Access Tabellen, Formulare und Berichte Beschreibung: Änderungen von Microsoft Access 2002 können sich auf das Verhalten der Version 1 auswirken. X oder 2.0 Applications.
...
=======
# <a name="convert-microsoft-access-tables-forms-and-reports"></a>Konvertieren von Microsoft Access-Tabellen, Formulare und Berichte
>>>>>>> master
...
Um zusätzliche Funktionen verfügbar machen beim Aktivieren von OLE-Objekten, können einige Menübefehle zu einem Menü verschoben wurden, die einen OLE-Server nicht ersetzt wird.
...
## <a name="form-and-report-class-modules"></a>Klassenmodule für Formulare und Berichte
...
<a name="iifisnullmycontrol-null-formatmycontrol-zls"></a>\=IIf (IsNull (\[MeinSteuerelement\]), "Null", Format (\[MeinSteuerelement\], "@; ;LZ"))"))
=======
## <a name="cant-use-the-format-property-to-distinguish-null-values-and-zero-length-strings"></a>Die Format-Eigenschaft können keine Null-Werte und leere Zeichenfolgen zu unterscheiden.
