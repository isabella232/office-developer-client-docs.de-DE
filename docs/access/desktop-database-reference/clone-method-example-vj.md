---
title: Clone-Methode (Beispiel) (VJ++)
...
ms.locfileid: "25475004"
---
# <a name="clone-method-example-vj"></a><span data-ttu-id="e8138-102">Clone-Methode (Beispiel) (VJ++)</span><span class="sxs-lookup"><span data-stu-id="e8138-102">Clone Method Example (VJ++)</span></span>


<span data-ttu-id="e8138-103">**Betrifft**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="e8138-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="e8138-104">In diesem Beispiel werden mit der [Clone](clone-method-ado.md) -Methode Kopien eines [Recordset](recordset-object-ado.md) erstellt. Anschließend kann der Benutzer den Datensatzzeiger jeder Kopie unabhängig positionieren.</span><span class="sxs-lookup"><span data-stu-id="e8138-104">This example uses the [Clone](clone-method-ado.md) method to create copies of a [Recordset](recordset-object-ado.md) and then lets the user position the record pointer of each copy independently.</span></span>
