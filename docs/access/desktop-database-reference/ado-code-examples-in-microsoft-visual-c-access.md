...
**Betrifft**: Access 2013 | Office 2013
  ...
  - [ADO-Ereignismodellbeispiel (VC++)](ado-events-model-example-vc.md)
...
=======
  - [AbsolutePage-, PageCount- und PageSize-Eigenschaften (VC++-Beispiel)](absolutepage-pagecount-and-pagesize-properties-example-vc.md)

  - [AbsolutePosition- und CursorLocation-Eigenschaften (VC++-Beispiel)](absoluteposition-and-cursorlocation-properties-example-vc.md)

  - [ActiveCommand-Eigenschaft (VC++-Beispiel)](activecommand-property-example-vc.md)

  - [ActiveConnection, CommandText, CommandTimeout, CommandType, Size und Direction Eigenschaft (VC++-Beispiel)](activeconnection-commandtext-commandtimeout-commandtype-size-and-direction-properties-example-vc.md)

  - [ActualSize- und DefinedSize Eigenschaft (VC++-Beispiel)](actualsize-and-definedsize-properties-example-vc.md)
>>>>>>> master

  - [AddNew-Methode (Beispiel) (VC++)](addnew-method-example-vc.md)

  - [Methoden "Append" und "CreateParameter" (Beispiel) (VC++)](append-and-createparameter-methods-example-vc.md)
...
=======
  - [Attributes- und Name-Eigenschaften-Beispiel) (VC++)](attributes-and-name-properties-example-vc.md)

  - [Methoden "BeginTrans", "CommitTrans" und "RollbackTrans" (Beispiel) (VC++)](begintrans-committrans-and-rollbacktrans-methods-example-vc.md)

  - [BOF-, EOF- und Bookmark-Eigenschaften (VC++-Beispiel)](bof-eof-and-bookmark-properties-example-vc.md)
...
=======
  - [ConnectionString-, ConnectionTimeout- und State-Eigenschaften (VC++-Beispiel)](connectionstring-connectiontimeout-and-state-properties-example-vc.md)

  - [Count-Eigenschaft (VC++-Beispiel)](count-property-example-vc.md)

  - [CursorType-, LockType- und EditMode-Eigenschaften (VC++-Beispiel)](cursortype-locktype-and-editmode-properties-example-vc.md)

  - [Delete-Methode (Beispiel) (VC++)](delete-method-example-vc.md)

  - [Description, HelpContext, HelpFile, NativeError, Anzahl, Source- und SQLState Eigenschaft (VC++-Beispiel)](description-helpcontext-helpfile-nativeerror-number-source-and-sqlstate-properties-example-vc.md)

  - [Execute-, Requery- und Clear-Methoden (Beispiel) (VC++)](execute-requery-and-clear-methods-example-vc.md)

  - [Filter- und RecordCount Eigenschaft (VC++-Beispiel)](filter-and-recordcount-properties-example-vc.md)
>>>>>>> master
...
=======
  - [IsolationLevel- und Mode-Eigenschaften (VC++-Beispiel)](isolationlevel-and-mode-properties-example-vc.md)

  - [Item-Eigenschaft (VC++-Beispiel)](item-property-example-vc.md)

  - [MarshalOptions-Eigenschaft (VC++-Beispiel)](marshaloptions-property-example-vc.md)
...
>>>>>>> master
  ...
  - [MoveFirst-, MoveLast-, MoveNext- und MovePrevious-Methoden (Beispiel) (VC++)](movefirst-movelast-movenext-and-moveprevious-methods-example-vc.md)
...
=======
  - [Optimieren der Eigenschaft (VC++-Beispiel)](optimize-property-example-vc.md)

  - [OriginalValue- und UnderlyingValue-Eigenschaften (VC++-Beispiel)](originalvalue-and-underlyingvalue-properties-example-vc.md)

  - [Prepared-Eigenschaft (VC++-Beispiel)](prepared-property-example-vc.md)

  - [Provider- und DefaultDatabase-Eigenschaften (VC++-Beispiel)](provider-and-defaultdatabase-properties-example-vc.md)
>>>>>>> master
...
=======
  ...
  - [Sort-Eigenschaft (VC++-Beispiel)](sort-property-example-vc.md)

  - [Source-Eigenschaft (VC++-Beispiel)](source-property-example-vc.md)

  - [State-Eigenschaft (VC++-Beispiel)](state-property-example-vc.md)

  - [Status-Eigenschaft (VC++-Beispiel)](status-property-example-vc.md)

  - [StayInSync-Eigenschaft (VC++-Beispiel)](stayinsync-property-example-vc.md)

  - [Supports-Methode (Beispiel) (VC++)](supports-method-example-vc.md)

  - [Geben Sie die Eigenschaft (Beispiel) (Field) (VC++)](type-property-example-field-vc.md)
...
=======
  - [Wert-Eigenschaft (VC++-Beispiel)](value-property-example-vc.md)
