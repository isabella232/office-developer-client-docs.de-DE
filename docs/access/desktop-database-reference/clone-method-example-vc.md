...
ms.locfileid: "25475224"
---
# <a name="clone-method-example-vc"></a><span data-ttu-id="c77e2-102">Clone-Methode (Beispiel) (VC++)</span><span class="sxs-lookup"><span data-stu-id="c77e2-102">Clone Method Example (VC++)</span></span>


<span data-ttu-id="c77e2-103">**Betrifft**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="c77e2-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="c77e2-104">In diesem Beispiel wird die [Clone](clone-method-ado.md)-Methode zum Erstellen von Kopien eines [Recordsets](recordset-object-ado.md) verwendet. Dann kann der Benutzer den Datensatzzeiger für jede Kopie unabhängig positionieren.</span><span class="sxs-lookup"><span data-stu-id="c77e2-104">This example uses the [Clone](clone-method-ado.md) method to create copies of a [Recordset](recordset-object-ado.md) and then lets the user position the record pointer of each copy independently.</span></span>
...
<span data-ttu-id="c77e2-105">**CloneX.h**</span><span class="sxs-lookup"><span data-stu-id="c77e2-105">**CloneX.h**</span></span>
