...
---
# <a name="attributes-and-name-properties-example-vc"></a><span data-ttu-id="f5588-102">Attributes- und Name-Eigenschaft (Beispiel) (VC++)</span><span class="sxs-lookup"><span data-stu-id="f5588-102">Attributes and Name Properties Example (VC++)</span></span>


<span data-ttu-id="f5588-103">**Betrifft**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="f5588-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="f5588-p101">In diesem Beispiel wird der Wert der [Attributes](attributes-property-ado.md)-Eigenschaft für [Connection](connection-object-ado.md)-, [Field](field-object-ado.md)- und [Property](property-object-ado.md)-Objekte angezeigt. Mithilfe der [Name](name-property-ado.md)-Eigenschaft wird der Name jedes **Field** - und **Property** -Objekts angezeigt.</span><span class="sxs-lookup"><span data-stu-id="f5588-p101">This example displays the value of the [Attributes](attributes-property-ado.md) property for [Connection](connection-object-ado.md), [Field](field-object-ado.md), and [Property](property-object-ado.md) objects. It uses the [Name](name-property-ado.md) property to display the name of each **Field** and **Property** object.</span></span>
...
<span data-ttu-id="f5588-106">**AttributesX.h**</span><span class="sxs-lookup"><span data-stu-id="f5588-106">**AttributesX.h**</span></span>
