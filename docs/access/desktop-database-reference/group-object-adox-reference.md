...
---
# <a name="group-object-adox-reference"></a>Gruppe Objektverweis (ADOX)

**Betrifft**: Access 2013, Office 2013

- [Group-Objekt (ADOX)](group-object-adox.md)
- [Gruppe von Eigenschaften, Methoden und Ereignisse (ADOX)](group-properties-methods-and-events-adox.md)
