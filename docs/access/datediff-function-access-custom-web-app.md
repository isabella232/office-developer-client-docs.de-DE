...
---
# <a name="datediff-function-access-custom-web-app"></a>DateDiff-Funktion (Access Custom Web App)

Gibt die Anzahl der angegebenen Datumsteil Grenzen zwischen dem angegebenen Startdatum und Enddatum überschritten zurück.
