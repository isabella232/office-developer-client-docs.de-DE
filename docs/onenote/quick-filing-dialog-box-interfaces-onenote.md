...
|**Parameter** <br/> | _recentResults_ &ndash; Ein Objekt vom Typ **RecentResultType,** das angibt, welche zuletzt verwendete Ergebnisliste angezeigt werden soll, falls vorhanden. Wenn **rrtNone** ausgewählt ist, wird keine Ergebnisliste der zuletzt verwendeten im Dialogfeld angezeigt.<br/><br/>  _fShowCurrentSection_ &ndash; Ein boolescher Wert, der angibt, ob der aktuelle Abschnitt in der Liste der zuletzt verwendeten Ergebnisse enthalten sein soll.<br/><br/>  _fShowCurrentPage_ &ndash; Ein boolescher Wert, der angibt, ob die aktuelle Seite in der Ergebnisliste der letzten Version enthalten sein soll.<br/><br/>  _fShowUnfiledNotes_ &ndash; Ein boolescher Wert, der angibt, ob der Abschnitt "Unfiled Notes" in der ergebnisliste der zuletzt verwendeten enthalten sein soll.  <br/> |
