...
- [Erste Schritte mit Excel-Add-Ins](https://docs.microsoft.com/en-us/office/dev/add-ins/excel/excel-add-ins-get-started-overview)
  
- [Plattformübersicht](https://docs.microsoft.com/en-us/office/dev/add-ins/overview/office-add-ins)
  
### <a name="code-samples"></a>Codebeispiele
  
- [Excel-Codebeispiele in der Office Developer Center](https://developer.microsoft.com/en-us/excel/gallery/?filterBy=Samples)
