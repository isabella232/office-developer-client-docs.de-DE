...
Beispiel für eine benutzerdefinierte Arbeitsblattfunktion, die 1 bis 29 Argumente benötigt und deren Summe berechnet. Jedes Argument kann eine einzelne Zahl, ein Bereich oder ein Array sein. Wenn GENERIC.xll geladen wird, registriert es diese Funktion, sodass sie aus dem Arbeitsblatt aufgerufen werden kann. 
...
Die Summe der Argumente oder #VALUE! wenn in der angegebenen Argumentliste oder in einer Zelle in einem Bereich oder Element in einem Array nicht numerische Zahlen vorhanden sind.
