...
> [!NOTE]
> <span data-ttu-id="32097-171">XLL-Arbeitsblattfunktionen d�rfen keine C-API-Befehle wie **xlcSave** aufrufen, unabh�ngig davon, ob diese als threadsicher registriert wurden oder nicht.</span><span class="sxs-lookup"><span data-stu-id="32097-171">XLL worksheet functions are not permitted to call C API commands, for example, **xlcSave**, regardless of whether they have been registered as thread safe or not.</span></span> 
