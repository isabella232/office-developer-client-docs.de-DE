...
|FillGradient  <br/> |Eine Auflistung von Eigenschaften, mit denen der Farbverlauf für die Farbe eines Shapes. Sie benötigen ein **ShapeSheet_Type** oder **StyleSheet_Type** übergeordnetes Element.  <br/> |[Farbverlauf Abschnitt füllen](fill-gradient-section.md) <br/> |
...
|Zeile Farbverlauf  <br/> |Eine Auflistung von verwandten Eigenschaften, mit denen Farbverlauf Zeile eines Shapes. Sie benötigen ein **ShapeSheet_Type** oder **StyleSheet_Type** übergeordnetes Element.  <br/> |[Abschnitt "Line Farbverlauf"](line-gradient-section.md) <br/> |
