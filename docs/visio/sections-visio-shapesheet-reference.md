...
- [Abschnitt "Connection Points"](connection-points-section.md)
    
- [Abschnitt "Controls"](controls-section.md)
    
- [Abschnitt "Document Properties"](document-properties-section.md)
    
- [Abschnitt "Events"](events-section.md)
...
- [Abschnitt "Geometrie"](geometry-section.md)
...
- [Abschnitt "Hyperlinks"](hyperlinks-section.md)
    
- [Abschnitt "Image Properties"](image-properties-section.md)
    
- [Abschnitt "Layer Membership"](layer-membership-section.md)
    
- [Abschnitt "Layers"](layers-section.md)
...
- [Abschnitt "Page Layout"](page-layout-section.md)
    
- [Abschnitt "Page Properties"](page-properties-section.md)
    
- [Abschnitt "Paragraph"](paragraph-section.md)
    
- [Abschnitt "Print Properties"](print-properties-section.md)
...
- [Abschnitt "Shape Data"](shape-data-section.md)
    
- [Abschnitt "Shape Layout"](shape-layout-section.md)
    
- [Abschnitt "Shape Transform"](shape-transform-section.md)
    
- [Abschnitt "Style Properties"](style-properties-section.md)
    
- [Abschnitt "Tabs"](tabs-section.md)
    
- [Abschnitt "Text Block Format"](text-block-format-section.md)
    
- [Abschnitt "Text Fields"](text-fields-section.md)
