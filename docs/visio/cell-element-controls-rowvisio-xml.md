...
Enthält eine Eigenschaft für einen bestimmten Steuerpunkt, der für eine Form definiert ist.
...
|:-----|:-----|:-----|
|[Row-Element (Controls-Abschnitt)](row-element-controls-sectionvisio-xml.md) <br/> |[ControlRow_Type](controlrow_type-complextypevisio-xml.md) <br/> |Enthält eine Eigenschaft für einen bestimmten Steuerpunkt, der für eine Form definiert ist.  <br/> |
...
|xCon  <br/> |Gibt an, welche Art von Verhalten die x-Koordinate des Steuerelements zeigt, nachdem der Ziehpunkt verschoben wurde.  <br/> |Keine.  <br/> |
...
|YCon  <br/> |Gibt den Verhaltenstyp an, den die y-Koordinate des Steuerpunkts zeigt, nachdem das Handle verschoben wurde.  <br/> |Keine.  <br/> |
