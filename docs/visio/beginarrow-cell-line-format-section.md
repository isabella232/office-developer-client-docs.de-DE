...
Gibt an, ob eine Linie eine Pfeilspitze oder eine andere Linienendformatierung an ihrem ersten Scheitelpunkt hat. Geben eine Zahl zwischen 0 und 45 oder die Funktion Verwendung durch den Namen des ein benutzerdefiniertes Linienende, oder verwenden Sie das Dialogfeld **Linie** . 
...
Wenn Sie einen Verweis auf die Zelle BeginArrow nach Namen aus einer anderen Formel oder aus einem Programm mithilfe der **CellsU** -Eigenschaft erhalten möchten, verwenden Sie Folgendes: 
