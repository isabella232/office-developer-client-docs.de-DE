...
Wie im Abschnitt ["Scratch"](scratch-section.md) kann im Abschnitt **User-defined Cells** auf viele verschiedene Arten von der Lösung verwendet werden. Der Vorteil des Abschnitts **User-defined Cells** ist, dass benannt werden können. Zellen im Abschnitt **"Scratch"** können nicht mit dem Namen. 
