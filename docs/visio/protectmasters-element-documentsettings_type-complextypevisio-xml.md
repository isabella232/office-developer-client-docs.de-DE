...
Gibt an, ob der Benutzer das Erstellen, bearbeiten oder Löschen von Master-Shapes verhindert. Der Benutzer kann unabhängig von dieser Einstellung immer noch neue Formen aus einem Master-Shape erstellen. 
  
Der Bereich der möglichen Werte für dieses Element ist entweder "0" oder "1". Der Wert "0" gibt an, dass Benutzer Master-Shapes erstellen, bearbeiten oder löschen können. Der Wert "1" gibt an, dass Benutzer Master-Shapes nicht erstellen, bearbeiten oder löschen können.
