...
---
# <a name="yrulerorigin-cell-ruler-amp-grid-section"></a>Zelle "YRulerOrigin" (Lineal &amp; Rasterabschnitt)

Gibt den Nullpunkt auf der y-Achse-Achsenlineal des Zeichenblatts an.
...
Wenn Sie einen Verweis auf die Zelle YRulerOrigin nach Namen aus einer anderen Formel oder aus einem Programm mithilfe der **CellsU** -Eigenschaft erhalten möchten, verwenden Sie Folgendes: 
  
|||
|:-----|:-----|
|Zellenname:  <br/> |YRulerOrigin  <br/> |
   
Wenn Sie einen Verweis auf die Zelle YRulerOrigin aus einem Programm nach Index erhalten möchten, verwenden Sie die **CellsSRC** -Eigenschaft mit folgenden Argumenten: 
