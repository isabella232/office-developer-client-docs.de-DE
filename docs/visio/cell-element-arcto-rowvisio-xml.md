...
---
# <a name="cell-element-arcto-row-visio-xml"></a>Cell-Element (ArcTo-Zeile) (' Visio XML ')

Enthält die x-Koordinate, y-Koordinate oder den Bogen eines kreisförmigen Bogens.
...
|**Element**|**Typ**|**Beschreibung**|
|:-----|:-----|:-----|
|[RefBy](refby-element-cell_type-complextypevisio-xml.md) <br/> |[RefBy_Type](refby_type-complextypevisio-xml.md) <br/> |Enthält die x-Koordinate, y-Koordinate oder den Bogen eines kreisförmigen Bogens.  <br/> |
