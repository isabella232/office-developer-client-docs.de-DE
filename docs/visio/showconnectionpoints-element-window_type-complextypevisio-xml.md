...
ms.locfileid: "59627415"
---
# <a name="showconnectionpoints-element-window_type-complextype-visio-xml"></a>ShowConnectionPoints-Element (Window_Type complexType) (Visio XML)
...
|||
|:-----|:-----|
|**Elementtyp** <br/> |[ShowConnectionPoints_Type](showconnectionpoints_type-complextypevisio-xml.md) <br/> |
