---
title: Zellenelement (Abschnitt "User-defined Cells") (Visio XML)
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "59594791"
---
# <a name="cell-element-user-defined-cells-section-visio-xml"></a>Zellenelement (Abschnitt "User-defined Cells") (Visio XML)

Eine Eigenschaft einer vom Benutzer angegebenen Information, auf die von anderen Zellen und Add-On-Tools verwiesen werden kann.
...
|:-----|:-----|:-----|
|[Zeilenelement (Abschnitt "User-defined Cells")](row-element-user-defined-cells-sectionvisio-xml.md) <br/> |[UserRow_Type](userrow_type-complextypevisio-xml.md) <br/> |Eine Eigenschaft einer vom Benutzer angegebenen Information, auf die von anderen Zellen und Add-On-Tools verwiesen werden kann.  <br/> |
