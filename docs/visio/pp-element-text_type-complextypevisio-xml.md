...
---
# <a name="pp-element-texttype-complextype-visio-xml"></a>PP-Element (text_type complexType) (Visio XML)

Gibt den Anfang einer Absatzeigenschaften Ausführung an. Die Ausführung wird bis zum Ende des Texts oder bis zum nächsten Tag definiert.
