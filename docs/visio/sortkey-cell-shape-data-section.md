...
Enthält eine Zeichenfolge, die die Reihenfolge beeinflusst, in der Elemente im Fenster **Shape-Daten** aufgeführt sind. 
...
Nachfolgend sehen Sie ein Beispiel der Verwendung von Sortierschlüsseln um die Shape-Daten im Fenster **Shape-Daten** in der Reihenfolge anzuzeigen: Artikelnummer, Menge, Preis. 
