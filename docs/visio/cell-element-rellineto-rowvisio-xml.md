...
---
# <a name="cell-element-rellineto-row-visio-xml"></a>Zellenelement (RelLineTo Zeile) ("Visio XML")

Enthält X- oder y-Koordinaten des Endscheitelpunkts eines geraden Linienabschnitts relativ zur Breite und Höhe des Shapes.
...
|:-----|:-----|:-----|
|[Row-Element ("Geometry")](row-element-geometry-sectionvisio-xml.md) <br/> |[RelLineTo_Type](rellineto_type-complextypevisio-xml.md) <br/> |Enthält X- oder y-Koordinaten des Endscheitelpunkts eines geraden Linienabschnitts relativ zur Breite und Höhe des Shapes.  <br/> |
...
|:-----|:-----|:-----|
|X  <br/> |Die X-Koordinate des Endscheitelpunkts eines geraden Linienabschnitts relativ zu der Breite des Shapes.  <br/> |[RelLineTo Zeile (Abschnitt "Geometry")](rellineto-row-geometry-section.md) <br/> |
|v  <br/> |Die y-Koordinate des Endscheitelpunkts eines geraden Linienabschnitts relativ zur Höhe des Shapes.  <br/> |[RelLineTo Zeile (Abschnitt "Geometry")](rellineto-row-geometry-section.md) <br/> |
