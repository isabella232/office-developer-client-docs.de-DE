...
|:-----|:-----|:-----|
|X  <br/> |Die X-Koordinate des Endscheitelpunkts eines geraden Linienabschnitts relativ zu der Breite des Shapes.  <br/> |[RelLineTo Row (Geometry Section)](rellineto-row-geometry-section.md) <br/> |
|v  <br/> |Die y-Koordinate des Endscheitelpunkts eines geraden Linienabschnitts relativ zur Höhe des Shapes.  <br/> |[RelLineTo Row (Geometry Section)](rellineto-row-geometry-section.md) <br/> |
