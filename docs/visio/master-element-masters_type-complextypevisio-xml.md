...
|[Icon](icon-element-master_type-complextypevisio-xml.md) <br/> |[Icon_Type](icon_type-complextypevisio-xml.md) <br/> |Gibt ein MIME-codiertes Binär Symbol (Multipurpose Internet Mail Extensions) (im ICO-Format) für ein **Master** -oder **MasterShortcut** -Element in einem Dokument an.  <br/> |
...
|BaseID  <br/> |XSD: Zeichenfolge  <br/> |Optional  <br/> |Eine GUID (Globally Unique Identifier), die den Master in allen Dokumenten identifiziert.  <br/> |Werte des XSD: String-Typs.  <br/> |
|Ausgeblendet  <br/> |XSD: Boolean  <br/> |Optional  <br/> |Gibt an, ob der Master in der Benutzeroberfläche ausgeblendet ist.  <br/> |Werte des XSD: Boolean-Typs.  <br/> |
...
|IconUpdate  <br/> |XSD: Boolean  <br/> |Optional  <br/> |Gibt an, ob das Symbol automatisch vom Master selbst generiert wird.  <br/> |Werte des XSD: Boolean-Typs.  <br/> |
...
|MatchByName  <br/> |XSD: Boolean  <br/> |Optional  <br/> |Bestimmt, wie Microsoft Visio entscheidet, ob ein Dokumentmaster bereits vorhanden ist, wenn eine Instanz eines Masters auf dem Zeichenblatt abgelegt wird.  <br/> |Werte des XSD: Boolean-Typs.  <br/> |
...
|UniqueID  <br/> |XSD: Zeichenfolge  <br/> |Optional  <br/> |Eine GUID, die den Master innerhalb des Dokuments identifiziert.  <br/> |Werte des XSD: String-Typs.  <br/> |
