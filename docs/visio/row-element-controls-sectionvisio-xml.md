...
---
# <a name="row-element-controls-section-visio-xml"></a>Row-Element (Controls-Abschnitt) (Visio XML)

Enthält die Zellen für einen bestimmten Steuerpunkt, der für eine Form definiert ist.
...
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |Enthält die Zellen für einen bestimmten Steuerpunkt, der für eine Form definiert ist.  <br/> |
   
### <a name="child-elements"></a>Untergeordnete Elemente

|**Element**|**Typ**|**Beschreibung**|
|:-----|:-----|:-----|
|[Cell](cell-element-controls-rowvisio-xml.md) <br/> |[Cell_Type](cell_type-complextypevisio-xml.md) <br/> |Enthält eine Eigenschaft für einen bestimmten Steuerpunkt, der für eine Form definiert ist.  <br/> |
