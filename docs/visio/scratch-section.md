...
In diesem Abschnitt können Sie über das Dialogfeld **Abschnitt einfügen** hinzufügen. Mit der rechten Maustaste in das ShapeSheet-Fenster, und klicken Sie dann auf **Abschnitt einfügen**.
...
|**Cell**|**Wenn Sie eingeben**|**Behandlung durch Visio**|**Ergebnis**|
|:-----|:-----|:-----|:-----|
