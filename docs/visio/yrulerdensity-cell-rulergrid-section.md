...
---
# <a name="yrulerdensity-cell-ruler-amp-grid-section"></a>Zelle "YRulerDensity" (Lineal &amp; Rasterabschnitt)
...
Wenn Sie einen Verweis auf die Zelle YRulerDensity nach Namen aus einer anderen Formel oder aus einem Programm mithilfe der **CellsU** -Eigenschaft erhalten möchten, verwenden Sie Folgendes: 
  
|||
|:-----|:-----|
|Zellenname:  <br/> |YRulerDensity  <br/> |
   
Wenn Sie einen Verweis auf die Zelle YRulerDensity aus einem Programm nach Index erhalten möchten, verwenden Sie die **CellsSRC** -Eigenschaft mit folgenden Argumenten: 
