...
Enthält x-oder y-Koordinaten des letzten Kommas einer Polylinie oder einer Polylinien Formel.
...
|:-----|:-----|:-----|
|[Row-Element (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[PolylineTo_Type](polylineto_type-complextypevisio-xml.md) <br/> |Enthält x-oder y-Koordinaten des letzten Kommas einer Polylinie oder einer Polylinien Formel.  <br/> |
