...
---
# <a name="cell-element-polylineto-row-visio-xml"></a>Cell-Element (PolyLineTo-Zeile) (' Visio XML ')

Enthält x-oder y-Koordinaten des letzten Punkts einer Polylinie oder einer Polylinie.
...
|:-----|:-----|:-----|
|[Row-Element (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[PolylineTo_Type](polylineto_type-complextypevisio-xml.md) <br/> |Enthält x-oder y-Koordinaten des letzten Punkts einer Polylinie oder einer Polylinie.  <br/> |
