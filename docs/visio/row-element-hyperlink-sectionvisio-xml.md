...
Enthält Elemente zum Erstellen mehrerer Sprünge zwischen einem Shape oder einer Zeichenseite und einem anderen Zeichenblatt, einer anderen Datei oder einer Website.
...
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |Enthält Elemente zum Erstellen mehrerer Sprünge zwischen einem Shape oder einer Zeichenseite und einem anderen Zeichenblatt, einer anderen Datei oder einer Website.  <br/> |
   
### <a name="child-elements"></a>Untergeordnete Elemente

|**Element**|**Typ**|**Beschreibung**|
|:-----|:-----|:-----|
|[Cell](cell-element-hyperlink-rowvisio-xml.md) <br/> |[Cell_Type](cell_type-complextypevisio-xml.md) <br/> |Enthält die Informationen für einen einzelnen Hyperlink, der einer Form zugeordnet ist.  <br/> |
