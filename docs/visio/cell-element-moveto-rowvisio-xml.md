...
ms.locfileid: "25382967"
---
# <a name="cell-element-moveto-row-visio-xml"></a>Zellenelement (Zeilen MoveTo-Zeile) ("Visio XML")

Enthält die x- oder y-Koordinaten des ersten Scheitelpunkts eines Shapes oder stellt die x- oder y-Koordinaten des ersten Scheitelpunkts hinter einer Pfadlücke dar.
...
|:-----|:-----|:-----|
|[Row-Element ("Geometry")](row-element-geometry-sectionvisio-xml.md) <br/> |[MoveTo_Type](moveto_type-complextypevisio-xml.md) <br/> |Enthält die x- oder y-Koordinaten des ersten Scheitelpunkts eines Shapes oder stellt die x- oder y-Koordinaten des ersten Scheitelpunkts hinter einer Pfadlücke dar.  <br/> |
...
|:-----|:-----|:-----|
|X  <br/> |Wenn die Zeile **MoveTo** die erste Zeile im Abschnitt ist, stellt die Zelle **X** die X-Koordinate des ersten Scheitelpunkts eines Shapes dar. Wenn die Zeile **MoveTo** zwischen zwei Zeilen angezeigt wird, stellt die Zelle **X** die X-Koordinate des ersten Scheitelpunkts hinter der Pfadlücke dar.  <br/> |[Zeile "MoveTo" (Abschnitt "Geometry")](moveto-row-geometry-section.md) <br/> |
|v  <br/> |Wenn die Zeile **MoveTo** die erste Zeile im Abschnitt ist, stellt die Zelle **Y** die y-Koordinate des ersten Scheitelpunkts eines Shapes dar. Wenn die Zeile **MoveTo** zwischen zwei Zeilen angezeigt wird, stellt die Zelle **Y** die y-Koordinate des ersten Scheitelpunkts hinter der Pfadlücke dar.  <br/> |[Zeile "MoveTo" (Abschnitt "Geometry")](moveto-row-geometry-section.md) <br/> |
