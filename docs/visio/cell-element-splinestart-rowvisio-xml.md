...
|:-----|:-----|:-----|
|X  <br/> |Zeigen Sie die X-Koordinate des zweiten Kontrollpunkts eines Splines.  <br/> |[Zeile "SplineStart" (Abschnitt "Geometry")](splinestart-row-geometry-section.md) <br/> |
|v  <br/> |Zeigen Sie die y-Koordinate des zweiten Kontrollpunkts eines Splines.  <br/> |[Zeile "SplineStart" (Abschnitt "Geometry")](splinestart-row-geometry-section.md) <br/> |
...
|C  <br/> |Der letzte Knoten eines Splines.  <br/> |[RelEllipticalArcTo Zeile (Abschnitt "Geometry")](splinestart-row-geometry-section.md) <br/> |
