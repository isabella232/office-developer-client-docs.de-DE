...
|1  <br/> |Umleiten Sie (Manuelles umleiten) erforderlichen  <br/> |**visSLOConFixedRerouteAsNeeded** <br/> |
...
Wenn Sie einen Verweis auf die Zelle ConFixedCode nach Namen aus einer anderen Formel oder aus einem Programm mithilfe der **CellsU** -Eigenschaft erhalten möchten, verwenden Sie Folgendes: 
  
|||
|:-----|:-----|
|Zellenname:  <br/> |ConFixedCode  <br/> |
   
Wenn Sie einen Verweis auf die Zelle ConFixedCode aus einem Programm nach Index erhalten möchten, verwenden Sie die **CellsSRC** -Eigenschaft mit folgenden Argumenten: 
