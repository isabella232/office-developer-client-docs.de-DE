...
|[PublishSettings](publishsettings-element-visiodocument_type-complextypevisio-xml.md) <br/> |[PublishSettings_Type](publishsettings_type-complextypevisio-xml.md) <br/> |Gibt den Satz von Zeichnungs Seiten an, die angezeigt werden, und einen Satz von Recordsets, die in einer Zeichnung aktualisiert werden können.  <br/> |
