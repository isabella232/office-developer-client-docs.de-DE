...
|[PublishSettings](publishsettings-element-visiodocument_type-complextypevisio-xml.md) <br/> |[PublishSettings_Type](publishsettings_type-complextypevisio-xml.md) <br/> |Gibt den Satz von Zeichnungs Seiten an, die angezeigt werden können, und eine Gruppe von Recordsets, die in einer Zeichnung aktualisiert werden können.  <br/> |
