...
---
# <a name="xrulerorigin-cell-ruler-amp-grid-section"></a>XRulerOrigin Cell (Ruler &amp; Grid Section)
...
Wenn Sie einen Verweis auf die Zelle XRulerOrigin aus einer anderen Formel oder aus einem Programm mithilfe der CellsU-Eigenschaft nach Namen erhalten möchten, verwenden Sie Folgendes: 
  
|||
|:-----|:-----|
|Zellenname:  <br/> |XRulerOrigin  <br/> |
   
Wenn Sie einen Verweis auf die Zelle XRulerOrigin aus einem Programm heraus nach Index erhalten möchten, verwenden Sie die CellsSRC-Eigenschaft mit folgenden Argumenten: 
