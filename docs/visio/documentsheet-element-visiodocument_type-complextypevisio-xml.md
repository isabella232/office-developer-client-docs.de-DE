...
|Name  <br/> |XSD: Zeichenfolge  <br/> |Optional  <br/> |Gibt den sprachabhängigen Namen des DocumentSheet an.  <br/> |Werte des XSD: String-Typs.  <br/> |
|NameU  <br/> |XSD: Zeichenfolge  <br/> |Optional  <br/> |Gibt den sprachunabhängigen Namen des DocumentSheet an.  <br/> |Werte des XSD: String-Typs.  <br/> |
|UniqueID  <br/> |XSD: Zeichenfolge  <br/> |Optional  <br/> |Optionaler string-Wert. Eine GUID (Globally Unique Identifier), die die Form identifiziert.  <br/> |Werte des XSD: String-Typs.  <br/> |
