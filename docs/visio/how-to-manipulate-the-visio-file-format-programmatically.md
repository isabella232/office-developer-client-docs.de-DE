...
6. <span data-ttu-id="9ecb0-148">Wählen Sie das neue Prozess-Shape im Zeichenbereich aus, und geben Sie „Eine Aufgabe ausführen“ ein.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-148">Select the new Process shape on the drawing canvas and type 'Perform some task'.</span></span>
...
### <a name="to-create-a-new-solution-in-visual-studio-2012"></a><span data-ttu-id="9ecb0-161">So öffnen Sie eine neue Lösung in Visual Studio 2012</span><span class="sxs-lookup"><span data-stu-id="9ecb0-161">To create a new solution in Visual Studio 2012</span></span>
...
<span data-ttu-id="9ecb0-188">Verwenden Sie den Code in dem folgenden Verfahren, um ein **PackagePartCollection**-Objekt aus der **Package** als Sammlung abzurufen, durchlaufen Sie die **PackagePart**-Objekte in der Sammlung, und schreiben Sie den URI und Inhaltstyp von allen **PackagePart** in die Konsole.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-188">Use the code in the following procedure to get a **PackagePartCollection** object from the **Package** as a collection, iterate through the **PackagePart** objects in the collection, and write the URI and content type of each **PackagePart** to the console.</span></span> 
...
### <a name="to-select-a-specific-element-in-a-package-part"></a><span data-ttu-id="9ecb0-243">So wählen Sie ein bestimmtes Element in einem Paketteil aus</span><span class="sxs-lookup"><span data-stu-id="9ecb0-243">To select a specific element in a package part</span></span>
...
1. <span data-ttu-id="9ecb0-313">Fügen Sie nach der `SaveXDocumentToPart`-Methode in der **Program**-Klasse (oder **Module1** in Visual Basic) aus dem vorherigen Schritt die folgende Methode hinzu.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-313">After the  `SaveXDocumentToPart` method in the **Program** class (or **Module1** in Visual Basic) from the previous step, add the following method.</span></span> 
...
3. <span data-ttu-id="9ecb0-315">Ersetzen Sie den Code aus dem vorherigen Beispiel im **using**-Block in der **Main**-Methode der **Program**-Klasse (der **Using**-Block der **Main**-Methode in **Module1** in Visual Basic) durch den folgenden Code:</span><span class="sxs-lookup"><span data-stu-id="9ecb0-315">Replace the code from the previous example in the **using** block in the **Main** method of the **Program** class (the **Using** block of the **Main** method in **Module1** in Visual Basic), with the following code.</span></span> 
...
4. <span data-ttu-id="9ecb0-316">Drücken Sie F5 zum Debuggen der Lösung.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-316">Choose the F5 key to debug the solution.</span></span> <span data-ttu-id="9ecb0-317">Wenn das Programm die Ausführung abgeschlossen hat, drücken Sie eine beliebige Taste, um es zu verlassen.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-317">When the program has completed running, choose any key to exit.</span></span>
    
5. <span data-ttu-id="9ecb0-318">Öffnen Sie die Datei „Visio-Paket.vsdx“ in Visio 2013.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-318">Open the Visio Package.vsdx file in Visio 2013.</span></span> 
    
<span data-ttu-id="9ecb0-319">Das Anfangs-/Ende-Shape sollte sich nun 5 cm vom unteren Rand der Zeichnung befinden.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-319">The Start/End shape should now be 2 inches from the bottom edge of the drawing.</span></span> <span data-ttu-id="9ecb0-320">Der Verbinder zwischen dem Anfangs-/Ende-Shape und dem Prozess-Shape sollte so umgeleitet worden sein, dass die Änderung im Layout berücksichtigt wird.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-320">The connector between the Start/End shape and the Process shape should have rerouted to accommodate the change in layout.</span></span> <span data-ttu-id="9ecb0-321">Wenn die **RecalcDocument**-Eigenschaft nicht zu der Datei hinzugefügt worden wäre, wäre die Shape-Position geändert worden, aber der Verbinder wäre nicht an die neue Position des Shapes umgeleitet worden.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-321">If the **RecalcDocument** property had not been added to the file, the shape position would have been changed, but the connector would not have rerouted to the new location of the shape.</span></span> 
  
## <a name="add-a-new-package-part-to-a-package"></a><span data-ttu-id="9ecb0-322">Hinzufügen eines neuen Paketteils zu einem Paket</span><span class="sxs-lookup"><span data-stu-id="9ecb0-322">Add a new package part to a package</span></span>
<span data-ttu-id="9ecb0-323"><a name="vis15_ManipulateFF_AddNewPart"> </a></span><span class="sxs-lookup"><span data-stu-id="9ecb0-323"><a name="vis15_ManipulateFF_AddNewPart"> </a></span></span>

<span data-ttu-id="9ecb0-324">Eines der häufigsten Szenarien für das Ändern eines Dateipakets ist das Hinzufügen eines neuen Dokumentteils zum Paket.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-324">One of the most common scenarios for modifying a file package is adding a new document part to the package.</span></span> <span data-ttu-id="9ecb0-325">Wenn Sie beispielsweise eine Seite zu der Visio-Zeichnung hinzufügen möchten, indem Sie dem Paket Inhalte hinzufügen, müssen Sie ein Seiteninhaltsteil zu dem Paket hinzufügen.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-325">For example, if you want to add a page to the Visio drawing by adding content to the package, you need to add a Page Contents part to the package.</span></span> 
  
<span data-ttu-id="9ecb0-326">Das Verfahren zum Hinzufügen eines neuen Teils zu dem Paket ist einfach:</span><span class="sxs-lookup"><span data-stu-id="9ecb0-326">The process for adding a new part to the package is straightforward:</span></span> 
  
1. <span data-ttu-id="9ecb0-327">Sie erstellen das XML-Dokument mit den Daten für **PackagePart**.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-327">You create the XML document with the data for the **PackagePart**.</span></span> <span data-ttu-id="9ecb0-328">Sie müssen besonders auf die XML-Namespaces Acht geben, die das Schema für den bestimmten Typ des XML-Dokuments festlegen, den Sie erstellen.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-328">You need to pay special attention to the XML namespaces that govern the schema for the specific type of XML document that you create.</span></span>
    
2. <span data-ttu-id="9ecb0-329">Sie erstellen eine neue Datei für die XML-Daten und speichern die Datei an einem Speicherort im **Package**.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-329">You create a new file to contain the XML and save the file to a location in the **Package**.</span></span>
    
3. <span data-ttu-id="9ecb0-330">Sie erstellen die erforderlichen Beziehungen zwischen dem neuen **PackagePart** und dem **Package** oder anderen **PackagePart**-Objekten.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-330">You create the necessary relationships between the new **PackagePart** and the **Package** or other **PackagePart** objects.</span></span> 
    
4. <span data-ttu-id="9ecb0-p144">Sie aktualisieren alle vorhandenen Teile, die auf das neue Teil verweisen müssen. Wenn Sie beispielsweise ein neues Seiteninhaltsteil (eine neue Seite) zu der Datei hinzufügen, müssen Sie auch das Seitenindexteil (/visio/pages/pages.xml-Datei) aktualisieren, um die richtigen Informationen zu der neuen Seite einzuschließen.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-p144">You update any existing parts that need to reference the new part. For example, if you add a new Page Contents part (a new page) to the file, you also need to update the Page Index part (/visio/pages/pages.xml file) to include the correct information about the new page.</span></span>
    
<span data-ttu-id="9ecb0-333">Gehen Sie folgendermaßen vor, um ein neues Menübanderweiterungsteil in der Visio-Datei zu erstellen.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-333">Use the following procedure to create a new Ribbon Extensibility part in the Visio file.</span></span> <span data-ttu-id="9ecb0-334">Das neue Menübanderweiterungsteil fügt dem Menüband eine neue Registerkarte mit einer einzigen Gruppe hinzu, die eine einzige Schaltfläche enthält.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-334">The new Ribbon Extensibility part adds to the ribbon a new tab with a single group that contains a single button.</span></span>
  
### <a name="to-create-a-new-package-part"></a><span data-ttu-id="9ecb0-335">So erstellen Sie ein neues Paketteil</span><span class="sxs-lookup"><span data-stu-id="9ecb0-335">To create a new package part</span></span>

1. <span data-ttu-id="9ecb0-336">Fügen Sie nach der `CheckForRecalc`-Methode in der **Program**-Klasse (oder **Module1** in Visual Basic) aus dem vorherigen Verfahren die folgende Methode hinzu.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-336">After the  `CheckForRecalc` method in the **Program** class (or **Module1** in Visual Basic) from the previous procedure, add the following method.</span></span> 
...
2. <span data-ttu-id="9ecb0-337">Fügen Sie nach der `CreateCustomUI`-Methode in der **Program**-Klasse (oder **Module1** in Visual Basic) aus dem vorherigen Schritt die folgende Methode hinzu.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-337">After the  `CreateCustomUI` method in the **Program** class (or **Module1** in Visual Basic) from the previous step, add the following method.</span></span> 
...
3. <span data-ttu-id="9ecb0-338">Ersetzen Sie den gesamten Code im **using**-Block in der **Main**-Methode der **Program**-Klasse (der **Using**-Block der **Main**-Methode in **Module1** in Visual Basic) durch den folgenden Code:</span><span class="sxs-lookup"><span data-stu-id="9ecb0-338">Replace all the code in the **using** block in the **Main** method of the **Program** class (the **Using** block of the **Main** method in **Module1** in Visual Basic), with the following code.</span></span> 
...
4. <span data-ttu-id="9ecb0-339">Drücken Sie F5 zum Debuggen der Lösung.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-339">Choose the F5 key to debug the solution.</span></span> <span data-ttu-id="9ecb0-340">Wenn das Programm die Ausführung abgeschlossen hat, drücken Sie eine beliebige Taste, um es zu verlassen.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-340">When the program has completed running, choose any key to exit.</span></span>
    
5. <span data-ttu-id="9ecb0-341">Öffnen Sie die Datei „Visio-Paket.vsdx“ in Visio 2013, und wählen Sie dann die Registerkarte **Benutzerdefiniert** aus.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-341">Open the Visio Package.vsdx file in Visio 2013, and then choose the **CUSTOM** tab.</span></span> 
    
<span data-ttu-id="9ecb0-342">Das benutzerdefinierte Menüband sieht wie in Abbildung 2 aus, wenn die Datei in Visio 2013 geöffnet wird.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-342">The custom ribbon looks like Figure 2 when the file is opened in Visio 2013.</span></span>
  
 <span data-ttu-id="9ecb0-343">**Abbildung 2. Benutzerdefinierte Registerkarte im Visio 2013-Menüband**</span><span class="sxs-lookup"><span data-stu-id="9ecb0-343">**Figure 2. Custom tab in the Visio 2013 ribbon**</span></span>
  
![Eine benutzerdefinierte Registerkarte im Menüband](media/vis15_CustomRibbonTab.PNG)
  
<span data-ttu-id="9ecb0-345">Der von der `CreateCustomUI`-Methode erstellte XML-Code sieht wie folgt aus.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-345">The XML created by the  `CreateCustomUI` method looks like the following.</span></span> 
...
## <a name="acknowledgements"></a><span data-ttu-id="9ecb0-346">Danksagung</span><span class="sxs-lookup"><span data-stu-id="9ecb0-346">Acknowledgements</span></span>
<span data-ttu-id="9ecb0-347"><a name="vis15_ManipulateFF_Ackn"> </a></span><span class="sxs-lookup"><span data-stu-id="9ecb0-347"><a name="vis15_ManipulateFF_Ackn"> </a></span></span>

<span data-ttu-id="9ecb0-348">Wir möchten uns für die Mitwirkung von Visio MVP **Al Edlund** bei der Erstellung der Codebeispiele bedanken, die in diesem technischen Artikel enthalten sind.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-348">We would like to recognize the contribution and input of Visio MVP **Al Edlund** in creating the code examples contained in this technical article.</span></span> <span data-ttu-id="9ecb0-349">Al Edlund ist ein anerkannter Experte für die Bearbeitung des Visio-Dateiformats, einschließlich des Visio-XML-Zeichnungsformats (.vdx) und des neuen Visio-Dateiformats (vsdx).</span><span class="sxs-lookup"><span data-stu-id="9ecb0-349">Al is a recognized expert in manipulating the Visio file format, including both the Visio XML Drawing format (.vdx) and the new Visio file format (.vsdx).</span></span> <span data-ttu-id="9ecb0-350">Er hat Projekte erstellt, bei denen die Visio-Dateiformate programmgesteuert durchsucht und die Strukturen darin verfügbar gemacht werden.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-350">Al has created projects that explore the Visio file formats programmatically and exposes the structures inside.</span></span> 
  
<span data-ttu-id="9ecb0-351">Weitere Informationen zur Arbeit von Al Edlund im Zusammenhang mit dem Visio-Dateiformat finden Sie weiter unten in den Links im Abschnitt „Zusätzliche Ressourcen“.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-351">For more information about Al's work with the Visio file format, see the links in the Additional Resources section that follows.</span></span>
  
## <a name="see-also"></a><span data-ttu-id="9ecb0-352">Siehe auch</span><span class="sxs-lookup"><span data-stu-id="9ecb0-352">See also</span></span>
<span data-ttu-id="9ecb0-353"><a name="vis15_ManipulateFF_Additional"> </a></span><span class="sxs-lookup"><span data-stu-id="9ecb0-353"><a name="vis15_ManipulateFF_Additional"> </a></span></span>

- <span data-ttu-id="9ecb0-354">Von Al Edlund:</span><span class="sxs-lookup"><span data-stu-id="9ecb0-354">By Al Edlund:</span></span>
    
  - <span data-ttu-id="9ecb0-355">[pkgVisio – Visio 2013-XML-Bearbeitung](https://pkgvisio.codeplex.com/documentation)-Projekt auf CodePlex.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-355">[pkgVisio - Visio 2013 XML manipulation](https://pkgvisio.codeplex.com/documentation) project on CodePlex.</span></span> 
    
  - <span data-ttu-id="9ecb0-356">[pkgVisio_pt1 ](https://www.youtube.com/watch?v=7LvDKJuP9oQ&amp;feature=youtu.be)-Video auf YouTube.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-356">[pkgVisio_pt1 ](https://www.youtube.com/watch?v=7LvDKJuP9oQ&amp;feature=youtu.be) video on YouTube.</span></span> 
    
  - <span data-ttu-id="9ecb0-357">[pkgVisio_pt2 ](https://www.youtube.com/watch?v=ZIWSXhNSkG8&amp;feature=youtu.be)-Video auf YouTube.</span><span class="sxs-lookup"><span data-stu-id="9ecb0-357">[pkgVisio_pt2 ](https://www.youtube.com/watch?v=ZIWSXhNSkG8&amp;feature=youtu.be) video on YouTube.</span></span> 
    
- [<span data-ttu-id="9ecb0-358">Visio Developer Center</span><span class="sxs-lookup"><span data-stu-id="9ecb0-358">Visio Developer Center</span></span>](https://developer.microsoft.com/visio)
    
- <span data-ttu-id="9ecb0-359">[Bearbeiten von Dokumenten im Office Open XML-Format](https://docs.microsoft.com/previous-versions/office/developer/office-2007/aa982683(v=office.12))</span><span class="sxs-lookup"><span data-stu-id="9ecb0-359">[Manipulate Office Open XML Formats Documents](https://docs.microsoft.com/previous-versions/office/developer/office-2007/aa982683(v=office.12))</span></span>
    
- <span data-ttu-id="9ecb0-360">[Erstellen eines Dokuments mit Namespaces (C#) (LINQ to XML)](https://docs.microsoft.com/previous-versions/bb387075(v=vs.140))</span><span class="sxs-lookup"><span data-stu-id="9ecb0-360">[Create a Document with Namespaces (C#) (LINQ to XML)](https://docs.microsoft.com/previous-versions/bb387075(v=vs.140))</span></span>
    
- <span data-ttu-id="9ecb0-361">[Hinzufügen von benutzerdefinierten XML-Elementen zu Dokumenten ohne Starten von Microsoft Office](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2008/bb608597(v=vs.90))</span><span class="sxs-lookup"><span data-stu-id="9ecb0-361">[Add Custom XML Parts to Documents Without Starting Microsoft Office](https://docs.microsoft.com/previous-versions/visualstudio/visual-studio-2008/bb608597(v=vs.90))</span></span>
