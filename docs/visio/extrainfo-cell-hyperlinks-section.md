...
Wenn Sie einen Verweis auf die Zelle ExtraInfo aus einem Programm heraus nach Index erhalten möchten, verwenden Sie die CellsSRC-Eigenschaft mit folgenden Argumenten: 
