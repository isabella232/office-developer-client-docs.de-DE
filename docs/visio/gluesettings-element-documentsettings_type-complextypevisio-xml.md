...
ms.locfileid: "25398143"
---
# <a name="gluesettings-element-documentsettingstype-complextype-visio-xml"></a>GlueSettings-Element (DocumentSettings_Type ComplexType) ("Visio XML")

Gibt die Objekte, denen Shapes verbunden werden, wenn die Klebefunktion im Dokument aktiviert ist.
