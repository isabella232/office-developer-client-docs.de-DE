...
---
# <a name="cell-element-line-gradient-section-visio-xml"></a>Cell-Element (Abschnitt "Streckenverlauf") (Visio XML)

Enthält die Farbe, die Transparenz oder die Position eines Farbverlaufsstopps für einen linearen Farbverlauf.
...
|:-----|:-----|:-----|
|[Zeilenelement (Abschnitt "Zeilen Verlauf")](row-element-line-gradient-sectionvisio-xml.md) <br/> |[LineGradientRow_Type](linegradientrow_type-complextypevisio-xml.md) <br/> |Enthält die Farbe, die Transparenz und die Position eines Farbverlaufsstopps für einen linearen Farbverlauf.  <br/> |
...
|:-----|:-----|:-----|
|GradientStopColor  <br/> |Der Farbwert des Farbverlaufsstopps.  <br/> |[Zeile "Farbverlaufsstopp" (Abschnitt "Zeilen Verlauf")](gradient-stop-row-line-gradient-section.md) <br/> |
|GradientStopColorTrans  <br/> |Der Grad der Transparenz der Farbverlaufs Unterbrechung als Prozentsatz.  <br/> |[Zeile "Farbverlaufsstopp" (Abschnitt "Zeilen Verlauf")](gradient-stop-row-line-gradient-section.md) <br/> |
|GradientStopPosition  <br/> |Die Position des Farbverlaufsstopps entlang der Richtung des Farbverlaufs, als Prozentsatz vom Ursprungsort des Farbverlaufs bis zum äußeren Rand des Farbverlaufs.  <br/> |[Zeile "Farbverlaufsstopp" (Abschnitt "Zeilen Verlauf")](gradient-stop-row-line-gradient-section.md) <br/> |
