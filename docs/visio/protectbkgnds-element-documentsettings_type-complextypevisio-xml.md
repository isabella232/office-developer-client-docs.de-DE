...
---
# <a name="protectbkgnds-element-documentsettingstype-complextype-visio-xml"></a>ProtectBkgnds-Element (DocumentSettings_Type ComplexType) ("Visio XML")

Gibt an, ob der Benutzer löschen oder Bearbeiten von Hintergrundblätter verhindert wird.
