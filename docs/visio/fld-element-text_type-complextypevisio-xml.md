...
---
# <a name="fld-element-text_type-complextype-visio-xml"></a>fld-Element (Text_Type complexType) (Visio XML)

Gibt eine Textfeldeinfügemarke für das entsprechende **Field-Element** an. 
