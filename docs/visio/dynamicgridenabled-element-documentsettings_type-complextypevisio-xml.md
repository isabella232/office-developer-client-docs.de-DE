...
---
# <a name="dynamicgridenabled-element-documentsettings_type-complextype-visio-xml"></a>DynamicGridEnabled-Element (DocumentSettings_Type complexType) (Visio XML)

Gibt an, ob das dynamische Rasterfeature für ein Dokument aktiviert ist.
