...
ms.locfileid: "25383184"
---
# <a name="row-element-line-gradient-section-visio-xml"></a>Row-Element (Zeile Farbverlauf Abschnitt) ("Visio XML")
...
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |Enthält die Farbe, Transparenz und Position des einen Farbverlaufstopp für einen Farbverlauf Linie.  <br/> |
