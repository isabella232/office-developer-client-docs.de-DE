...
Zeigt die Formatierungsattribute für eine Textausführung des Shapes an, beispielsweise Schriftart, Farbe, Text Format, Groß-/Kleinschreibung, Position relativ zur Grundlinie und Punktgröße.
...
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |Zeigt die Formatierungsattribute für eine Textausführung des Shapes an, beispielsweise Schriftart, Farbe, Text Format, Groß-/Kleinschreibung, Position relativ zur Grundlinie und Punktgröße.  <br/> |
