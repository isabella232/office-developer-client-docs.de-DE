...
description: Zeigt die Formatierungsattribute für einen Textlauf der Form an, wie Schriftart, Farbe, Textstil, Groß-/Kleinschreibung, Position relativ zur Basislinie und Punktgröße.
...
Zeigt die Formatierungsattribute für einen Textlauf der Form an, wie Schriftart, Farbe, Textstil, Groß-/Kleinschreibung, Position relativ zur Basislinie und Punktgröße.
...
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |Zeigt die Formatierungsattribute für einen Textlauf der Form an, wie Schriftart, Farbe, Textstil, Groß-/Kleinschreibung, Position relativ zur Basislinie und Punktgröße.  <br/> |
