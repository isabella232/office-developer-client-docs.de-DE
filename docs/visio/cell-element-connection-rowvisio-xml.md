...
|:-----|:-----|:-----|
|[Row-Element (Abschnitt "Connection")](row-element-connection-sectionvisio-xml.md) <br/> |[ConnectionRow_Type](connectionrow_type-complextypevisio-xml.md) <br/> |Enthält die x- und y-Koordinaten, die horizontalen und vertikalen Richtung und den Typ für einen einzelnen Verbindungspunkt auf einem Shape.  <br/> |
...
|Prompt  <br/> |Dieses Attribut ist für die zukünftige Verwendung reserviert.  <br/> |Keine.  <br/> |
