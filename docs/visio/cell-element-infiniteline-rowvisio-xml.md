...
Enthält die x- oder y-Koordinaten von zwei Punkten einer unendlichen Linie.
...
|:-----|:-----|:-----|
|[Row-Element ("Geometry")](row-element-geometry-sectionvisio-xml.md) <br/> |[InfiniteLine_Type](infiniteline_type-complextypevisio-xml.md) <br/> |Enthält die x- oder y-Koordinaten von zwei Punkten einer unendlichen Linie.  <br/> |
