...
---
# <a name="cell-element-infiniteline-row-visio-xml"></a>Cell-Element (endlos Zeilen) (Visio XML)

Enthält die x-oder y-Koordinaten von zwei Punkten auf einer unendlichen Reihe.
...
|:-----|:-----|:-----|
|[Row-Element (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[InfiniteLine_Type](infiniteline_type-complextypevisio-xml.md) <br/> |Enthält die x-oder y-Koordinaten von zwei Punkten auf einer unendlichen Reihe.  <br/> |
...
|:-----|:-----|:-----|
|X  <br/> |Eine x-Koordinate eines Points auf der unendlichen Leine; gepaart mit der y-Koordinate, dargestellt durch die Zelle y.  <br/> |[Zeile "InfiniteLine" (Abschnitt "Geometry")](infiniteline-row-geometry-section.md) <br/> |
|v  <br/> |Eine y-Koordinate eines Kommas auf der unendlichen Leine; gepaart mit der x-Koordinate, dargestellt durch die Zelle x.  <br/> |[Zeile "InfiniteLine" (Abschnitt "Geometry")](infiniteline-row-geometry-section.md) <br/> |
