...
---
# <a name="cell-element-tabs-section-visio-xml"></a>Cell-Element (Tabs-Abschnitt) (' Visio XML ')

Gibt eine Eigenschaft an, die die Position oder Ausrichtung der Tabstopps für Shape und Style steuert. 
...
|:-----|:-----|:-----|
|[Zeilenelement (Abschnitt "Tabs")](row-element-tabs-sectionvisio-xml.md) <br/> |[TabsRow_Type](tabsrow_type-complextypevisio-xml.md) <br/> |Gibt eine Eigenschaft an, die die Position oder Ausrichtung der Tabstopps für Shape und Style steuert.  <br/> |
