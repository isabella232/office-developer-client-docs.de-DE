...
|:-----|:-----|:-----|
|[Row-Element (Abschnitt "Hyperlinks")](row-element-hyperlink-sectionvisio-xml.md) <br/> |[HyperlinkRow_Type](hyperlinkrow_type-complextypevisio-xml.md) <br/> |Enthält die Informationen für einen einzelnen Hyperlink, der mit einer Form verknüpft ist. Ein Shape enthält **eine Zeile für jeden Hyperlink** .  <br/> |
