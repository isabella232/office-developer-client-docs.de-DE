...
---
# <a name="cell-element-ellipse-row-visio-xml"></a>Cell-Element (Ellipse Row) (Visio XML)
...
|A  <br/> |Die X-Koordinate des ersten Punkts auf der Ellipse; gekoppelt mit y-Koordinate, die durch die Zelle B dargestellt wird.  <br/> |[Zeile "Ellipse" (Abschnitt "Geometry")](ellipse-row-geometry-section.md) <br/> |
|B  <br/> |Die y-Koordinate des ersten Punkts auf der Ellipse; gekoppelt mit x-Koordinate, die durch die Zelle A dargestellt wird.  <br/> |[Zeile "Ellipse" (Abschnitt "Geometry")](ellipse-row-geometry-section.md) <br/> |
|C  <br/> |Die x-Koordinate des zweiten Punkts auf der Ellipse; y-Koordinate, die durch die Zelle D dargestellt wird.  <br/> |[Zeile "Ellipse" (Abschnitt "Geometry")](ellipse-row-geometry-section.md) <br/> |
|D  <br/> |Die y-Koordinate des zweiten Punkts auf der Ellipse; y-Koordinate, die durch die Zelle C dargestellt wird.  <br/> |[Zeile "Ellipse" (Abschnitt "Geometry")](ellipse-row-geometry-section.md) <br/> |
